<?
class CPL_Admin_Modules_Tradingsg_Product_Controller extends CP_Common_Lib_ModuleControllerAbstract
{
    ...
    function getSupplierValidationAlert(){
        return $this->model->getSupplierValidationAlert();
    }
    ...
    function getUpdateStockHistoryFromPo(){
        return $this->view->getUpdateStockHistoryFromPo();
    }
}