<?
class CPL_Admin_Widgets_EnggCrm_ProjectJobCompletion_Controller extends CP_Common_Lib_WidgetControllerAbstract
{
    /**
    */
    ...
    */
    ...
    function getJobCompletionPortal() {
        return $this->view->getJobCompletionPortal();
