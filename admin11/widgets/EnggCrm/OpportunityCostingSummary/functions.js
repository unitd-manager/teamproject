$(function(){
    $("a.addOpportunityCostingSummary").livequery('click', function (e){
        var title = "Costing Summary";
        var opportunity_id = $(this).attr('opportunity_id');
        var url = 'index.php?widget=enggCrm_opportunityCostingSummary&_spAction=createCostingSummary'
        ...
        Util.openFormInDialog.call(this, 'opportunityCostingSummaryForm', title, 900, 530, exp);
    });

    $("a.addOpportunityActualCharges").livequery('click', function (e){
        var opportunity_id    = $(this).attr('opportunity_id');
        var title    = $(this).attr('title');

        var url = 'index.php?widget=enggCrm_opportunityCostingSummary&_spAction=addOpportunityActualCharges'
                + '&showHTML=0&opportunity_id='+opportunity_id+'&title='+title;
        var exp = {
            url: url
           ,callbackOnSuccess: function(){
                Util.closeAllDialogs();
    ...
    $("a.clearOpportunityCostingSummary").livequery('click', function (e){
    ...
    $("a.editOpportunityCostingSummary").livequery('click', function (e){
        var title              = "Edit Costing Summary";
        var opportunity_id     = $(this).attr('opportunity_id');
        var opportunity_costing_summary_id = $(this).attr('opportunity_costing_summary_id');
        var url = 'index.php?widget=enggCrm_opportunityCostingSummary&_spAction=editCostingSummary'
                + '&showHTML=0&opportunity_id='+opportunity_id+'&opportunity_costing_summary_id='+opportunity_costing_summary_id;
        var exp = {
            url: url
           ,callbackOnSuccess: function(){
                Util.closeAllDialogs();
    ...
    $("#opportunityCostingSummaryForm a.addRow").livequery('click', function (e){
        var opportunity_id = $(this).attr('opportunity_id');
        var url = 'index.php?widget=enggCrm_opportunityCostingSummary&_spAction=addLineItemRecord'
                + '&showHTML=0&opportunity_id=' + opportunity_id;

        $.get(url, '' ,function(html){
            $('#opportunityCostingSummaryForm tr:last').after(html);
        });
    });

    $('.addMoreDetailsOpportunityCostingRow').livequery('click', function (e){
        var link_text = $(this).html();

        if(link_text == '(+) Add More Details'){
            $('.addMoreDetailsOpportunityCostingRow').text('(-) Hide More Details');
        }
        else{
            $('.addMoreDetailsOpportunityCostingRow').text('(+) Add More Details');
        }

        $('.hideMoreOpportunityCostingDetails').slideToggle();
    });

    $("#opportunityCostingSummaryForm .costingSummaryQuantity").livequery('change', function (e){
        ...
        $("#opportunityCostingSummaryForm input.costingSummaryAmount").each(function() {
        ...
        opportunityCostingSummary.populateTotalAmount();
    });

    $("#opportunityCostingSummaryForm .costingSummaryUnitPrice").livequery('change', function (e){
        var amount       = $(this).val();
    ...
    $("#opportunityCostingSummaryForm input.costingSummaryAmount").livequery('change', function (e){
        var total_material_price = parseFloat(0);
        $("#opportunityCostingSummaryForm input.costingSummaryAmount").each(function() {
            if(isNaN($(this).val()) || $(this).val() == undefined || $(this).val() == "") {
                total_material_price += parseFloat(0);
    ...
    $("#opportunityCostingSummaryForm .totalCostField input").livequery('change', function (e){
        var total_amount = parseFloat(0);
        $("#opportunityCostingSummaryForm .totalCostField input").each(function() {
            if(isNaN($(this).val()) || $(this).val() == undefined || $(this).val() == "") {
    ...
    $("#opportunityCostingSummaryForm input[name=po_price]").livequery('change', function (e){
        var po_price = $(this).val();
        $("#opportunityCostingSummaryForm input[name=po_price]").attr('value', parseFloat(po_price).toFixed(3));
    ...
    $("#opportunityCostingSummaryForm input[name=transport_charges]").livequery('change', function (e){
        var transport_charges = $(this).val();
        $("#opportunityCostingSummaryForm input[name=transport_charges]").attr('value', parseFloat(transport_charges).toFixed(3));

        opportunityCostingSummary.populateTotalAmount();
    });

    $("#opportunityCostingSummaryForm input[name=no_of_worker_used]").livequery('change', function (e){
        var no_of_worker_used    = $("#opportunityCostingSummaryForm input[name=no_of_worker_used]").val();
        var no_of_days_worked    = $("#opportunityCostingSummaryForm input[name=no_of_days_worked]").val();
        var labour_rates_per_day = $("#opportunityCostingSummaryForm input[name=labour_rates_per_day]").val();
        ...
        $("#opportunityCostingSummaryForm input[name=total_labour_charges]").attr('value', totalLabourCharges.toFixed(3));
        opportunityCostingSummary.populateTotalAmount();
    });

    $("#opportunityCostingSummaryForm input[name=no_of_days_worked]").livequery('change', function (e){
        var no_of_worker_used    = $("#opportunityCostingSummaryForm input[name=no_of_worker_used]").val();
        var no_of_days_worked    = $("#opportunityCostingSummaryForm input[name=no_of_days_worked]").val();
        var labour_rates_per_day = $("#opportunityCostingSummaryForm input[name=labour_rates_per_day]").val();
    ...
    $("#opportunityCostingSummaryForm input[name=labour_rates_per_day]").livequery('change', function (e){
        var no_of_worker_used    = $("#opportunityCostingSummaryForm input[name=no_of_worker_used]").val();
        var no_of_days_worked    = $("#opportunityCostingSummaryForm input[name=no_of_days_worked]").val();
        var labour_rates_per_day = $("#opportunityCostingSummaryForm input[name=labour_rates_per_day]").val();
    ...
    $("#opportunityCostingSummaryForm input[name=salesman_commission_percentage]").livequery('change', function (e){
        var salesman_commission_percentage = $(this).val();

        var invoiced_price   = $("#opportunityCostingSummaryForm input[name=invoiced_price]").val();
        ...
        $("#opportunityCostingSummaryForm input[name=salesman_commission]").attr('value', salesman_commission.toFixed(3));
        opportunityCostingSummary.populateTotalAmount();
    });

    $("#opportunityCostingSummaryForm input[name=finance_charges_percentage]").livequery('change', function (e){
        ...
        $("#opportunityCostingSummaryForm input[name=finance_charges]").attr('value', finance_charges.toFixed(3));
        opportunityCostingSummary.populateTotalAmount();
    });
    
    $("#opportunityCostingSummaryForm input[name=office_overheads_percentage]").livequery('change', function (e){
        ...
        $("#opportunityCostingSummaryForm input[name=office_overheads]").attr('value', office_overheads.toFixed(3));
        opportunityCostingSummary.populateTotalAmount();
    });

    $("#opportunityCostingSummaryForm input[name=transport_charges_percentage]").livequery('change', function (e){
        var transport_charges_percentage = $(this).val();
        $("#opportunityCostingSummaryForm input[name=transport_charges_percentage]").attr('value', transport_charges_percentage);
        opportunityCostingSummary.populateTotalAmount();
    });

    $("#opportunityCostingSummaryForm input[name=invoiced_price]").livequery('change', function (e){
    ...
    $("#opportunityCostingSummaryForm input[name=profit_percentage]").livequery('change', function (e){
    ...
    $("input[name='sub_con_name[]']").livequery(opportunityCostingSummary.subConName);

    $("#opportunityCostingSummaryForm select.costingSummarySupplier").livequery('change', function (e){
    ...
    $("#opportunityCostingSummaryForm input[name='product_title[]']").livequery(opportunityCostingSummary.poProductTitle);

    $('#opportunityCostingSummaryForm .addNewSupplierPopup').livequery('click', function (e){
        ...
        var expObj = {
            validate: true
           ,callbackOnSuccess: function(){
                var supplierObj = $("#opportunityCostingSummaryForm .costingSummarySupplier");
                var url = $('#scopeRootAlias').val() + 'index.php?widget=enggCrm_opportunityCostingSummary&_spAction=supplierByJSON&showHTML=0';
                $.ajax({
                    type: "GET",
                    url: url,
                    async: false,
...
var opportunityCostingSummary = {
    reloadCostingSummaryDisplay: function(opportunity_id){
        var url = 'index.php?widget=enggCrm_opportunityCostingSummary&_spAction=rowsHTML&showHTML=0';
    ...
    subConName: function(){
        ...
        $(titleObj).autocomplete({
             source : 'index.php?widget=enggCrm_opportunityCostingSummary&_spAction=searchSubCon&showHTML=0'
            ,minLength : 1
            ,selectFirst: true
            ,autoFocus: true
    ...
    populateTotalAmount: function(opportunity_id){
        var invoiced_price   = $("#opportunityCostingSummaryForm input[name=invoiced_price]").val();
        if(isNaN(invoiced_price) || invoiced_price == undefined || invoiced_price == "") {
            invoiced_price = parseFloat(0);
        }

        var transport_charges_percentage   = $("#opportunityCostingSummaryForm input[name=transport_charges_percentage]").val();
        var salesman_commission_percentage = $("#opportunityCostingSummaryForm input[name=salesman_commission_percentage]").val();
        var finance_charges_percentage     = $("#opportunityCostingSummaryForm input[name=finance_charges_percentage]").val();
        var office_overheads_percentage    = $("#opportunityCostingSummaryForm input[name=office_overheads_percentage]").val();
        ...
        $("#opportunityCostingSummaryForm input[name=transport_charges]").attr('value', transport_charges.toFixed(3));
        ...
        $("#opportunityCostingSummaryForm input[name=profit_percentage]").attr('value', marginPercentage.toFixed(3));
        $("#opportunityCostingSummaryForm input[name=profit]").attr('value', marginAmount.toFixed(3));
    ...
    poProductTitle: function() {
        ...
        $(titleObj).autocomplete({
            source: function(request, response) {
                $.ajax({
                  url: 'index.php?widget=enggCrm_opportunityCostingSummary&_spAction=searchProductTitle&showHTML=0',
                  dataType: "json",
                  data: request,                    
