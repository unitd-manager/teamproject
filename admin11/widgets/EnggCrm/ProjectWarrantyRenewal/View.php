<?
class CPL_Admin_Widgets_EnggCrm_ProjectWarrantyRenewal_View extends CP_Common_Lib_WidgetViewAbstract
{
    /**
     *
     */
     ...
     *
     */
    function getProjectWarrantyPortal($renewal_id = '') {
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            $materialActions = '';
                $editForMaterialUsed = "index.php?widget=enggCrm_projectWarrantyRenewal&_spAction=editForMaterialUsed&renewal_id={$renewal_id}&project_warranty_id={$row['project_warranty_id']}&showHTML=0";


                $urlPrintmaterialLinkPdf  = "index.php?widget=enggCrm_projectWarrantyRenewal&_spAction=printmaterialLinkForPdf&renewal_id={$renewal_id}&project_warranty_id={$row['project_warranty_id']}&showHTML=0";

                $materialActions = "
                <div class='float_box clearfix'>
                    <div class='float_left'>
                        <a class='editForWarrantyRenewal' href='{$editForMaterialUsed}'><u>Edit</u></a>
                    </div>
                    <div class='float_left'>
                    <a href='{$urlPrintmaterialLinkPdf}' target='_blank' class='printLink btn btn-info' renewal_id='{$renewal_id}'>Print Pdf</a>
                </div>
                </div>
                ";
...
$addForMaterialUsed = "index.php?widget=enggCrm_projectWarrantyRenewal&_spAction=addMultipleMaterials&renewal_id={$renewal_id}&showHTML=0";
                ...
                <thead>
                    <tr>
                        <th colspan='9' align='left' class='rightPanelHeading'>
                          ...
                          <div class='float_left'>
                              <a class='addMultipleWarrantyRenewal btn btn-primary' href='{$addForMaterialUsed}'>Add Warranty</a>
                          </div>
                        </th>
                    </tr>
                    <tr>
    ...
    function getEditForMaterialUsed() {
        ...
        $formActionMaterialUsed = "index.php?widget=enggCrm_projectWarrantyRenewal&_spAction=editForMaterialUsedSubmit&lnkRoom={$tv['lnkRoom']}&project_warranty_id={$project_warranty_id}&showHTML=0";
        $expTitle  = array("placeholder" => "Please type and select");
        $expNoEdit = array("isEditable" => 0);
        
        $text = "
        <form id='editForWarrantyRenewal' class='yform columnar' method='post' action='{$formActionMaterialUsed}'>
            <fieldset>
            <table width='100%'>
            <tr>
        ...
        <td>{$formObj->getDateRow('End Date', 'warranty_end_date',$rowMaterial['end_date'])}</td>
        </tr>
        <tr>
    ...
    function getAddMultipleMaterials() {
        ...
        $formAction = "index.php?widget=enggCrm_projectWarrantyRenewal&_spAction=addMultipleMaterialsSubmit&showHTML=0";

        $expEdit = array("isEditable" => 0);
        $text = "
        <form id='addMultipleWarrantyForm' class='yform columnar addMultipleMaterialsForm' method='post' action='{$formAction}'>
