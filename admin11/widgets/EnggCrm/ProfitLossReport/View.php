<?
class CPL_Admin_Widgets_EnggCrm_ProfitLossReport_View extends CP_Common_Lib_WidgetViewAbstract
{
    //==================================================================//
    function getWidget() {
        ...
        $text = "
        <h2 class='txtCenter reportTitle'><strong>Profit & Loss A/c between " . $start_date_formatted . " AND " . $end_date_formatted ."</strong></h2>
    ...
    function getRowsHTML() {
        ...
        while ($rowgroup    = $db->sql_fetchrow($resultgroup)) {
            ...
            if ($count == $numRows) {
                ...
                <tr>
                    <td width = 80% class='expenseDetailsHead'>
                    <div class='expenseDetails'><strong>Purchase Order</strong></div>
                ...
                <tr>
                    <td width = 80% class='expenseDetailsHead'>
                    <div class='expenseDetails'><strong>Credit Note</strong></div>
