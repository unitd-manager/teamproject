<?
class CPL_Admin_Widgets_EnggCrm_ProjectMaintenanace_Controller extends CP_Common_Lib_WidgetControllerAbstract
{
	/**
    */
    ...
    */
    function getPrintRenewalDisplayPdf(){
        return $this->view->getPrintRenewalDisplayPdf();
    }
