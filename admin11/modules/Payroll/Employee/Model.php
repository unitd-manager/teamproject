...
class CPL_Admin_Modules_Payroll_Employee_Model extends CP_Admin_Modules_Payroll_Employee_Model
{
    ...
    function getSave(){
        ...
        if($login_email != "" && $login_pass_word != ''){
            $rec = $fn->getRecordByCondition("staff", "employee_id = '{$id}'");
            if($rec['staff_id']){
                $faStaff = array();
                ...
                $whereCondition = "WHERE employee_id = {$id}";
    ...
    function getFields(){
        ...
        $fa = $fn->addToFieldsArray($fa, 'project_designation');       
        $fa = $fn->addToFieldsArray($fa, 'team');
        $fa = $fn->addToFieldsArray($fa, 'project_manager');
    ...
    function getImportData(){
        ...
        $fa = array(
             ...
             ,'rest_day_per_week'       => $phpExcel->getImportFldObj('Rest day per week')
        );
        ...
        $fa['rest_day_per_week']['refOnly']  = true;
        /* Reference End */
        /****************************************/
        $config = array(
    ...
    function importDataRowCallback($employee_id, $fa) {
        ...
        if ($employee_id) {
            ...
            $fa2['place_of_work']        = "364 Geylang Road";
