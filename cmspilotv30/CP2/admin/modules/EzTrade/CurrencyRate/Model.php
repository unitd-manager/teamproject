<?
class CP_Admin_Modules_EzTrade_CurrencyRate_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
    ...
    function getCurrencyExchageRateFromWeb() {
        ...
        return $utilCommon->getJsonFromArray(array('exchange_rate' => $exchRate));
    }
}
