<?
class CP_Admin_Modules_EzTrade_Enquiry_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('ezTrade_enquiry');
        $modules->registerModule($modObj, array(
            'relatedTables' => array('media', 'enquiry_product')
           ,'actBtnsList' => array('new')
           ,'actBtnsDetail' => array('tradingRaiseRfqList', 'tradingRaiseQuote', 'edit', 'delete')
    ...
    function setMediaArray($mediaArr) {
        $mediaObj = $mediaArr->getMediaObj('ezTrade_enquiry', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        $linkObj = $inst->getLinksArrayObj('ezTrade_enquiry', 'ezTrade_productLink', array(
            'historyTableName' => 'enquiry_product'
           ,'hasPortalEdit'    => 1
           ,'hasPortalDetail'  => 1
           ,'hasHistoryCallback' => true
           ,'showAlternativeRowColor' => false
           ,'validationJsMethod' => 'Enquiry.validateEditLink'
     ...
     *
     */
    function getEzTradeEnquiryEzTradeProductLinkAddLinkCallback($enquiry_product_id, $enqProdRow) {
     ...
     *
     */
    function getEzTradeEnquiryEzTradeProductLinkHistoryCallback($enqProd) {
        ...
        if ($numRows > 0) {
            while ($row = $db->sql_fetchrow($result)) {
                ...
                $rfqCodeText = $fn->getRecordDetailLink('ezTrade_rfq', 'record_id', $row['quote_request_id'], $expRfq);
