<?
class CP_Admin_Modules_Project_TaskLink_Model extends CP_Common_Lib_ModuleLinkModelAbstract
{
    /**
     *
     */
    ...
    function getAdd() {
        ...
        $fa = $this->getFields();
        $id = $fn->addRecord($fa);
        $spActionObj->linkRecordsByFormField('project_task', 'core_staffLink', $id, 'staff_ids');
