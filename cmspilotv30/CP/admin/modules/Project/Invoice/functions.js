Util.createCPObject('cpm.project.invoice');

cpm.project.invoice.init = function(){
    ...
    $('a.reminderMailSend').livequery('click', function(e){
        ...
        if (!confirm(msg)){
            ...
            var url = 'index.php?module=project_invoice&_spAction=sendReminderEmailSubmit&showHTML=0';
