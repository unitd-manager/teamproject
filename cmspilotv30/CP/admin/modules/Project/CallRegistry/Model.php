<?
class CP_Admin_Modules_Project_CallRegistry_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
    ...
    function getConvertToOpportunity() {
        ...
        if ($numRows == 0){
            ...
            $cpUtil->redirect("index.php?_topRm=opportunity&module=project_opportunity&_action=edit&opportunity_id={$opportunity_id}");
        } else {
            //This url will run when the no. of candidate is 0                
            $cpUtil->redirect("index.php?_topRm=opportunity&module=project_callRegistry&_action=edit&call_registry_id={$call_registry_id}");
        }
    }
