<?
class CP_Admin_Modules_Project_ThirdPartyCost_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('project_thirdPartyCost');
    ...
    function refreshValuesBasedOnThirdPartyCosts($third_party_cost_id, $excludeCurRec = 0){
        ...
        if ($rec['project_id'] > 0 && $cpCfg['m.project.hasQuotingModule'] == 0){
            $SQL = "
