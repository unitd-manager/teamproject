<?
class CP_Admin_Modules_Hms_LabsSupplierLink_View extends CP_Common_Lib_ModuleLinkViewAbstract
{
    function getList($dataArray, $linkRecType) {
        ...
        foreach ($dataArray as $row){
            ...
            {$listLinkObj->getListRowEndLink($linkRecType, $row['labs_supplier_id'])}
            ";
        ...
        {$listLinkObj->getListHeaderCellLink($linkRecType,'Name', 'title')}
