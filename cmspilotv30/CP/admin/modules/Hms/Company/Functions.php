<?
class CP_Admin_Modules_Hms_Company_Functions {
    ...
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('hms_company');
    ...
    function setMediaArray($mediaArr) {
        ...
        $mediaObj = $mediaArr->getMediaObj('hms_company', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('hms_company', 'hms_contactLink');
