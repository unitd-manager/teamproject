<?
class CP_Admin_Modules_Hms_PatientQueue_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$media->getRightPanelMediaDisplay('Attachments', 'hms_patientQueue', 'attachment', $row)}
        ";
