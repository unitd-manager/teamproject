<?
class CP_Admin_Modules_Hms_Appointment_Controller extends CP_Common_Lib_ModuleControllerAbstract
{

	var $handle      = 'calendarAppointment';
    var $cssClass    = '';
    var $eventAction = 'index.php?module=hms_appointment&_spAction=eventDetails&showHTML=0';
    ...
    function getAppointmentNotes(){
        return $this->model->getAppointmentNotes();
    }

    function getUpdateAppointmentNotes(){
        return $this->model->getUpdateAppointmentNotes();
    }
