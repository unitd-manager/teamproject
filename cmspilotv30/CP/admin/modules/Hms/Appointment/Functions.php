<?
class CP_Admin_Modules_Hms_Appointment_Functions {
    ...
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('hms_appointment');
    ...
    function setMediaArray($mediaArr) {
        ...
        $mediaObj = $mediaArr->getMediaObj('hms_appointment', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('hms_appointment', 'hms_contactLink');
