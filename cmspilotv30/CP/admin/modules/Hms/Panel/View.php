<?
class CP_Admin_Modules_Hms_Panel_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getNew(){
        ...
        $fielset1 = "
        {$formObj->getTBRow('Panel Name', 'company_name')}
        ";
    ...
    function getEdit($row){
        ...
        <div class='linkPortalWrapper'>
            <div expanded='1' class='header'>
                <div class='floatbox'>
                    <div class='float_left'>Panel Details</div>
                ...
                <div class='linkPortalDataWrapper'>
                    <table class='thinlist'>
                        <tbody>
                            ...
                            <tr>
                                <th colspan='5'>Panel Delivery Address</th>
                            </tr>
                            ...
                            <tr>
                                <th colspan='5'>Panel Billing Address</th>
                            </tr>
    ...
    function getSearch(){
        ...
        {$formObj->getDDRowBySQL('Choose Category', 'category', $sqlCategory, 'Panel', $expVl)}
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$displayLinkData->getLinkPortalMain('hms_panel', 'hms_contactLink', 'Contacts Linked', $row)}
        {$media->getRightPanelMediaDisplay('Attachments', 'hms_panel', 'attachment', $row)}
        ";
