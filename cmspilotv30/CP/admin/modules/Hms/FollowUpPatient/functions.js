Util.createCPObject('cpm.hms.followUpPatient');

cpm.hms.followUpPatient = {
    init: function(){
        $("input[name='patient_name']")
        .livequery(cpm.hms.followUpPatient.patientName);
        ...
        $('#fld_employee_id').change(function(){
            ...
            var events = {
                  url: 'index.php?module=hms_followUpPatient&_spAction=eventDetails&showHTML=0',
                  type: 'POST',
                  data: {
                    doctor_id: doctor_id
                  }
        ...
        $('#fld_employee_id_appointment').change(function(){
            ...
            cpm.hms.followUpPatient.patientNameFilter(employee_id);
        });
        ...
        $('.followUpNotesUpdate').livequery('click', function (e){
            ...
            var url = 'index.php?_topRm=main&module=hms_followUpPatient&_spAction=updateFollowUpNotes&showHTML=0';
            Util.showProgressInd();
            
            $.get(url,{follow_up_patient_id: follow_up_patient_id, notes:notes}, function(html){
                cpm.hms.followUpPatient.reloadNotesDetails(follow_up_patient_id, notes);
        ...
        $('.createAppointment').livequery('click', function (e){
            ...
            var url = 'index.php?module=hms_followUpPatient&_spAction=createAppointmentRecord&follow_up_patient_id='
            ...
            var exp = {
               ...
               ,callbackOnSuccess: function(){
                    ...
                    cpm.hms.followUpPatient.reloadDoctorDetails();
                    cpm.hms.followUpPatient.reloadFollowUpListDetails();
        ...
        $('.cancelFollowUp').livequery('click', function (e){
            ...
            if (!confirm(msg)){
                ...
                var url = 'index.php?_topRm=main&module=hms_followUpPatient&_spAction=cancelFollowUpRecord&showHTML=0';
                Util.showProgressInd();
                var follow_up_patient_id = $(this).attr('follow_up_patient_id');
    ...
    patientName: function() {
        ...
        $(titleObj).autocomplete({
             source : 'index.php?module=hms_followUpPatient&_spAction=searchPatientDetails&showHTML=0'
            ,minLength : 2
            ,selectFirst: true
            ,autoFocus: true
    ...
    patientNameFilter: function(employee_id){
        var url = "index.php?module=hms_followUpPatient&_spAction=followUpListDetails&showHTML=0";
...
cpm.hms.followUpPatient.run = function(exp){
    ...
    $('#' + handle).fullCalendar({
        ...
        ,dayClick: function(date, allDay, jsEvent, view) {
            ...
            if (allDay) {
                ...
                cpm.hms.followUpPatient.addFollowUpDetails(SelectedTime, selectedDate);
            }else{
       ...
       ,eventClick: function(event, jsEvent, view) {
            ...
            if (event.url) {
                cpm.hms.followUpPatient.showFollowUpDetails.call(this);
                return false;
            }
        }
       ...
       ,eventDrop: function(event, delta, revertFunc, jsEvent, ui, view) {
            ...
            if (!confirm("Please note for this action the follow up time will be changed")) {
                ...
                if (view.name == 'agendaDay' || view.name == 'agendaWeek') {
                    ...
                    var selectedDate = local.toJSON().slice(0, 10);
                    var url = 'index.php?_topRm=main&module=hms_followUpPatient&_spAction=changeFollowUpByDrag&showHTML=0';
    ...
    cpm.hms.followUpPatient.reloadDoctorDetails = function(){
        var url = 'index.php?module=hms_followUpPatient&_spAction=doctorDetails&showHTML=0';
    ...
    cpm.hms.followUpPatient.reloadNotesDetails = function(follow_up_patient_id, notes){
        var url = 'index.php?module=hms_followUpPatient&_spAction=followUpNotes&follow_up_patient_id='+follow_up_patient_id+'&notes='+notes+'&showHTML=0';
        $.get(url,  function(html){
    ...
    cpm.hms.followUpPatient.reloadFollowUpListDetails = function(){
        var url = "index.php?module=hms_followUpPatient&_spAction=followUpListDetails&showHTML=0";
        $.get(url,  function(html){
            $('#followUpListDetails').html(html);
            Util.hideProgressInd();
    ...
    cpm.hms.followUpPatient.addFollowUpDetails = function(SelectedTime, selectedDate){
        var title = "Add Follow Up";
        var url   = "index.php?module=hms_followUpPatient&_spAction=addFollowUpDetails&follow_up_date="+selectedDate+"&follow_up_time="+SelectedTime+"&showHTML=0";
    ...
    cpm.hms.followUpPatient.showFollowUpDetails = function(){
        var title = "Follow Up Details";
