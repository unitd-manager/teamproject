...
class CP_Admin_Modules_Hms_FollowUpPatient_Model extends CP_Common_Lib_ModuleModelAbstract
{
    ...
    function getSQL() {
        ...
        SELECT fp.*
              ,pv.visit_code
              ,p.name
        FROM follow_up_patient fp
        LEFT JOIN (patient_visit pv) ON (pv.patient_information_id = fp.patient_information_id)
        LEFT JOIN (patient_information p) ON (p.patient_information_id = fp.patient_information_id)
        ";
    ...
    function setSearchVar($linkRecType = '') {
       ...
       // $company_name = $fn->getReqParam('company_name');
        ...
        if ($follow_up_patient_id != "") {
            $searchVar->sqlSearchVar[] = "fp.follow_up_patient_id = '{$follow_up_patient_id}'";
        } else if ($tv['record_id'] != '') {
            $searchVar->sqlSearchVar[] = "fp.follow_up_patient_id = '{$tv['record_id']}'";
        } else {
            $fn->setSearchVarForLinkData($searchVar, $linkRecType, 'fp.follow_up_patient_id');
           ...
           /* if ($company_name != "") {
            ...
            if ($tv['special_search'] == "Flagged") {
                $searchVar->sqlSearchVar[] = "fp.flag = 1";
            }

            if ($tv['special_search'] == "Not-Flagged") {
                $searchVar->sqlSearchVar[] = "(fp.flag != 1 OR fp.flag IS null)";
            }
    ...
    function getNewValidate() {
        ...
        $validate->validateData('follow_up_date', 'Please enter the follow_up_date');
    ...
    function getFields(){
        ...
        $fa = $fn->addToFieldsArray($fa, 'follow_up_time');
