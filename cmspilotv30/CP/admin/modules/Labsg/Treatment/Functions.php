<?
class CP_Admin_Modules_Labsg_Treatment_Functions {
    ...
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('labsg_treatment');
    ...
    function setMediaArray($mediaArr) {
        ...
        $mediaObj = $mediaArr->getMediaObj('labsg_treatment', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('labsg_treatment', 'labsg_treatment_medicine_templateLink');
