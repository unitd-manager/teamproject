<?
class CP_Admin_Modules_Labsg_Treatment_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getEdit($row){
        ...
        $sqlCategory = $fn->getValueListSQL('treatmentCategory');
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$media->getRightPanelMediaDisplay('Attachments', 'labsg_treatment', 'attachment', $row)}
    ...
    function getAddMedicineTemplate($treatment_id=''){
        ...
        $formActionMedicineTemplate = "index.php?module=labsg_treatment&_spAction=MedicineTemplate&treatment_id={$treatment_id}&showHTML=0";
        ...
        $text = "
        <div class='linkPortalWrapper labsg_treatment__labsg_treatment_medicine_templateLink'>
    ...
    function getAddMedicineTemplateDetail($treatment_id = ''){
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            //$formActionDeleteMedicineTemplate = "index.php?module=labsg_treatment&_spAction=DeleteMedicineTemplate&treatment_medicine_template_id={$row['treatment_medicine_template_id']}&treatment_id={$treatment_id}&showHTML=0";
            $formActionEditMedicineTemplate   = "index.php?module=labsg_treatment&_spAction=EditMedicineTemplate&treatment_medicine_template_id={$row['treatment_medicine_template_id']}&showHTML=0";
    ...
    function getMedicineTemplate() {
        ...
        $formAction = "index.php?_topRm=order&module=labsg_treatment&_spAction=MedicineTemplateFormSubmit&showHTML=0";
    ...
    function getEditMedicineTemplate() {
        ...
        $formAction = "index.php?module=labsg_treatment&_spAction=EditMedicineTemplateFormSubmit&showHTML=0&treatment_medicine_template_id={$treatment_medicine_template_id}";
