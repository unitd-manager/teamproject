<?
class CP_Admin_Modules_Labsg_DutyRoster_Controller extends CP_Common_Lib_ModuleControllerAbstract
{
    var $handle      = 'calendarDutyRoster';
    var $cssClass    = '';
    var $eventAction = 'index.php?module=labsg_dutyRoster&_spAction=eventDetails&showHTML=0';
