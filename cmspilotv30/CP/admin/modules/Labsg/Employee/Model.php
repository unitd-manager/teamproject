<?
class CP_Admin_Modules_Labsg_Employee_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
        ...
        $extraTableNames = "";
        if ($interest_id != "") {
            $extraTableNames .= "interest_employee hist,";
        }
    ...
    function setSearchVar($linkRecType = '') {
        ...
        if ($employee_id != "") {
            ...
            if ($interest_id != '' ) {
                $searchVar->sqlSearchVar[] = "a.employee_id     =  hist.employee_id";
                $searchVar->sqlSearchVar[] = "hist.interest_id = {$interest_id}";
            }
    
            if ($opportunity_id != '' ) {
                $searchVar->sqlSearchVar[] = "a.employee_id       = opp.employee_id";
                $searchVar->sqlSearchVar[] = "opp.opportunity_id = {$opportunity_id}";
            }
    
            if ($project_id != '' ) {
                $searchVar->sqlSearchVar[] = "a.employee_id    =  proj.employee_id";
                $searchVar->sqlSearchVar[] = "proj.project_id = {$project_id}";
            }
    
            if ($task_id != '' ) {
                $searchVar->sqlSearchVar[] = "a.employee_id = task.employee_id";
            ...
            $searchVar->sortOrder = "a.employee_name";
        }
    }
