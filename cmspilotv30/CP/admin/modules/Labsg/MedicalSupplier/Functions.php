<?
class CP_Admin_Modules_Labsg_MedicalSupplier_Functions {
    ...
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('labsg_medicalSupplier');
    ...
    function setMediaArray($mediaArr) {
        ...
        $mediaObj = $mediaArr->getMediaObj('labsg_medicalSupplier', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('labsg_medicalSupplier', 'labsg_contactLink');
