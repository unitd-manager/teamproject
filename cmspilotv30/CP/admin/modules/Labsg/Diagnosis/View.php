<?
class CP_Admin_Modules_Labsg_Diagnosis_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$media->getRightPanelMediaDisplay('Attachments', 'labsg_diagnosis', 'attachment', $row)}
