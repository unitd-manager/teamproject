<?
class CP_Admin_Modules_Labsg_PurchaseOrder_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('labsg_purchaseOrder');
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('labsg_purchaseOrder', 'picture', 'image');
        $mediaArr->registerMedia($mediaObj, array(
        ));

        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('labsg_purchaseOrder', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('labsg_purchaseOrder', 'labsg_po_productLink');
        $statusArr = $cpCfg['m.labsg.purchaseOrder.poProductStatusArr'];
