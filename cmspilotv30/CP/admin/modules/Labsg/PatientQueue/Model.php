<?
class CP_Admin_Modules_Labsg_PatientQueue_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
    function getSQL() {
        ...
        LEFT JOIN (patient_information p) ON (p.patient_information_id = pq.patient_information_id)
       ";
    ...
    function setSearchVar($linkRecType = '') {
        ...
        $searchVar->mainTableAlias = 'pq';

        $status       = $fn->getReqParam('status');
        $patient_queue_id   = $fn->getReqParam('patient_queue_id');
        //$company_name = $fn->getReqParam('company_name');

        if ($patient_queue_id != "") {
            $searchVar->sqlSearchVar[] = "pq.patient_queue_id = '{$patient_queue_id}'";
        } else if ($tv['record_id'] != '') {
            $searchVar->sqlSearchVar[] = "pq.patient_queue_id = '{$tv['record_id']}'";
        } else {
            $fn->setSearchVarForLinkData($searchVar, $linkRecType, 'pq.patient_queue_id');
    ...
    function getNewValidate() {
        ...
        $validate->validateData('check_up_date', 'Please Select the check_up_date');
    ...
    function getFields(){
        ...
        $fa = $fn->addToFieldsArray($fa, 'queue_no');
