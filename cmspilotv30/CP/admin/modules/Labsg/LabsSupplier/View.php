<?
class CP_Admin_Modules_Labsg_LabsSupplier_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        $record_id = $fn->getIssetParam($row, 'labs_supplier_id');

        $text = "
        {$displayLinkData->getLinkPortalMain('labsg_labsSupplier', 'labsg_contactLink', 'Contacts Linked', $row)}
        {$media->getRightPanelMediaDisplay('Attachments', 'labsg_labsSupplier', 'attachment', $row)}
        ";
