<?
class CP_Admin_Modules_Labsg_FollowUpPatient_Functions {
    ...
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('labsg_followUpPatient');
    ...
    function setMediaArray($mediaArr) {
        ...
        $mediaObj = $mediaArr->getMediaObj('labsg_followUpPatient', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('labsg_followUpPatient', 'labsg_contactLink');
