<?
class CP_Admin_Modules_Labsg_FollowUpPatient_Controller extends CP_Common_Lib_ModuleControllerAbstract
{

	var $handle      = 'calendarFollowUpPatient';
    var $cssClass    = '';
    var $eventAction = 'index.php?module=labsg_followUpPatient&_spAction=eventDetails&showHTML=0';
