<?
class CP_Admin_Modules_Labsg_Labs_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('labsg_labs');
        $modObj['tableName'] = 'labs';
        $modObj['keyField']  = 'labs_id';
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('labsg_labs', 'picture', 'image');
        $mediaArr->registerMedia($mediaObj, array(
        ));

        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('labsg_labs', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('labsg_labs', 'labsg_labs_productLink');
        $statusArr = $cpCfg['m.labsg.labs.labsProductStatusArr'];

        $inst->registerLinksArray($linkObj, array(
            'historyTableName' => 'labs_product'
           ,'historyTableKeyField' => 'labs_product_id'
           ,'hasPortalEdit' => 0
           ,'hasPortalDetail' => 1
           ,'hasPortalDelete' => 0
           ,'hasPortalNew'=> 0
