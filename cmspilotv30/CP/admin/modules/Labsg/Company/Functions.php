<?
class CP_Admin_Modules_Labsg_Company_Functions {
    ...
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('labsg_company');
    ...
    function setMediaArray($mediaArr) {
        ...
        $mediaObj = $mediaArr->getMediaObj('labsg_company', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('labsg_company', 'labsg_contactLink');
