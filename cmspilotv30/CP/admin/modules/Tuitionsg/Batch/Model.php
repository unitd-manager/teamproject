<?
class CP_Admin_Modules_Tuitionsg_Batch_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
     ...
     *
     */
    function getTuitionsgBatchTuitionsgContactLinkSQL($id) {
     ...
     *
     */
    function getTuitionsgBatchTuitionsgAssessorLinkSQL($id) {
        $formObj = Zend_Registry::get('formObj');
     ...
     *
     */
    function getTuitionsgBatchTuitionsgTeacherLinkSQL($id) {
        $cpCfg = Zend_Registry::get('cpCfg');

        $sqlAppend = '';
        if($cpCfg['m.tuitionsg.batch.showTrainerOnly']){
     ...
     *
     */
    function getTuitionsgBatchTuitionsgTeacherLinkLinkedIdsSQL() {
        $tv     = Zend_Registry::get('tv');
        $cpCfg  = Zend_Registry::get('cpCfg');
     ...
     *
     */
    function getTuitionsgBatchTuitionsgAssessorLinkLinkedIdsSQL() {
        $tv = Zend_Registry::get('tv');
