<?
class CP_Admin_Modules_Tuitionsg_Batch_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        $modObj = $modules->getModuleObj('tuitionsg_batch');
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('tuitionsg_batch', 'picture', 'image');
        $mediaObj = $mediaArr->getMediaObj('tuitionsg_batch', 'attachment', 'attachment');
    ...
    */
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('tuitionsg_batch', 'tuitionsg_contactLink');        
	   ...
	   //------------------------------------------------------------------------------//
        ...
        $linkObj = $inst->getLinksArrayObj('tuitionsg_batch', 'tuitionsg_teacherLink');        
        $inst->registerLinksArray($linkObj, array(
       ...
       $linkObj = $inst->getLinksArrayObj('tuitionsg_batch', 'tuitionsg_assessorLink');
       $inst->registerLinksArray($linkObj, array(
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('tuitionsg_batch', 'tuitionsg_attendance');               
        $inst->registerLinksArray($linkObj, array(
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('tuitionsg_batch', 'tuitionsg_feedback');        
        $inst->registerLinksArray($linkObj, array(
    ...
    *
    */
    function getTuitionsgBatchTuitionsgContactLinkAddLinkCallback($course_contact_id, $row) {
        ...
        if ($row['order_id'] == ''){
            ...
            $fa['payment_method']  = '';
            $fa['module']          = 'Tuitionsg_course';
            $fa['order_status']    = 'Due';
            $fa['order_date']      =  date('Y-m-d');
            $fa['contact_module']  = 'Tuitionsg_contact';
    ...
    *
    */
    function getTuitionsgBatchTuitionsgContactLinkDeleteLinkCallback($batch_id, $contact_id) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
        $fn = Zend_Registry::get('fn');
    ...
    *
    */
    function getTuitionsgBatchTuitionsgContactLinkAddAllLinkCallback($batch_id, $newly_created_contact_ids) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
    ...
    *
    */
    function getTuitionsgBatchTuitionsgContactLinkRemoveAllLinkCallback($batch_id, $removed_contact_ids) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
     ...
     *
     */
    function getTuitionsgBatchTuitionsgContactLinkPortalSearch() {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
        $fn = Zend_Registry::get('fn');
