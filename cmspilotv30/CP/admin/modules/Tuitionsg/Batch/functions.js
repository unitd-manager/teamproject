Util.createCPObject('cpm.tuitionsg.batch');
cpm.tuitionsg.batch.init = function(){
    $('.tuitionsg_batch__tuitionsg_studentFeedbackLink select[name=group]').livequery('change', function(){
        Util.showProgressInd('Populating related content.... Please wait');

        cpm.tuitionsg.batch.populateRelatedQuestions.call(this);
    });
    
}

cpm.tuitionsg.batch.populateRelatedQuestions = function(){
    feedback_group = $(this).val();
    batch_id = $('input:hidden[name=batch_id]').val();
    
    var url = $('#scopeRootAlias').val() + 'index.php?module=tuitionsg_batch&_spAction=feedbackQuestions&showHTML=0';
    ...
    var expObj = {
       ...
       ,callbackOnSuccess: function(){
            ...
            Util.alert(msg, function(){
                ...
                Links.reloadPortalRecords('tuitionsg_batch#tuitionsg_contactLink', 'tuitionsg_batch');
            });
        }
    }
...
$("#takeAttendance").livequery('click', function (e){
    ...
    var expObj = {
       ...
       ,callbackOnSuccess: function(){
            ...
            Util.alert(msg, function(){
                Util.closeAllDialogs();
                Links.reloadPortalRecords('tuitionsg_batch#tuitionsg_attendance', 'tuitionsg_batch');
...
$("#studentGrade").livequery('click', function (e){
    ...
    var expObj = {
       ...
       ,callbackOnSuccess: function(){
            ...
            Util.alert(msg, function(){
                Util.closeAllDialogs();
                Links.reloadPortalRecords('tuitionsg_batch#tuitionsg_studentGrade', 'tuitionsg_batch');
                window.location.reload(true);
            });
        }
    }
...
$("#studentFeedback").livequery('click', function (e){
    ...
    var expObj = {
       ...
       ,callbackOnSuccess: function(){
            ...
            Util.alert(msg, function(){
                Util.closeAllDialogs();
                Links.reloadPortalRecords('tuitionsg_batch#tuitionsg_feedback', 'tuitionsg_batch');
                window.location.reload(true);
            });
        }
    }
...
$(".editStudentFeedback").livequery('click', function (e){
    ...
    var expObj = {
       ...
       ,callbackOnSuccess: function(){
            ...
            Util.alert(msg, function(){
                Util.closeAllDialogs();
                Links.reloadPortalRecords('tuitionsg_batch#tuitionsg_student_feedback', 'tuitionsg_batch');
            });
        }
    }
...
$('input#marks').livequery('change', function(){
    ...
    var url = 'index.php?module=tuitionsg_batch&_spAction=updateGrade&showHTML=0';
    grade = 'input#fld_' + batch_history_id + '_grade';
    $.get(url, {mark: mark}, function(html){
        $(grade).val(html);
    });

    var url = 'index.php?module=tuitionsg_batch&_spAction=updateStudentResult&showHTML=0';
