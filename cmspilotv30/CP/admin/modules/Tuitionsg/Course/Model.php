<?
class CP_Admin_Modules_Tuitionsg_Course_Model extends CP_Common_Modules_Tuitionsg_Course_Model
{
    function getSQL() {
     ...
     */
    function getTuitionsgCourseTuitionsgBatchLinkSQL($id) {
        $fn = Zend_Registry::get('fn');
     ...
     * @param type $id = course_id
    */
    function getTuitionsgCourseTuitionsgCourseSubsidyLinkSQL($id) {
     ...
     * @param type $id = course_id
    */
    function getTuitionsgCourseTuitionsgLevelLinkSQL($id) {
