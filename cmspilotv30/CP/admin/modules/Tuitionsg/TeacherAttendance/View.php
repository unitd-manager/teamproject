<?
class CP_Admin_Modules_Tuitionsg_TeacherAttendance_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getNew(){
        ...
        $formObj = Zend_Registry::get('formObj');
   		...
   		$sqlTeacher = getCPModuleObj('tuitionsg_teacher')->model->getTeacherSQL();
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'tuitionsg_teacherAttendance', 'attachment', $row)}
        ";
