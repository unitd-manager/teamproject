<?
class CP_Admin_Modules_Tuitionsg_Teacher_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Picture', 'tuitionsg_teacher', 'picture', $row)}
        {$media->getRightPanelMediaDisplay('Attachments', 'tuitionsg_teacher', 'attachment', $row)}
        {$displayLinkData->getLinkPortalMain('tuitionsg_teacher', 'tuitionsg_courseLink', 'Course Linked', $row)}
        {$displayLinkData->getLinkPortalMain('tuitionsg_teacher', 'tuitionsg_batchLink', 'Batch Linked', $row)}
        ";
        return $text;
    }
