<?
class CP_Admin_Modules_Tuitionsg_ProgramGroup_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
     ...
     *
     */
    function getTuitionsgProgramGroupTuitionsgSubsidyDiscountLinkSQL($id) {
