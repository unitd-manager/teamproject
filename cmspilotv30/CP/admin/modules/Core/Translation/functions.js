Util.createCPObject('cpm.core.translation');

cpm.core.translation.init = function(){
}

cpm.core.translation.enableEditFunctions = function(){
    $(function(){
        ...
        $('button.saveTrans, button.cancelTrans').click(function(){
            ...
            if($(this).hasClass('cancelTrans')){
                ...
                var url = 'index.php?module=core_translation&_spAction=updateValue&showHTML=0';
