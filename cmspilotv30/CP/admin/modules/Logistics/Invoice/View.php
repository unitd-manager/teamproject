<?
class CP_Admin_Modules_Logistics_Invoice_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getEdit($row) {
        ...
        $expInvNo  = array('isEditable' => $cpCfg['m.logistics.invoice.codeEditable']);
    ...
    function getRightPanel($row) {
        ...
        $text = "
        {$media->getRightPanelMediaDisplay('Attachments', 'logistics_invoice', 'attachment', $row)}
        ";
    ...
    function getQuickSearch() {
        ...
        <td>
            <select name='company_id'>
                ...
                {$dbUtil->getDropDownFromSQLCols2($db, $company_id)}
            </select>
        </td>
        <td>
            <select name='status'>
