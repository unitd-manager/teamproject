<?
class CP_Admin_Modules_Logistics_Receipt_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'logistics_receipt', 'attachment', $row)}
        ";
