<?
class CP_Admin_Modules_AceIms_CreditNote_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'aceIms_creditNote', 'attachment', $row)}
        ";
