Util.createCPObject('cpm.aceIms.reports');
...
cpm.aceIms.reports = {
    init: function(){
        ...
        cpm.aceIms.reports.setSearchForm();
        ...
        $('.search select[name=report]').change(function(){
            ...
            var url = 'index.php?_topRm=reports&module=aceIms_reports&_spAction=search&showHTML=0&report=' + report;
    ...
    setSearchForm: function(){
        $('table.search input.button').livequery('click', function(e) {
            ...
            var url = 'index.php?_topRm=reports&module=aceIms_reports&_spAction=displayReport&showHTML=0' + allVars;
            $.ajax({
                type: "GET",
                url: url,
                dataType: "html",
