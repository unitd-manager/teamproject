<?
class CP_Admin_Modules_AceIms_Contact_Model extends CP_Common_Modules_AceIms_Contact_Model
{
    /**
     *
     */
    ...
    function getEditValidate($contact_id) {
        ...
        $validate->validateData('id_card_no' , 'Please enter NRIC / Passport No. / FIN');
    ...
    function getExportData($dataArray){
        ...
        if ($course_status != '' && $cpCfg['m.aceIms.course.hasCourseContactStatus']) {
            $addStatusField = 1;
        } else {
            $addStatusField = '';
        }
