<?
class CP_Admin_Modules_AceIms_ProgramGroup_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$displayLinkData->getLinkPortalMain('aceIms_programGroup', 'aceIms_subsidyDiscountLink', 'Subsidy Discount Link', $row)}
        ";
