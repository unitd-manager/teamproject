<?
class CP_Admin_Modules_AceIms_ProgramGroup_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
        $SQL   = "
        SELECT pg.*
     ...
     *
     */
    function getAceImsProgramGroupAceImsSubsidyDiscountLinkSQL($id) {
