<?
class CP_Admin_Modules_AceIms_ProgramGroup_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        $modObj = $modules->getModuleObj('aceIms_programGroup');
   ...
   function setLinksArray($inst) {
       $linkObj = $inst->getLinksArrayObj('aceIms_programGroup', 'aceIms_subsidyDiscountLink');
    ...
    *
    */
    function getAceImsProgramGroupAceImsSubsidyDiscountLinkAddLinkCallback($program_group_id, $row) {
    ...
    *
    */
    function getAceImsProgramGroupAceImsSubsidyDiscountLinkDeleteLinkCallback($program_group_id, $subsidy_discount_id) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
    ...
    *
    */
    function getAceImsProgramGroupAceImsSubsidyDiscountLinkAddAllLinkCallback($program_group_id) {
        $fn = Zend_Registry::get('fn');
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
    ...
    *
    */
    function getAceImsProgramGroupAceImsSubsidyDiscountLinkRemoveAllLinkCallback($program_group_id) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
