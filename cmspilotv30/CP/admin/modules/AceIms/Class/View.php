<?
class CP_Admin_Modules_AceIms_Class_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'aceIms_class', 'attachment', $row)}
		{$displayLinkData->getLinkPortalMain('aceIms_class', 'aceIms_contactLink', 'Students Linked', $row)}
        ";
