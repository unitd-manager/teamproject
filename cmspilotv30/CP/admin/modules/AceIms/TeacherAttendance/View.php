<?
class CP_Admin_Modules_AceIms_TeacherAttendance_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getNew(){
        ...
        $formObj = Zend_Registry::get('formObj');
   		...
   		$sqlTeacher = getCPModuleObj('aceIms_teacher')->model->getTeacherSQL();
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'aceIms_teacherAttendance', 'attachment', $row)}
        ";
