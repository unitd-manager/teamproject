<?
class CP_Admin_Modules_AceIms_Teacher_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Picture', 'aceIms_teacher', 'picture', $row)}
        {$media->getRightPanelMediaDisplay('Attachments', 'aceIms_teacher', 'attachment', $row)}
        {$displayLinkData->getLinkPortalMain('aceIms_teacher', 'aceIms_courseLink', 'Course Linked', $row)}
        {$displayLinkData->getLinkPortalMain('aceIms_teacher', 'aceIms_batchLink', 'Batch Linked', $row)}
        ";
        return $text;
    }
