<?
class CP_Admin_Modules_AceIms_BatchHistory_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        $modObj = $modules->getModuleObj('aceIms_batchHistory');
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('aceIms_batchHistory', 'picture', 'image');
        $mediaObj = $mediaArr->getMediaObj('aceIms_batchHistory', 'attachment', 'attachment');
