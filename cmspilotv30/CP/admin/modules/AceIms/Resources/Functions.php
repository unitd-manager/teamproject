<?
class CP_Admin_Modules_AceIms_Resources_Functions
{
    function setModuleArray($modules){
        $modObj = $modules->getModuleObj('aceIms_resources');
    ...
    function setLinksArray($inst) {
        $linkObj = $inst->getLinksArrayObj('aceIms_resources', 'aceIms_contactLink');
