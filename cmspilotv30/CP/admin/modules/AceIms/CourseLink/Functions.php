<?
class CP_Admin_Modules_AceIms_CourseLink_Functions
{
    function setModuleArray($modules){
        $fn = Zend_Registry::get('fn');
        $tv = Zend_Registry::get('tv');
    
        $modObj = $modules->getModuleObj('aceIms_courseLink');
        if ($tv['srcRoom'] == 'aceIms_teacher' || $tv['srcRoom'] == 'aceIms_document'){
