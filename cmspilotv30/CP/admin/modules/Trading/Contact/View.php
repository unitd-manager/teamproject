<?
class CP_Admin_Modules_Trading_Contact_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getEdit($row){
        ...
        $sqlComp = $fn->getDDSql('trading_company');
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$media->getRightPanelMediaDisplay('Attachments', 'trading_contact', 'attachment', $row)}
        {$comment->getView(array(
             'roomName' => 'trading_contact'
            ,'recordId' => $record_id
        ))}
        ";
