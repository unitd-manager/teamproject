<?
class CP_Admin_Modules_Trading_Rfq_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
    ...
    function setSearchVar($linkRecType = '') {
        ...
        if ($tv['record_id'] != '') {
            ...
            if ($tv['special_search'] == "Flagged") {
                $searchVar->sqlSearchVar[] = "qr.flag = 1";
            }
            if ($tv['special_search'] == "Not-Flagged") {
                $searchVar->sqlSearchVar[] = "(qr.flag != 1 OR qr.flag IS null)";
            }
            if ($tv['keyword'] != "") {
    ...
    function getEditValidate() {
        ...
        $validate->validateData('valid_until', 'Please enter Quote Validity');
     ...
     *
     */
    function getTradingRfqTradingProductLinkSQL($id) {
