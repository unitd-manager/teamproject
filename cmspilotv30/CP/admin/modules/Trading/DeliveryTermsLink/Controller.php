<?
class CP_Admin_Modules_Trading_DeliveryTermsLink_Controller extends CP_Common_Lib_ModuleLinkControllerAbstract
{
    function getChooseValues() {
        ...
        $SQL = $this->model->getDeliveryTermsSQL($company_id);
