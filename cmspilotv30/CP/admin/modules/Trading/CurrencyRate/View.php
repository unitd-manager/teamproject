<?
class CP_Admin_Modules_Trading_CurrencyRate_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getNew(){
        ...
        $modCurrencyRate = getCPModuleObj('trading_currencyRate');
    ...
    function getRightPanel($row){
        ...
        $rows = "";
        $rows .= $displayLinkData->getLinkPortalMain("trading_enquiry", "trading_productLink", "Items", $row);
