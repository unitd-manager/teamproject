<?
class CP_Admin_Modules_Trading_ProductLink_Model extends CP_Common_Lib_ModuleLinkModelAbstract
{
    ...
    function getSQL() {
        ...
        } else if ($srcRoom == 'trading_enquiry') {
            $SQL = "
            SELECT DISTINCT
                   p.*
                  ,c.title AS category_title
        ...
        } else if ($srcRoom == 'trading_salesOrder') {
            $SQL = "
            SELECT DISTINCT
                   p.*
                  ,c.title AS category_title
