<?
class CP_Admin_Modules_Trading_Enquiry_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getEdit($row){
        ...
        $sqlSalesAgent = $fn->getDDSql('trading_company', array('condn' => "category = 'Sales Agent'"));
    ...
    function getRightPanel($row){
        ...
        //return;
        //{$displayLinkData->getLinkPortalMain("trading_enquiry", "trading_inventoryLink", "Enquiry Line From Inventory", $row)}

        $links = "";
        $record_id = $fn->getIssetParam($row, 'enquiry_id');

        $links .= "
        {$displayLinkData->getLinkPortalMain("trading_enquiry", "trading_productLink", "Enquiry Line", $row)}
        {$displayLinkData->getLinkPortalMain('trading_enquiry',
                                             'trading_quoteLink', 'Quote', $row)}
        ";

        $text = "
        {$links}
        {$media->getRightPanelMediaDisplay("Attachments", "trading_enquiry", "attachment", $row)}
        {$comment->getView(array(
             'roomName' => 'trading_enquiry'
            ,'recordId' => $record_id
        ))}
        ";
    ...
    function getRaiseRfqList() {
        ...
        $modCompany = getCPModuleObj('trading_company');
