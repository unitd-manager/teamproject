...
//        cpm.trading.enquiry.setupEvents();
        ...
        $('input.select-rfq').live('click', cpm.trading.enquiry.selectConfirmedRfq);
        ...
        //in linking panel
        $('#linkRight .suppliers-cont input.checkbox').live('click', cpm.trading.enquiry.chooseSupplier);
    },
        ...
        $.getJSON(url, {enquiry_id: enquiry_id}, function (json) {
            ...
            var exp = {
               ...
               ,afterOpen: function() {
                    ...
                    $('#btnRaiseRfq').click(cpm.trading.enquiry.raiseRfq);
                }
            };
        ...
        $.getJSON(url, {enquiry_id: enquiry_id}, function (json) {
            ...
            var exp = {
               ...
               ,afterOpen: function() {
                    ...
                    $('#btnRaiseQuote').click(cpm.trading.enquiry.raiseQuote);
                }
            };
    ...
    chooseRFQForLine: function(enquiry_product_id) {
        ...
        var exp = {
           ...
           ,afterOpen: function() {
                ...
                $('#btnChooseRFQSave').click(cpm.trading.enquiry.chooseRFQForLineSave);
            }
        };
    ...
    selectConfirmedRfq: function() {
        ...
        $.getJSON(url, function(json) {
            $('tr[recid=' + enquiry_product_id + '] td.status').html(json.status);
