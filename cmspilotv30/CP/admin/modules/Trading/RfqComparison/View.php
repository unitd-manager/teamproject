<?
class CP_Admin_Modules_Trading_RfqComparison_View extends CP_Common_Lib_ModuleViewAbstract
{
    //========================================================//
    function getList($dataArray){
        ...
        foreach ($dataArray as $row){
            ...
            $rfqText     = $fn->getRecordDetailLink('trading_rfq', 'record_id', $row['quote_request_id'], $expRfq);
            $productText = $fn->getRecordDetailLink('trading_product', 'record_id', $row['product_id'], $expProd);
