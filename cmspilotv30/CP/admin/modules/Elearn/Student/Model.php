<?
class CP_Admin_Modules_ELearn_Student_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
    ...
    function getNewValidate() {
        ...
        $validate->validateData('school_id', 'Please choose the school');
        $validate->validateData('klass_id', 'Please choose the class');
    ...
    function getAdd(){
        ...
        $fa = $this->getFields();
        $id = $fn->addRecord($fa);
        $fnMod = includeCPClass('ModuleFns', 'eLearn_student');
        $fnMod->linkKlassBooksToContact($fa['klass_id'], $id);
