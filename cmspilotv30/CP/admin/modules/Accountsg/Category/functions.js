Util.createCPObject('cpm.accountsg.category');

cpm.accountsg.category.init = function(){
    $("#addNewMenu").livequery('click', function(e){
        e.preventDefault();

        var expObj = {
            callbackOnSuccess: function(){
                Util.closeAllDialogs();
                cpm.accountsg.category.reloadMenu();
            }
        }
...
cpm.accountsg.category.reloadMenu = function(){
    url = "index.php?module=accountsg_category&_spAction=listItems&showHTML=0";
