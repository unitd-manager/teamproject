<?
class CP_Admin_Modules_Subscription_Invoice_View extends CP_Common_Lib_ModuleViewAbstract
{
    function getList($dataArray) {
        ...
        foreach ($dataArray as $row){
		    ...
		    {$listObj->getListDataCell($cpCfg['cp.amount'] ,'right')}
        ...
        {$listObj->getListHeaderCell('Amount', $cpCfg['cp.amount'], 'headerRight')}
    ...
    function getEdit($row) {
        ...
        $expInvNo  = array('isEditable' => $cpCfg['m.subscription.invoice.codeEditable']);
    ...
    function getRightPanel($row) {
        ...
        $text = "
        {$media->getRightPanelMediaDisplay('Attachments', 'subscription_invoice', 'attachment', $row)}
        ";
