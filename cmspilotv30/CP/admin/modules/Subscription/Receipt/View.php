<?
class CP_Admin_Modules_Subscription_Receipt_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getRightPanel($row){
        ...
        $text ="
        <!--{$media->getRightPanelMediaDisplay('Attachments', 'subscription_receipt', 'attachment', $row)}-->
        ";
