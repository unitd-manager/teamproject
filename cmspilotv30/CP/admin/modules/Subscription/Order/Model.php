<?
class CP_Admin_Modules_Subscription_Order_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
        ...
        SELECT o.*		
              ...
              ,CONCAT_WS(' ', o.cust_first_name, o.cust_last_name) AS contact_name
        FROM `order` o
    ...
    function setSearchVar($linkRecType = '') {
        ...
        //$searchVar->sqlSearchVar[] = "o.module = 'subscription_course'";
    ...
    function getFields() {
        ...
        $fa = $fn->addToFieldsArray($fa, 'cust_address');
        $fa = $fn->addToFieldsArray($fa, 'cust_fax');
        ...
        $fa = $fn->addToFieldsArray($fa, 'cust_mobile');
        $fa = $fn->addToFieldsArray($fa, 'cust_address_po_code');               
        ...
        $fa = $fn->addToFieldsArray($fa, 'from_year');
        $fa = $fn->addToFieldsArray($fa, 'to_year');
    ...
    function getGenerateMonthlyInvoiceForEntFormSubmit() {
        ...
        foreach($_POST AS $key => $val){
            ...
            WHERE oi.order_id = {$order_id}
              ...
              AND oi.module = 'subscription_reg_fee'
            ";
            ...
            if ($numRowsOrderItem > 0 && $numRowsInv == 0) {
                ...
                AND module      = 'subscription_subsidy'
