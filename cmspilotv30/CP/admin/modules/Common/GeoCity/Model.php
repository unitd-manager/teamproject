<?
class CP_Admin_Modules_Common_GeoCity_Model extends CP_Common_Modules_Common_GeoCity_Model
{
    /**
     *
     */
    ...
    function getEditValidate() {
        ...
        $validate->validateData('name', 'Please enter the city name');
    ...
    function getImportData(){
        ...
        $fa = array(
              'city_code'    => $phpExcel->getImportFldObj('City Code')
        ...
        $config = array(
             'module'        => 'common_geoCity'
            ,'matchFieldArr' => array('city_code')
            ,'fldsArr'       => $fa
        );
