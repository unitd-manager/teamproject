<?
class CP_Admin_Modules_Pms_Resources_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getEdit($row) {
        ...
        if ($cpCfg['cp.forAceIms'] == 0 && $row['no_of_book'] > 0) {
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$displayLinkData->getLinkPortalMain('pms_resources', 'pms_contactLink', 'Students Linked', $row)}
        ";
