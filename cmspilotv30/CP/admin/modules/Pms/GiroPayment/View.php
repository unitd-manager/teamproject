<?
class CP_Admin_Modules_Pms_GiroPayment_View extends CP_Common_Lib_ModuleViewAbstract
{
        ...
        foreach ($dataArray as $row){
            ...
            */
            ...
            <tr>
                ...
                <td>
                    <a class='button' href='index.php?_topRm=finance&module=pms_order&_action=edit&order_id={$row['order_id']}'  target=''><u>Goto Finance</u></a>
                </td>
            </tr>
            ";
            /*
    ...
    function getSearch() {
        ...
        $action = "index.php?_topRm=finance&module=pms_giroPayment&_action=list";
        $failedStudentsLink = "index.php?module=pms_giroPayment&_spAction=printGiroFailures&month={$month}";

        $reportLink = "index.php?module=pms_order&_spAction=printSelectedInvoices&month_val={$month}&showHTML=0";
            ...
            <tr>
                <tbody>
                    <tr>
                        ...
                        <td><strong>Branch Name</strong></td>
                        <td>Month</td>
                        <td><input id='btnGiroSubmit' class='button' type='submit' value='Update Payment failures'></td>
                    </tr>
                    {$rows}
