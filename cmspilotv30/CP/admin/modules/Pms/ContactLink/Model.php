<?
class CP_Admin_Modules_Pms_ContactLink_Model extends CP_Common_Lib_ModuleLinkModelAbstract
{
    function getSQL() {
    ...
    */
    function getNewValidate() {
        ...
        if ($email != ''){
            ...
            $emailLink = $fn->getRecordDetailLink('pms_contact', 'record_id', $rec['contact_id'], $expEmail);
    ...
    */
    function setSearchVar($linkRecType) {
        ...
        $modObj = getCPModuleObj('pms_contact');
