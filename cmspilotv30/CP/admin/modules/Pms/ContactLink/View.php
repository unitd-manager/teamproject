<?
class CP_Admin_Modules_Pms_ContactLink_View extends CP_Common_Lib_ModuleLinkViewAbstract
{
    function getList($dataArray, $linkRecType) {
        ...
        if ($tv['srcRoom'] == 'pms_class' && $tv['lnkRoom'] == 'pms_contactLink') {
    ...
    */
    function getNew(){
        ...
        if ($tv['srcRoom'] == 'pms_resources' && $tv['lnkRoom'] == 'pms_contactLink') {
    ...
    */
    function getNewForResources(){
        ...
        $sqlContact = $fn->getDDSql('pms_contact');
