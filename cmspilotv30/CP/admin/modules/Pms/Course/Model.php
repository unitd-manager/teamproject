<?
class CP_Admin_Modules_Pms_Course_Model extends CP_Common_Modules_Pms_Course_Model
{
    function getSQL() {
    ...
    */
    function getPmsCoursePmsBatchLinkSQL($id) {
        $fn = Zend_Registry::get('fn');
        $cpCfg = Zend_Registry::get('cpCfg');
     ...
     * @param type $id = course_id
    */
    function getPmsCoursePmsCourseSubsidyLinkSQL($id) {
     ...
     * @param type $id = course_id
    */
    function getPmsCoursePmsLevelLinkSQL($id) {
    ...
    */
     ...
     * @param type $id = course_id
    */
    function getPmsCoursePmsSubjectLinkSQL($id) {
