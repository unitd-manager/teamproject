<?
class CP_Admin_Modules_Pms_Feedback_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    function getList($dataArray){
        ...
        foreach ($dataArray as $row){
            ...
            {$listObj->getGoToDetailText($rowCounter, $row['group'])}
        ...
        {$listObj->getListHeaderCell('Group', 'f.group')}
    ...
    function getEdit($row) {
        ...
        $fielset1 = "
        {$formObj->getDDRowBySQL('Group', 'group', $sqlFeedbackGroup, $row['group'] , $expVL)}
