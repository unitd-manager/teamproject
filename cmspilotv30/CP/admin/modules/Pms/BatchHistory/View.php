<?
class CP_Admin_Modules_Pms_BatchHistory_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        $url = "index.php?module=pms_batch&_spAction=bulkUpdateEvaluate&id={$row['course_contact_id']}&showHTML=0";
        
        $text ="
        {$media->getRightPanelMediaDisplay('Certificate', 'pms_batchHistory', 'attachment', $row)}
        ";
        return $text;
    }
