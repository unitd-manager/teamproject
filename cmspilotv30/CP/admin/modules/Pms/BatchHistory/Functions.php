<?
class CP_Admin_Modules_Pms_BatchHistory_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('pms_batchHistory');
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('pms_batchHistory', 'picture', 'image');
        $mediaObj = $mediaArr->getMediaObj('pms_batchHistory', 'attachment', 'attachment');
