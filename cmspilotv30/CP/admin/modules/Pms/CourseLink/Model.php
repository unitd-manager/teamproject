<?
class CP_Admin_Modules_Pms_CourseLink_Model extends CP_Common_Lib_ModuleLinkModelAbstract
{
    function getFields(){
        ...
        //if ($fa['course_id'] > 0){
            ...
            */
            ...
            //if there is change in subsidy/batch record below code will update the subsidy in order items
                ...
                $expOrderItemSubsidy = array('condn' => " AND module = 'pms_subsidy'");
                ...
                if ($discount){
                    $expOrderItemDiscount = array('condn' => " AND module = 'pms_discount'");
    ...
    */
    function getSaveCoursePvtLink() {
        ...
        if($existingCCRec['course_id'] != $course_id){
            ...
            $expOrderItemCourse = array('condn' => " AND module = 'pms_course'");
