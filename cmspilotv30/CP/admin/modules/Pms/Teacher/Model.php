<?
class CP_Admin_Modules_Pms_Teacher_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
     ...
     *
     */
    function getPmsTeacherPmsCourseLinkSQL($id) {
