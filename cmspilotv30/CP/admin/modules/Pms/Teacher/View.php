<?
class CP_Admin_Modules_Pms_Teacher_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Picture', 'pms_teacher', 'picture', $row)}
        {$media->getRightPanelMediaDisplay('Attachments', 'pms_teacher', 'attachment', $row)}
        {$displayLinkData->getLinkPortalMain('pms_teacher', 'pms_courseLink', 'Course Linked', $row)}
        {$displayLinkData->getLinkPortalMain('pms_teacher', 'pms_batchLink', 'Batch Linked', $row)}
        ";
        return $text;
    }
