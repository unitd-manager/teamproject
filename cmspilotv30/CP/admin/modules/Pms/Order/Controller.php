<?
class CP_Admin_Modules_Pms_Order_Controller extends CP_Common_Lib_ModuleControllerAbstract
{
   ...
   /**
     ...
     *
     */
    function getApplySpecialDiscountForInvoiceForm() {
        return $this->view->getApplySpecialDiscountForInvoiceForm();
    }    

    /**
     *
     */
    function getApplySpecialDiscountForInvoiceFormSubmit() {
        return $this->model->getApplySpecialDiscountForInvoiceFormSubmit();
    }    
}