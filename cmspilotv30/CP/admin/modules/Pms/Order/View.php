        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            <div class='form-row-wrapper'>
                <div class='floatbox'>
                    ...
                    <div class='float_left'>{$row['invoice_code']}({$row['invoice_amount']}INR)</div>
                    <div class=''>Paid:{$row['prev_inv_amount']}INR</div>
                </div>
            </div>
            ";
        }
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            <div class='mb10'>
                <div class='floatbox'>
                    ...
                    <div class='float_left'>{$row['invoice_hist_title']} ({$invoice_hist_amount} INR)</div>
                    <div class='float_left'> : {$row['invoice_hist_status']}</div>
                    <div class=''>Paid:{$amount_already_paid}INR</div>
                </div>
            </div>
            ";
            $count++;
