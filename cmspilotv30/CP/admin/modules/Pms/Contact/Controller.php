<?
class CP_Admin_Modules_Pms_Contact_Controller extends CP_Common_Lib_ModuleControllerAbstract
{
    ...
    */
    ...
    /**
     * To update discount amount in course contact table. Script is written (ARIF)
     */
    function getUpdateDiscountAmount() {
        return $this->model->getUpdateDiscountAmount();
    }

    /**
     * To update year of joining in contact table. Script is written (ARIF)
     */
    function getUpdateEnrollmentYearInContact() {
        return $this->model->getUpdateEnrollmentYearInContact();
    }
}