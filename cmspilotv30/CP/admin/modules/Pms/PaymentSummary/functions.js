...
Util.createCPObject('cpm.pms.paymentSummary');

cpm.pms.giroPayment = {
    init: function(){
        $('.click-all-top .check-all').click(cpm.pms.paymentSummary.checkAllCol);
        $('.click-all-top .uncheck-all').click(cpm.pms.paymentSummary.uncheckAllCol);
    },
...
$('.m-pms_paymentSummary form.giroForm .invoiceCode').livequery('click', function(e){
    var invoice_code  = $(this).val();
    var is_checked  = $(this).is(':checked');

    var url = 'index.php?module=pms_paymentSummary&_spAction=setInvoiceCodeForSession&showHTML=0';
...
$('#generateReceiptForParent').livequery('click', function (e){
    ...
    $("select[name='mode_of_payment']").livequery('change', function (e){
        cpm.pms.giroPayment.populatePaymentMode.call(this);
    });
    ...
    var expObj = {
       ...
       ,callbackOnSuccess: function(){
            ...
            var url = "index.php?_topRm=finance&module=pms_order&_spAction=printGroupReceiptInFpdf&showHTML=0";
...
cpm.pms.giroPayment.populatePaymentMode = function(){
...
$('.receiptFormForParent .populateAmountPayable').livequery('click', function (e){
    ...
    var url = 'index.php?_topRm=finance&module=pms_order&_spAction=calculateAmountPayable&showHTML=0';
    Util.showProgressInd();
