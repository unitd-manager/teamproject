<?
class CP_Admin_Modules_Pms_ProgramGroup_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$displayLinkData->getLinkPortalMain('pms_programGroup', 'pms_subsidyDiscountLink', 'Subsidy Discount Link', $row)}
        ";
