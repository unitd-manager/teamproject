<?
class CP_Admin_Modules_Pms_Reports_Model extends CP_Common_Lib_ModuleModelAbstract
{
    ...
    function __construct() {
        ...
        $this->reportsArray = array(
           ...
           ,'studentEnrollmentReport'       => $this->getReportObj('studentEnrollmentReport', 'Student Enrollment Report')
           ,'monthlyFinancialReport'        => $this->getReportObj('monthlyFinancialReport', 'Monthly Financial Report')
           ,'statementofAccountReport'      => $this->getReportObj('statementofAccountReport', 'Statement of Account Report')
           ,'enrollmentByYearReport'        => $this->getReportObj('enrollmentByYearReport', 'Enrollment By Year Report')
           ,'enrollmentBySummaryReport'     => $this->getReportObj('enrollmentBySummaryReport', 'Enrollment By Summary Report')
           ,'giroFailureReport'             => $this->getReportObj('giroFailureReport', 'Giro Failure Report')
           ,'giroFailureByMonthReport'      => $this->getReportObj('giroFailureByMonthReport', 'Giro Failure by Month Report')
           ,'overdueReport'                 => $this->getReportObj('overdueReport', 'Overdue Fees Report')
           ,'studentParentReport'           => $this->getReportObj('studentParentReport', 'Student Parent Report')
           ,'attendanceSummaryReport'       => $this->getReportObj('attendanceSummaryReport', 'Attendance Summary Report')
           ,'attendanceDetailReport'        => $this->getReportObj('attendanceDetailReport', 'Attendance Detail Report')
           ,'attendanceAbsentReport'        => $this->getReportObj('attendanceAbsentReport', 'Attendance Absent Report')
           ,'assessmentReport'              => $this->getReportObj('assessmentReport', 'Assessment Report')
           ,'smsBroadcastReport'            => $this->getReportObj('smsBroadcastReport', 'SMS Broadcast Report')
        );
