<?
class CP_Admin_Modules_Pms_Company_Functions extends CP_Common_Modules_Pms_Company_Functions
{
    /**
     *
     */
    ...
    function setLinksArray($inst) {
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('pms_company', 'pms_orderLink');
		...
		*/
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('pms_company', 'pms_contactLink');
