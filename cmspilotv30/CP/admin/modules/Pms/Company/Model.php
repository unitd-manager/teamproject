<?
class CP_Admin_Modules_Pms_Company_Model extends CP_Common_Modules_Pms_Company_Model
{
    /**
     *
     */
     ...
     *
     */
    function getPmsCompanyPmsOrderLinkSQL($id) {
     ...
     *
     */
    function getPmsCompanyPmsContactLinkSQL($id) {
    ...
    function getCompanyAddValidate() {
        ...
        if ($reg_number != ''){
            ...
            $emailLink = $fn->getRecordDetailLink('pms_company', 'record_id', $rec['company_id'], $expEmail);
