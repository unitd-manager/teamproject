<?
class CP_Admin_Modules_Pms_Company_View extends CP_Common_Modules_Pms_Company_View
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        if($cpCfg['m.pms.company.hasCompanyEnrollment']){
        ...
        $text = "
        {$displayLinkData->getLinkPortalMain('pms_company', 'pms_contactLink', 'Contacts Linked', $row)}
        {$rows}
        ";
    ...
    function getCourseContactDisplay($row){
        ...
        while ($rowCC = $db->sql_fetchrow($result)) {
            if ($order_id != $rowCC['order_id']){
                ...
                */
                ...
                $editurl = "index.php?_topRm=main&_spAction=courseTraineeSearch&module=pms_orderLink&srcRoom=pms_company&lnkRoom=pms_orderLink&company_id={$row['company_id']}&order_id={$rowCC['order_id']}&showHTML=0
                ";
                ...
                <tr style='background-color: #F4F4F4; color:#000000;'>
                    ...
                    <td class='portalActBtns'>
                        <div style='float:right'>
                            ...
                            <a class='deletePortalRecord' srcroomid={$row['company_id']} link='/admin/index.php?_spAction=deletePortalRecordByID&srcRoom=pms_company&lnkRoom=pms_orderLink&id={$rowCC['order_id']}&showHTML=0' href='javascript:void(0);'>
        ...
        $text = "
        <div class='linkPortalWrapper pms_company__pms_orderLink' id='pms_company#pms_orderLink'>
            <div expanded='1' class='header'>
                <div class='linkPortalDataWrapper'>
                    <div class='actBtns'>
                        <a id='bulkCompanyCourseLink' class='' dialogtitle='Bulk Company Trainee Link' href='index.php?_topRm=main&_spAction=courseTraineeSearch&module=pms_orderLink&srcRoom=pms_company&lnkRoom=pms_orderLink&company_id={$row['company_id']}&showHTML=0';'> 
    ...
    function getCourseTraineePortal($row){
        ...
        $text = "
        <div class='linkPortalWrapper pms_company__pms_orderLink' >
            <div expanded='1' class='header'>
                <div class='linkPortalDataWrapper'>
                    <div class='actBtns'>
                        <a id='bulkCompanyCourseLink' class='' dialogtitle='Bulk Company Trainee Link' href='index.php?_topRm=main&_spAction=courseTraineeSearch&module=pms_orderLink&srcRoom=pms_company&lnkRoom=pms_orderLink&srcRoomId={$row['company_id']}&showHTML=0';'> 
                            Add
                        </a>
                    </div>
                </div>
    ...
    function getCourseTraineePortalOrgnl($row){
        ...
        <div class='linkPortalWrapper pms_company__pms_orderLink' id='pms_company#pms_orderLink'>
            <div expanded='1' class='header'>
                <div class='linkPortalDataWrapper'>
                    <div class='actBtns'>
                        <a class='newPortalRecord' h='525' w='1100' dialogtitle='Bulk Company Trainee Link' link='/admin/index.php?_spAction=courseTraineeSearch&srcRoom=pms_company&lnkRoom=pms_orderLink&srcRoomId={$row['company_id']}&showHTML=0' href='javascript:void(0);'> 
                            Add
                        </a>
                    </div>
                </div>
    ...
    function getCompanyNew(){
        ...
        $formAction ='index.php?module=pms_company&_spAction=companyAddSubmit&showHTML=0';
        $text = "
