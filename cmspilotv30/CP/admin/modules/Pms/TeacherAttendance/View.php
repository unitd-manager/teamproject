<?
class CP_Admin_Modules_Pms_TeacherAttendance_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getNew(){
        ...
        $formObj = Zend_Registry::get('formObj');
   		...
   		$sqlTeacher = getCPModuleObj('pms_teacher')->model->getTeacherSQL();
...
/*        $sqlTeacher = $fn->getDDSql('pms_teacher');
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'pms_teacherAttendance', 'attachment', $row)}
        ";
