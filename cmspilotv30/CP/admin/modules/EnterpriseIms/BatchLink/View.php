<?
class CP_Admin_Modules_EnterpriseIms_BatchLink_View extends CP_Common_Lib_ModuleLinkViewAbstract
{
    /**
     *
     */
    function getList($dataArray, $linkRecType) {
        ...
        foreach ($dataArray as $row){
            ...
            {$listLinkObj->getListRowEndLink($linkRecType, $row['batch_id'])}
            ";            
            $rowCounter++;
        }
