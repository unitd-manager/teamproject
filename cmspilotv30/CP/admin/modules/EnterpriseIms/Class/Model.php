<?
class CP_Admin_Modules_EnterpriseIms_Class_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
     ...
     *
     */
    function getEnterpriseImsClassEnterpriseImsContactLinkSQL($id) {
        return $SQL = "
