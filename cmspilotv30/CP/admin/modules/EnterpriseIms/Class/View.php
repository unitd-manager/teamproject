<?
class CP_Admin_Modules_EnterpriseIms_Class_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'enterpriseIms_class', 'attachment', $row)}
		{$displayLinkData->getLinkPortalMain('enterpriseIms_class', 'enterpriseIms_contactLink', 'Contact Linked', $row)}
        ";
