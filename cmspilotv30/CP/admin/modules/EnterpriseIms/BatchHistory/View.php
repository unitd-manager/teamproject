<?
class CP_Admin_Modules_EnterpriseIms_BatchHistory_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getEdit($row) {
        ...
        $sqlTeacher  = $fn->getDDSql('enterpriseIms_teacher', $exp);
    ...
    function getRightPanel($row){
        ...
        $url = "index.php?module=enterpriseIms_batch&_spAction=bulkUpdateEvaluate&id={$row['course_contact_id']}&showHTML=0";
        
        $text ="
        {$media->getRightPanelMediaDisplay('Certificate', 'enterpriseIms_batchHistory', 'attachment', $row)}
        ";
        return $text;
    }
