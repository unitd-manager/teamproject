<?
class CP_Admin_Modules_EnterpriseIms_Receipt_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'enterpriseIms_receipt', 'attachment', $row)}
        ";
