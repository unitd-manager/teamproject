<?
class CP_Admin_Modules_EnterpriseIms_Company_Model extends CP_Common_Modules_EnterpriseIms_Company_Model
{
    /**
     *
     */
     ...
     *
     */
    function getEnterpriseImsCompanyEnterpriseImsOrderLinkSQL($id) {
        ...
        SELECT a.order_id
              ...
              ,(SELECT c.title 
                FROM course c
                WHERE c.course_id = oi.record_id) as course_title
              ,CONCAT_WS(' ', cont.first_name, cont.last_name) as contact_name
        FROM `order` a 
        LEFT JOIN order_item oi ON (oi.order_id = a.order_id)
     ...
     *
     */
    function getEnterpriseImsCompanyEnterpriseImsContactLinkSQL($id) {
    ...
    function getCompanyAddValidate() {
        ...
        if ($reg_number != ''){
            ...
            $emailLink = $fn->getRecordDetailLink('enterpriseIms_company', 'record_id', $rec['company_id'], $expEmail);
