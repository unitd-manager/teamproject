<?
class CP_Admin_Modules_EnterpriseIms_Company_Functions extends CP_Common_Modules_EnterpriseIms_Company_Functions
{
    /**
     *
     */
    ...
    function setLinksArray($inst) {
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('enterpriseIms_company', 'enterpriseIms_orderLink');
        ...
        /* DO NOT DELETE - SYED
        $courseArr = $fn->getDdDataAsArray('enterpriseIms_course');
        $batchArr = $fn->getDdDataAsArray('enterpriseIms_batch');
		$inst->registerLinksArray($linkObj, array(
		...
		*/
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('enterpriseIms_company', 'enterpriseIms_contactLink');
