<?
class CP_Admin_Modules_EnterpriseIms_CourseSubsidyLink_Model extends CP_Common_Lib_ModuleLinkModelAbstract
{
    /**
     *
     */
    ...
    function getSQL($linkRecType) {
        $modObj = getCPModuleObj('enterpriseIms_subsidyDiscount');
