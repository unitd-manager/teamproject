<?
class CP_Admin_Modules_EnterpriseIms_CourseLink_Functions
{
    function setModuleArray($modules){
        $fn = Zend_Registry::get('fn');
        $tv = Zend_Registry::get('tv');
    
        $modObj = $modules->getModuleObj('enterpriseIms_courseLink');
        if ($tv['srcRoom'] == 'enterpriseIms_teacher' || $tv['srcRoom'] == 'enterpriseIms_document'){
