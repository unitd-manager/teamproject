<?
class CP_Admin_Modules_EnterpriseIms_Batch_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        $modObj = $modules->getModuleObj('enterpriseIms_batch');
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('enterpriseIms_batch', 'picture', 'image');
        $mediaObj = $mediaArr->getMediaObj('enterpriseIms_batch', 'attachment', 'attachment');
    ...
    */
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('enterpriseIms_batch', 'enterpriseIms_contactLink');        
	   ...
	   //------------------------------------------------------------------------------//
        ...
        $linkObj = $inst->getLinksArrayObj('enterpriseIms_batch', 'enterpriseIms_teacherLink');        
        $inst->registerLinksArray($linkObj, array(
       ...
       $linkObj = $inst->getLinksArrayObj('enterpriseIms_batch', 'enterpriseIms_assessorLink');
       $inst->registerLinksArray($linkObj, array(
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('enterpriseIms_batch', 'enterpriseIms_attendance');               
        $inst->registerLinksArray($linkObj, array(
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('enterpriseIms_batch', 'enterpriseIms_feedback');        
        $inst->registerLinksArray($linkObj, array(
    ...
    *
    */
    function getEnterpriseImsBatchEnterpriseImsContactLinkAddLinkCallback($course_contact_id, $row) {
        ...
        if ($row['order_id'] == ''){
            ...
            $fa['payment_method']  = '';
            $fa['module']          = 'enterpriseIms_course';
            $fa['order_status']    = 'Due';
            $fa['order_date']      =  date('Y-m-d');
            $fa['contact_module']  = 'enterpriseIms_contact';
    ...
    *
    */
    function getEnterpriseImsBatchEnterpriseImsContactLinkDeleteLinkCallback($batch_id, $contact_id) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
        $fn = Zend_Registry::get('fn');
    ...
    *
    */
    function getEnterpriseImsBatchEnterpriseImsContactLinkAddAllLinkCallback($batch_id, $newly_created_contact_ids) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
    ...
    *
    */
    function getEnterpriseImsBatchEnterpriseImsContactLinkRemoveAllLinkCallback($batch_id, $removed_contact_ids) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
     ...
     *
     */
    function getEnterpriseImsBatchEnterpriseImsContactLinkPortalSearch() {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
        $fn = Zend_Registry::get('fn');
