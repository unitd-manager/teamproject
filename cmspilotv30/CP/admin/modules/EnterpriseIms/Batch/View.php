<?
class CP_Admin_Modules_EnterpriseIms_Batch_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    function getList($dataArray){
        ...
        {$listObj->getListHeaderCell($modulesArr['enterpriseIms_course']['title'], 'course_title')}
    ...
    function getRightPanel($row){
        ...
        if($cpCfg['m.enterpriseIms.batch.printAttendanceExcell']){
            ...
            $urlAttendance = "index.php?module=enterpriseIms_batch&_spAction=printAttendance&id={$row['batch_id']}&showHTML=0";
        }
        ...
        {$printText}
        {$actionText}
        {$displayLinkData->getLinkPortalMain('enterpriseIms_batch', 'enterpriseIms_contactLink', 'Contacts Linked', $row)}
        {$displayLinkData->getLinkPortalMain('enterpriseIms_batch', 'enterpriseIms_teacherLink', 'Trainers Linked', $row)}
        {$media->getRightPanelMediaDisplay('Attendance Attachment', 'enterpriseIms_batch', 'attachment', $row)}
        {$rows}
        ";
    ...
    function getAttendancePortalDisplay($row){
                ...
                <tr style='background-color: #F4F4F4; color:#000000;'>
                    <td class='portalActBtns'>
                        ...
                        <div style='float:right'>  
                            <a class='editAttendance' class='' h='350' w='650' recid={$rowCC['attendance_id']} dialogtitle='Edit Attendance' link='index.php?module=enterpriseIms_batch&_spAction=editAttendance&id={$rowCC['batch_id']}&attendance_id={$rowCC['attendance_id']}
        ...
        $text = "
        <div class='linkPortalWrapper enterpriseIms_batch__enterpriseIms_attendance' id='enterpriseIms_batch#enterpriseIms_attendance'>
            <div expanded='1' class='header'>
                <div class='linkPortalDataWrapper'>
                    <div class='actBtns'>
                        <a id='takeAttendance' class='button' dialogtitle='Take Attendance' href='index.php?module=enterpriseIms_batch&_spAction=takeAttendance&id={$row['batch_id']}&showHTML=0'> 
    ...
    function getStudentGradePortalDisplay($row){
        ...
        while ($rowCC = $db->sql_fetchrow($result)) {
            ...
            if ($presentDate != $rowCC['exam_date']){
                ...
                <tr style='background-color: #F4F4F4; color:#000000;'>
                    ...
                    <td>
                        <a class='editStudentGrade' class='' h='350' w='650' recid={$rowCC['student_grade_id']} dialogtitle='Edit Attendance' link='index.php?module=enterpriseIms_batch&_spAction=editStudentGrade&id={$rowCC['batch_id']}&type={$rowCC['exam_type']}&date={$rowCC['exam_date']}&student_grade_id={$rowCC['student_grade_id']}&showHTML=0'>
                            <img border='0' title='Edit Record' src='/cmspilotv30/CP/admin/images/icons/btn_edit.png'>
                        </a>                        
                    </td>
                </tr>
        ...
        $text = "
        <div class='linkPortalWrapper enterpriseIms_batch__enterpriseIms_studentGrade' id='enterpriseIms_batch#enterpriseIms_studentGrade'>
            <div expanded='1' class='header'>
                <div class='linkPortalDataWrapper'>
                    <div class='actBtns'>
                        <a id='studentGrade' class='button' dialogtitle='Student Grade' href='index.php?module=enterpriseIms_batch&_spAction=studentGrade&id={$row['batch_id']}&showHTML=0'> 
    ...
    function getStudentFeedbackDisplay($row){
        ...
        while ($rowCC = $db->sql_fetchrow($result)) {   
            ...
            <tr style='background-color: #F4F4F4; color:#000000;'>
                <td class='portalActBtns'>
                    ...
                    <div style='float:right'>  
                        <a class='editStudentFeedback' class='' h='350' w='650' recid={$row['batch_id']} dialogtitle='Edit Student Feedback' href='index.php?module=enterpriseIms_batch&_spAction=editStudentFeedback&id={$rowCC['batch_feedback_id']}&title={$rowCC['title']}&showHTML=0'>
                            <img border='0' title='Edit Record' src='/cmspilotv30/CP/admin/images/icons/btn_edit.png'>
                        </a>                        
                    </div>
                </td>
        ...
        $text = "
        <div class='linkPortalWrapper enterpriseIms_batch__enterpriseIms_feedback' id='enterpriseIms_batch#enterpriseIms_feedback'>
            <div expanded='1' class='header'>
                <div class='linkPortalDataWrapper'>
                    <div class='actBtns'>
                        <a id='studentFeedback' class='button' dialogtitle='Student Feedback' href='index.php?module=enterpriseIms_batch&_spAction=studentFeedback&id={$row['batch_id']}&showHTML=0'> 
     ...
     */
     function getTakeAttendance() {
        ...
        $formAction  = "index.php?module=enterpriseIms_batch&_spAction=takeAttendanceSubmit&showHTML=0";
     ...
     */
     function getStudentGrade() {
        ...
        $formAction   = "index.php?module=enterpriseIms_batch&_spAction=studentGradeSubmit&showHTML=0";
     ...
     */
     function getStudentFeedback() {
        ...
        $formAction = "index.php?module=enterpriseIms_batch&_spAction=studentFeedbackSubmit&showHTML=0";

        $text = "
        <div id='studentFeedbackOuter'>
            <form id='portalForm' class='yform columnar enterpriseIms_batch__enterpriseIms_studentFeedbackLink' method='post' action='{$formAction}'>
                <div class='floatbox'>
     ...
     */
     function getEditStudentFeedback() {
        ...
        $formAction = "index.php?module=enterpriseIms_batch&_spAction=editStudentFeedbackSubmit&showHTML=0";
     ...
     */
     function getEditAttendance() {
        ...
        $formAction = "index.php?module=enterpriseIms_batch&_spAction=editAttendanceSubmit&showHTML=0";
     ...
     */
     function getEditStudentGrade() {
        ...
        $formAction = "index.php?module=enterpriseIms_batch&_spAction=editStudentGradeSubmit&showHTML=0";
    ...
    function getBulkUpdateEvaluate() {
        ...
        $formAction = "index.php?module=enterpriseIms_batch&_spAction=bulkUpdateEvaluateSubmit&showHTML=0";
