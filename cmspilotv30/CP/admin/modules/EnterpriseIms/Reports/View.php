<?
class CP_Admin_Modules_EnterpriseIms_Reports_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getReportsDropdown() {
        ...
        if ($cpCfg['m.pms.reports.showIncomeByStudentEntReport']){
    ...
    function getDisplayReport($text){
        ...
        if ($report == 'receiptSummary' || $report == 'paymentOutstandingReport' 
         || $report == 'studentEnrollmentReport' || $report == 'monthlyFinancialReport') {
            $text = "
            <div>
