<?
class CP_Admin_Modules_EnterpriseIms_Document_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
     ...
     *
     */
    function getEnterpriseImsDocumentEnterpriseImsCourseLinkSQL($id) {
