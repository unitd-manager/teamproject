<?
class CP_Admin_Modules_EnterpriseIms_Order_Functions
{
    function setModuleArray($modules){
        $cpCfg = Zend_Registry::get('cpCfg');
        $modObj = $modules->getModuleObj('enterpriseIms_order');
    ...
    function setActionsArray($actArrayObj){
        ...
        $actArrayObj->registerAction($actObj, array(
            'title' => 'Print'
           ,'url' => "index.php?module=enterpriseIms_order&_spAction=printOrder"
        ));
    }
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('enterpriseIms_order', 'ecommerce_orderItemLink');
        ...
        //------------------------------------------------------------------------------//
        /*$linkObj = $inst->getLinksArrayObj('enterpriseIms_order', 'enterpriseIms_paymentLink');
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('enterpriseIms_order', 'enterpriseIms_insuranceLink');
    ...
    function getPrintOrderIndividual($order_id) {
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            if($row['module'] == 'enterpriseIms_course'){
                $courseTxt = 'Programme Fee';
            }
            else if($row['module'] == 'enterpriseIms_subsidy'){
                $courseTxt = 'Rebate for Tuition Fee';
            }
            else if($row['module'] == 'enterpriseIms_discount'){
                $courseTxt = 'Discount';
            }
            else{
                $courseTxt = ''; 
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('enterpriseIms_order', 'attachment', 'attachment');
