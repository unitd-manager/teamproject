<?
class CP_Admin_Modules_EnterpriseIms_OrderLink_Model extends CP_Common_Lib_ModuleLinkModelAbstract
{
    /**
    */
    function getParentFields(){
        ...
        $fa['contact_module']   = 'enterpriseIms_parent';
    ...
    */
    ...
    /**
    Submit functionality for Parent enrollment form
    */
    ...
    /**
    Deletes the student from enrollment process
    */
    ...
    /**
    Saves student data when the user edits the student data from enrollment modal window
    */
    ...
    /**
    Adds a new student when the user adds a new student from enrollment modal window
    */
    ...
    */
    ...
    /**
    Submit functionality for Parent Student enrollment form
    */
    ...
    /**
    Checks for previous enrollment for the selected year for the selected students
    */
    ...
    /**
    Calculate age of Student of student according to date of birth in Enrollment (when a new student is added) and Contact edit
    */
    ...
    /**
    Generate invoice records for all the months selected for enrollment in New Enrollment form
     */
