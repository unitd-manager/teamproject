Util.createCPObject('cpm.enterpriseIms.batchTransfer');
cpm.enterpriseIms.batchTransfer.init = function(){
    ...
    $('#studentSearchForm #fld_course_id').livequery('change', function(){
        ...
        Util.showProgressInd('Populating Year and Session for the Selected Course.... Please wait');
        
        if (courseId != '') {
            $('#studentSearchForm .row_level_id').removeClass('hideme');
            $('#studentSearchForm .row_batch_id').removeClass('hideme');
        } else {
            $('#studentSearchForm .row_level_id').addClass('hideme');
            $('#studentSearchForm .row_batch_id').addClass('hideme');
        }

        cpm.enterpriseIms.batchTransfer.populateLevel.call(this);
        cpm.enterpriseIms.batchTransfer.populateBatch.call(this);
    ...
    $('#studentSelectedForm #fld_enrollment_course_id').livequery('change', function(){
        ...
        if (courseId != '') {
            $('#studentSelectedForm .row_enrollment_level_id').removeClass('hideme');
...
cpm.enterpriseIms.batchTransfer.populateLevel = function(){
    var courseId = $(this).val();
    var formName = $(this).closest('form').attr('id');
...
cpm.enterpriseIms.batchTransfer.populateBatch = function(){
    var courseId = $(this).val();
    var formName = $(this).closest('form').attr('id');
...
$('table.studentSearchRow .addTrainee').livequery('click', function(e){
    ...
    var url = 'index.php?module=enterpriseIms_batchTransfer&_spAction=selectedStudentListRow&showHTML=0';
...
$('table.studentsSelectedLinked .removeTrainee').livequery('click', function(e){
    ...
    $(parent).remove();
    var contact_id = $(this).attr('contact_id');
    var url = 'index.php?module=enterpriseIms_batchTransfer&_spAction=removeTrainee&showHTML=0';
...
$('table.studentSearchRow .addAllTrainee').livequery('click', function(e){
    ...
    var url = 'index.php?module=enterpriseIms_batchTransfer&_spAction=allSelectedStudentListRow&showHTML=0';
...
$('table.studentsSelectedLinked .removeAllTrainee').livequery('click', function(e){
    ...
    $(parent).remove();
    var url = 'index.php?module=enterpriseIms_batchTransfer&_spAction=removeAllTrainee&showHTML=0';
