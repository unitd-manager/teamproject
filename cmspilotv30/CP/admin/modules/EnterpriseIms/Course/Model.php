<?
class CP_Admin_Modules_EnterpriseIms_Course_Model extends CP_Common_Modules_EnterpriseIms_Course_Model
{
    function getSQL() {
     ...
     */
    function getEnterpriseImsCourseEnterpriseImsBatchLinkSQL($id) {
        $fn = Zend_Registry::get('fn');
     ...
     * @param type $id = course_id
    */
    function getEnterpriseImsCourseEnterpriseImsCourseSubsidyLinkSQL($id) {
     ...
     * @param type $id = course_id
    */
    function getEnterpriseImsCourseEnterpriseImsLevelLinkSQL($id) {
