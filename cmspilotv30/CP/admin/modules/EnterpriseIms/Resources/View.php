<?
class CP_Admin_Modules_EnterpriseIms_Resources_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$displayLinkData->getLinkPortalMain('enterpriseIms_resources', 'enterpriseIms_contactLink', 'Students Linked', $row)}
        ";
