<?
class CP_Admin_Modules_EnterpriseIms_Resources_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     */
    function getSQL() {
    ...
    /**
     */
    function getEnterpriseImsResourcesEnterpriseImsContactLinkSQL($id) {
