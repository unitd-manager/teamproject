<?
class CP_Admin_Modules_EnterpriseIms_Resources_Functions
{
    function setModuleArray($modules){
        $modObj = $modules->getModuleObj('enterpriseIms_resources');
    ...
    function setLinksArray($inst) {
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('enterpriseIms_resources', 'enterpriseIms_contactLink');
