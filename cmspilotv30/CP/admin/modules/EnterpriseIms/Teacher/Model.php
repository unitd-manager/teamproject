<?
class CP_Admin_Modules_EnterpriseIms_Teacher_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
     ...
     *
     */
    function getEnterpriseImsTeacherEnterpriseImsCourseLinkSQL($id) {
        return "
