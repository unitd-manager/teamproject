<?
class CP_Admin_Modules_EnterpriseIms_Grade_View extends CP_Common_Lib_ModuleViewAbstract
{
    function getList($dataArray){
        ...
        foreach ($dataArray as $row){
            ...
            {$listObj->getListRowEnd($row['student_grade_id'])}
            ";
            $rowCounter++ ;
        }
    ...
    function getNew(){
        ...
        $sqlCont = $fn->getDDSql('enterpriseIms_contact');
    ...
    function getEdit($row) {
        ...
        $sqlBatch = $fn->getDDSql('enterpriseIms_batch');
