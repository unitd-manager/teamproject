<?
class CP_Admin_Modules_EnterpriseIms_PaymentSummary_View extends CP_Common_Lib_ModuleViewAbstract
{
    function getList($dataArray){
        ...
        foreach ($dataArray as $row){
            ...
            <tr>
                ...
                <td>
                    <a href='index.php?_topRm=finance&module=enterpriseIms_order&_action=edit&order_id={$row['order_id']}'  target=''><u>Goto Finance</u></a>
                </td>
            </tr>
            ";
        }

        $formAction = "index.php?module=enterpriseIms_giroPayment&_spAction=giroPaymentSubmit&showHTML=0";        
        $url = 'index.php?_topRm=finance&module=enterpriseIms_giroPayment&_spAction=generateDBSTxtFile&showHTML=0';
        ...
        <form id='frmGiro' class='yform columnar giroForm' method='post' action='{$formAction}'>
            <table class='thinlist room-giroPayment-table'>
                <tr>
                    <thead>
                        <!--<div class='actBtns'>
                            <a id='giroSubmit' class='button giroSubmit' href='index.php?module=enterpriseIms_giroPayment&_spAction=giroPaymentSubmit&showHTML=0'> 
                            <h3>Submit</h3>
                            </a>
                        </div>-->
                    </thead>
    ...
    function getSearch() {
        ...
        $action = "index.php?_topRm=finance&module=enterpriseIms_paymentSummary&_action=list";
        $reportLink = "index.php?module=enterpriseIms_order&_spAction=printSelectedInvoices&year={$year}&showHTML=0";
        $receiptLink = "index.php?_topRm=finance&module=enterpriseIms_paymentSummary&_spAction=makePaymentForParentForm&showHTML=0";
     ...
     */
     function getMakePaymentForParentForm() {
        ...
        */
        ...
        $formAction = "index.php?_topRm=finance&module=enterpriseIms_paymentSummary&_spAction=generateReceiptForParentFormSubmit&showHTML=0";
