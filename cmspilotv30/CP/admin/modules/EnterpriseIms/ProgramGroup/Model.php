<?
class CP_Admin_Modules_EnterpriseIms_ProgramGroup_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
     ...
     *
     */
    function getEnterpriseImsProgramGroupEnterpriseImsSubsidyDiscountLinkSQL($id) {
