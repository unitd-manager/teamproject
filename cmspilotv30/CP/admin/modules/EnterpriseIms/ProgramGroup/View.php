<?
class CP_Admin_Modules_EnterpriseIms_ProgramGroup_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$displayLinkData->getLinkPortalMain('enterpriseIms_programGroup', 'enterpriseIms_subsidyDiscountLink', 'Subsidy Discount Link', $row)}
        ";
