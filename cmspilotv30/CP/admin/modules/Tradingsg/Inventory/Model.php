<?
class CP_Admin_Modules_Tradingsg_Inventory_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
    function getSQL() {
        ...
        SELECT i.*
              ...
              ,p.carton_no AS product_carton_no
              ,p.batch_no AS product_batch_no
              ,p.item_code
              ,p.unit
              ,
