<?
class CP_Admin_Modules_Tradingsg_Supplier_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getNew(){
        ...
        $fielset1 = "
        {$formObj->getTBRow('Supplier Company Name', 'company_name')}
        ";
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$displayLinkData->getLinkPortalMain('tradingsg_supplier', 'tradingsg_contactLink', 'Contacts Linked', $row)}
