<?
class CP_Admin_Modules_Tradingsg_Supplier_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
    ...
    function setSearchVar($linkRecType = '') {
        ...
        $searchVar->sqlSearchVar[] = "(c.category = 'Supplier' OR c.category = 'Both')";
    ...
    function getFields(){
        ...
        $fa = $fn->addToFieldsArray($fa, 'gst_applied');
     ...
     *
     */
    function getTradingsgSupplierTradingsgContactLinkSQL($id) {
