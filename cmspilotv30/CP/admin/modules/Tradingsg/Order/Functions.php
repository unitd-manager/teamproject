<?
class CP_Admin_Modules_Tradingsg_Order_Functions
{
    //==================================================================//
    function setModuleArray($modules){
        $cpCfg = Zend_Registry::get('cpCfg');
        $modObj = $modules->getModuleObj('tradingsg_order');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('tradingsg_order', 'ecommerce_orderItemLink');
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('tradingsg_order', 'tradingsg_invoiceLink');
        $inst->registerLinksArray($linkObj, array(
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('tradingsg_order', 'tradingsg_receiptLink');
        $inst->registerLinksArray($linkObj, array(
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('tradingsg_order', 'attachment', 'attachment');

        $mediaArr->registerMedia($mediaObj, array(
        ));

        $mediaObj = $mediaArr->getMediaObj('tradingsg_order', 'label', 'attachment');
     ...
     *
    */
    function getTradingsgOrderEcommerceOrderItemLinkPortalSearch1() {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
        $fn = Zend_Registry::get('fn');
