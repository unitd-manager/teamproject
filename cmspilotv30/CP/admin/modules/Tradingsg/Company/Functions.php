<?
class CP_Admin_Modules_Tradingsg_Company_Functions {
    ...
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('tradingsg_company');
    ...
    function setMediaArray($mediaArr) {
        ...
        $mediaObj = $mediaArr->getMediaObj('tradingsg_company', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('tradingsg_company', 'tradingsg_contactLink');
        ...
        $linkObj = $inst->getLinksArrayObj('tradingsg_company', 'tradingsg_discountLink');
