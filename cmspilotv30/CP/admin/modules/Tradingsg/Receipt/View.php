<?
class CP_Admin_Modules_Tradingsg_Receipt_View extends CP_Common_Lib_ModuleLinkViewAbstract
{
    function getGenerateReceiptForm() {
        ...
        $formAction = "index.php?_topRm=finance&module=tradingsg_order&_spAction=generateReceiptFormSubmit&showHTML=0";
