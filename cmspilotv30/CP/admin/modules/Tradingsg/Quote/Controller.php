<?
class CP_Admin_Modules_Tradingsg_Quote_Controller extends CP_Common_Lib_ModuleControllerAbstract
{
    ...
    function getPrintProformaInvoice() {
        return $this->view->getPrintProformaInvoice();
    }
    ...
    function getAddNoteQp() {
        return $this->view->getAddNoteQp();
    }

    function getPrintQuoteThermalPrinter() {
        return $this->view->getPrintQuoteThermalPrinter();
    }

    function getQuoteProductLink() {
        return $this->view->getQuoteProductLink();
    }
    ...
    function getAddNewClientForm() {
        return $this->view->getAddNewClientForm();
    }

    function getAddNewClientSubmit() {
        return $this->model->getAddNewClientSubmit();
    }
}