Util.createCPObject('cpm.tradingsg.quote');
...
cpm.tradingsg.quote = {
    init: function(){
        ...
        $('#portalForm select#fld_product_group_id').livequery('change', function(){
           cpm.tradingsg.quote.loadCategoryDropdown.call(this);
        });

        //for edit portal product
        $('#portalForm .costs input, #portalForm .costs select')
        .live('change', cpm.tradingsg.quote.calculateProductCosting);
        ...
        $('#portalForm a.next').live('click', cpm.tradingsg.quote.nextLine);
        $('#portalForm a.previous').live('click', cpm.tradingsg.quote.previousLine);
        ...
        $('select[name=product_id]').livequery('change', function(){
            ...
            cpm.tradingsg.quote.loadSupplierDropdown.call(this);
        });

        $('.row-tradingsg_quote__tradingsg_productLink .mark-up').livequery('change', function(){
            var parent = $(this).closest('tr');
            var rec_id = $(parent).attr('recid');
        ...
        $('.row-tradingsg_quote__tradingsg_productLink .client-id').livequery('change', function(){
            var parent = $(this).closest('tr');
            var rec_id = $(parent).attr('recid');
            var clientIdObj = $(this).parents('tr').find('select[name=client_id]');
            var client_id = clientIdObj.val();
            var url = 'index.php?module=tradingsg_quote&_spAction=updateClientId&showHTML=0';
        ...
        $('.row-tradingsg_quote__tradingsg_productLink .discount-percentage')
        .livequery('change', cpm.tradingsg.quote.quoteProductDiscount);

        //---------------------- CHANGE QTY IN PRODUCT LINK---------------------
        $('.row-tradingsg_quote__tradingsg_productLink .qty')
        .livequery('change', cpm.tradingsg.quote.quoteProductQty);

        //---------------- COST PRICE UPDATE -----------------------------
        $('.row-tradingsg_quote__tradingsg_productLink .cost-price')
        .livequery('change', cpm.tradingsg.quote.quoteProductCostPrice);

        //---------------- DISCOUNT TYPE UPDATE -----------------------------
        $('.row-tradingsg_quote__tradingsg_productLink .discount-type').livequery('change', function(){
            ...
            $.get(url, {rec_id: rec_id, discount_type: discount_type, discount_percentage: discount_percentage}, function(json){
                totalSellingPriceObj.html(json.totalSellingPrice);
        ...
        //---------------- MARK UP TYPE UPDATE -----------------------------
        $('.row-tradingsg_quote__tradingsg_productLink .mark-up-type').livequery('change', function(){
            var parent = $(this).closest('tr');
            var markUpTypeObj = $(this).parents('tr').find('.mark-up-type select[name=mark_up_type]');
            var mark_up_type    = markUpTypeObj.val();
            var markUpValObj = $(this).parents('tr').find('input[name=mark_up_amount]');
            var mark_up = markUpValObj.val();
            ...
            $.get(url, {rec_id: rec_id, mark_up_type: mark_up_type, mark_up: mark_up}, function(json){
                totalSellingPriceObj.html(json.totalSellingPrice);
                costPriceObj.html(json.totalCostPrice);
                sellingPriceObj.html(json.selling_price);
                $('tr.summary-row .totalCp').html(json.total_cost_price_sum);
        ...
        //---------------------- CHANGE QTY IN PRODUCT LINK---------------------
        $('.row-tradingsg_quote__tradingsg_productLink .mark-up-amount')
        .livequery('change', cpm.tradingsg.quote.quoteProductMarkUp);
        ...
        $('#raisePo').livequery('click', function(){
            ...
            if (!confirm(msg)){
                ...
                var url = 'index.php?module=tradingsg_quote&_spAction=raisePurchaseOrder&showHTML=0&id=' + quote_id;
        ...
        $('.m-tradingsg_quote #updateMarkupByGroup').livequery('click', function (e){
        ...
        $('.m-tradingsg_quote #raiseGeneralQuotation')
        .livequery('click', cpm.tradingsg.quote.raiseGeneralQuotation);

        /*
        $('.m-tradingsg_quote #raiseGeneralQuotation').livequery('click', function (e){
            ...
            if (!confirm(msg)){
                ...
                Util.showProgressInd();
                var quote_id = $(this).attr('quote_id');
                var url = 'index.php?module=tradingsg_quote&_spAction=raiseGeneralQuotation&showHTML=0&quote_id=' + quote_id;
                $.get(url, {quote_id: quote_id}, function(html){
                    Util.hideProgressInd();
                    window.location.reload(true);
                });
        ...
        */
        ...
        $('.m-tradingsg_quote #deleteProducts').livequery('click', function (e){
            ...
            if (!confirm(msg)){
                ...
                Util.showProgressInd();
                var quote_id = $(this).attr('quote_id');
                var url = 'index.php?module=tradingsg_quote&_spAction=deleteProductsLinked&showHTML=0&quote_id=' + quote_id;
                $.get(url, {quote_id: quote_id}, function(html){
                    Util.hideProgressInd();
                    window.location.reload(true);
                });
        ...
        $('.m-tradingsg_quote #updateDiscountByGroupForm').livequery('click', function (e){
        ...
        /* Updating of discount group in quote_product table by product group */
        $('.m-tradingsg_quote #updateDiscountForm').livequery('click', function (e){
        ...
        $('.m-tradingsg_quote #updateMarkupByCategory').livequery('click', function (e){
            msg = "Do you like to Update Markup?";
            if (!confirm(msg)){
                return false;
            }
        ...
        /* Thermal Print */
        /*$("#thermalPrinter").livequery('click', function (e){
            var title = "Do you like to Print";

            e.preventDefault();
            var expObj = {
            }
            Util.openDialogForLink.call(this, 'Do you like to Print', title, 300, 140, expObj);
        });*/

        /* Thermal Print 2*/
        /*$("#thermalPrinterPrint").livequery('click', function (e){
            window.location.reload(true);
        });*/

        /*$("#bulkAddProduct").livequery('click', function (e){
        ...
        $(".productViewHistory").livequery('click', function (e){
            ...
            Util.openDialogForLink.call(this, 'Product History', 700, 500, expObj);
        });

        /* Add note in quote po link*/
        $('.m-tradingsg_quote a.addNotePo').livequery('click', function (e){
                var title = "Add Note";
                e.preventDefault();
        ...
        $('#bulkAddProduct')
        .livequery('click', cpm.tradingsg.quote.quoteProductBulkAdd);

        /* Add Product in quote_product link */
        $('#addProduct')
        .livequery('click', cpm.tradingsg.quote.quoteProductAdd);

        //=========================== AUTO COMPLETE ===========================
        $(".row-tradingsg_quote__tradingsg_productLink input[name='product_title']")
        .livequery(cpm.tradingsg.quote.quoteProductProductTitle);
        ...
        $('#raiseInvoice').livequery('click', function(){
            ...
            if (!confirm(msg)){
                ...
                Util.showProgressInd();
                var quote_id = $(this).attr('quote_id');
                var url = 'index.php?module=tradingsg_quote&_spAction=raiseInvoice&showHTML=0&id=' + quote_id;
                $.get(url, {quote_id: quote_id}, function(html){
        ...
        $('.row-tradingsg_quote__tradingsg_productLink td.qo-po-id').livequery('click', function (e){
            var parent = $(this).closest('tr');
            var rec_id = $(parent).attr('recid');
            var cbObj = $('input[name=qo_po_id]', parent);
            var checkedVal = cbObj.is(":checked") ? 1 : 0;

            var url = 'index.php?_topRm=order&module=tradingsg_quote&_spAction=checkboxForDeleteProductsLinked&showHTML=0';
        ...
        $('.m-tradingsg_quote #deleteProductChecked').livequery('click', function (e){
            ...
            if (!confirm(msg)){
                ...
                Util.showProgressInd();
                var quote_id = $(this).attr('quote_id');
                var url = 'index.php?module=tradingsg_quote&_spAction=deleteCheckedProductsLinked&showHTML=0&quote_id=' + quote_id;
                $.get(url, {quote_id: quote_id}, function(html){
                    Util.hideProgressInd();
        ...
        $('.m-tradingsg_quote #convertClientRequirement').livequery('click', function (e){
            ...
            if (!confirm(msg)){
                ...
                Util.showProgressInd();
                var quote_id = $(this).attr('quote_id');
                var url = 'index.php?module=tradingsg_quote&_spAction=updateGeneralQuotation&showHTML=0';
                $.get(url, {quote_id: quote_id}, function(html){
                    Util.hideProgressInd();
                    window.location.reload(true);
                });
        ...
        $('.addNewClient').livequery('click', function (e){
         ...
         /*show displaylink product*/
        $(".displayLinkedProducts").livequery('click', function (e){
            //var quote_product_id = $(this).attr('quote_product_id');
            //alert ('Display Product Linked');
            //var title = "displayproduct";
            e.preventDefault();
            var expObj = {
                beforeCloseFn: function(){
                    Util.closeAllDialogs();
            ...
            Util.openDialogForLink.call(this, 'displayproduct', 700, 500, expObj);
        });

        /*show purchase order linked*/
        $(".DisplayPurchaseOrderLinked").livequery('click', function (e){
            //var quote_product_id = $(this).attr('quote_product_id');
            alert ('Display Purchase order Linked');
            //var title = "displayproduct";
            e.preventDefault();
            var expObj = {
                beforeCloseFn: function(){
            ...
            Util.openDialogForLink.call(this, 'display purchase order', 700, 500, expObj);
        });



        /* Delete Products Linked */
        $('.m-tradingsg_quote #productdeleted').livequery('click', function (e){
            msg = "Do you like to delete the products? (Note: This will delete the products including purchase order and order)";
            if (!confirm(msg)){
                return false;
            }
            else{
    ...
    quoteProductBulkAdd: function(e) {
        ...
        var expObj = {
           ...
           ,callbackOnSuccess: function(){
                var msg = 'Generated successfully';
                Util.closeAllDialogs();
                cpm.tradingsg.quote.reloadQuoteProductLink(quote_id);
                //window.location.reload(true);
            }
        }
        Util.openFormInDialog.call(this, 'portalForm', title, 300, 175, expObj);
    ...
    quoteProductAdd: function(e) {
        ...
        var quote_id       = $(this).attr('quote_id');
        Util.showProgressInd();
        var url = 'index.php?module=tradingsg_quote&_spAction=addProduct&quote_id=' + quote_id + '&showHTML=0';
    ...
    reloadQuoteProductLink: function(quote_id){
        var url = 'index.php?module=tradingsg_quote&_spAction=quoteProductLink&quote_id=' + quote_id + '&showHTML=0';
        $.get(url,  function(html){
            $('#quoteProductLinkPanel').html(html);
            Util.hideProgressInd();
        });
    },
    ...
    raiseSOList: function() {
        ...
        var url = 'index.php?module=tradingsg_quote&_spAction=raiseSOListValidation&showHTML=0';
        $.getJSON(url, {quote_id: quote_id}, function (json) {
            ...
            var url = 'index.php?module=tradingsg_quote&_spAction=raiseSOList' +
                      '&quote_id=' + quote_id +
                      '&showHTML=0';
            var exp = {
                url: url
               ,afterOpen: function() {
                    ...
                    $('#btnRaiseSO').click(cpm.tradingsg.quote.raiseSO);
                }
            };
    ...
    raiseSO: function() {
        ...
        var quote_id = $('#record_id').val();
        var url = 'index.php?module=tradingsg_quote&_spAction=raiseSO&showHTML=0' +
                  '&quote_id=' + quote_id;
    ...
    printQuote: function() {
        ...
        var url = 'index.php?_spAction=printReport&record_id=' +
                   quote_id + '&showHTML=0&roomName=tradingsg_quote&report=quote';
    ...
    nextLine: function(e) {
        ...
        var nextRow = $('.tradingsg_quote__tradingsg_productLink table tr[recid=' + record_id + ']').next();
        if (nextRow.length > 0) {
            $('#dialog').dialog('destroy');
            $('#dialog').remove();
    ...
    previousLine: function(e) {
        e.preventDefault();
        var record_id = $('#portalForm input[name=quote_items_id]').val();
        var prevRow = $('.tradingsg_quote__tradingsg_productLink table tr[recid=' + record_id + ']')
                      .prev('[recid]');
        if (prevRow.length > 0) {
            $('#dialog').dialog('destroy');
            $('#dialog').remove();
    ...
    quoteProductQty: function(e) {
        ...
        var rec_id = $(parent).attr('recid');
        //var profitObj = $(this ).closest('tr').find('.profit');
        var costPriceSumObj = $(this ).closest('table').find('.total-cost-price');
        var marginSumObj    = $(this ).closest('table').find('.mark-up-amount');
        var discountSumObj = $(this ).closest('table').find('.discount-percentage-amount');
        var totalSellingPriceObj = $(this ).closest('tr').find('.total-selling-price');
        var costPriceObj = $(this ).closest('tr').find('.total-cost-price');
        ...
        $.get(url, {rec_id: rec_id, qty: qty}, function(json){
            totalSellingPriceObj.html(json.totalSellingPrice);
            costPriceObj.html(json.totalCostPrice);
            discountObj.html(json.discount_value);
            ...
            //totalSellingPriceSumObj.html(json.total_cost_price_sum);
            $('tr.summary-row .totalCp').html(json.total_cost_price_sum);
            $('tr.summary-row .discountSum').html(json.discount_percentage_amount_sum);
            $('tr.summary-row .serviceCostSum').html(json.mark_up_amount_sum);
            $('tr.summary-row .totalSp').html(json.total_selling_price_sum);
            //$('.total_cost_price_sum', totalSellingPriceSumObj).val(35);
            /*
            var profitVal = json.profit;
            if (profitVal > 0) {
            } else {
                $(parent).addClass('red');
            }
    ...
    quoteProductMarkUp: function(e) {
        e.preventDefault();
        var parent = $(this).closest('tr');
        var markUpObj = $(this).parents('tr').find('input[name=mark_up_amount]');
        var mark_up    = markUpObj.val();
        var discountPercentageObj = $(this).closest('tr').find('input[name=discount_percentage_amount]');
        ...
        $.get(url, {rec_id: rec_id, mark_up: mark_up, discount_percentage: discount_percentage}, function(json){
            totalSellingPriceObj.html(json.totalSellingPrice);
            sellingPriceObj.html(json.selling_price);
            $('tr.summary-row .totalCp').html(json.total_cost_price_sum);
            $('tr.summary-row .serviceCostSum').html(json.mark_up_amount_sum);
    ...
    quoteProductDiscount: function(e) {
        e.preventDefault();
        var parent = $(this).closest('tr');
    ...
    quoteProductProductTitle: function() {
    	...
    	$(titleObj).autocomplete({
    		...
    		,select: function(event, ui) {
                ...
                //cpm.tradingsg.quote.populateProductRelatedValues.call(product_id);
                ...
                var viewHisObj      = $(this ).closest('tr').find('.view-history');
                var discountObj     = $(this ).closest('tr').find('.discount-percentage-amount');
                var clientIdObj     = $(this ).parents('tr').find('.client-id select[name=client_id]');
                var markUpTypeObj     = $(this ).parents('tr').find('.mark-up-type select[name=mark_up_type]');
                ...
                $.get(url, {product_id: product_id, rec_id: rec_id}, function(json){
                    ...
                    //The cost price is uneditable for trading mass hence the condition is given as below
                    if (m_tradingsg_quote_hasProductLinkForSplCase == 1){
                        costPriceObj.html(json.price);
                        marginObj.html(json.margin);
                    }
                    else{
                        //For General Trading
                        $("input[name=cost_price]", costPriceObj).val(json.price);
                        $("input[name=mark_up_amount]", marginObj).val(json.margin);
                        markUpTypeObj.val('%');
                    }
                    ...
                    titleObj.html(json.title);
                    sellingPriceObj.html(json.sellingPrice);
                    discountObj.html(json.discount);
                    itemCodeObj.html(json.itemCode);
                    unitObj.html(json.unit);
                    viewHisObj.html(json.viewHistory);
                    $('tr.summary-row .totalSp').html(json.total_selling_price_sum);
                ...
                /* Notify plugin */
                /*
                var company_id = $('.m-tradingsg_quote .row_company_id option[selected=selected]').val();
                var rec_id = $('#record_id').val();
                if (company_id != '') {
                    var url = 'index.php?_topRm=finance&module=tradingsg_quote&_spAction=previousOrderForClient&showHTML=0';
                    $.get(url,{company_id: company_id, product_id: product_id, rec_id: rec_id}, function(html){
