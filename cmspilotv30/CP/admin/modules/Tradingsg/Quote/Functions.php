<?
class CP_Admin_Modules_Tradingsg_Quote_Functions
{

    function setModuleArray($modules){
        $cpCfg = Zend_Registry::get('cpCfg');
        $modObj = $modules->getModuleObj('tradingsg_quote');
        $modules->registerModule($modObj, array(
            'relatedTables' => array('quote_product')
           ,'actBtnsList' => array('new')
           ,'actBtnsDetail' => array('tradingsgDuplicateQuote'
                                    ,'edit'
                                    ,'delete'
            )
           ,'actBtnsEdit' => array('tradingsgDuplicateQuote', 'save', 'apply')
        ));
    }
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('tradingsg_quote', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        ...
        */
        ...
        $linkObj = $inst->getLinksArrayObj('tradingsg_quote', 'tradingsg_expenseLink', array(
        ...
        $linkObj = $inst->getLinksArrayObj('tradingsg_quote', 'tradingsg_purchaseOrderLink', array(
     ...
     *
    */
    function getTradingsgQuoteTradingsgProductLinkPortalSearch() {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
        $cpUtil = Zend_Registry::get('cpUtil');
        $cpCfg = Zend_Registry::get('cpCfg');
