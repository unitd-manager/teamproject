<?
class CP_Admin_Modules_Tradingsg_QuoteLink_View extends CP_Common_Lib_ModuleLinkViewAbstract
{
    ...
    function getList($dataArray, $linkRecType) {
        ...
        foreach ($dataArray as $row){
            ...
            $productTitle = $fn->getRecordDetailLink('tradingsg_quote',
                                                     'record_id',
                                                     $row['quote_id'],
                                                     $expProdTitle);
            ...
            {$listLinkObj->getListRowEndLink($linkRecType, $row['quote_id'])}
            ";
            $rowCounter++;
        }
        ...
        {$listLinkObj->getListHeaderCellLink($linkRecType, 'Quote Code', 'q.quote_code')}
        {$listLinkObj->getListHeaderCellLink($linkRecType, 'Title', 'q.title')}
