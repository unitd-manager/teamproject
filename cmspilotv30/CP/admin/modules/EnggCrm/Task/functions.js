Util.createCPObject('cpm.enggCrm.task');

cpm.enggCrm.task.init = function(){
    ...
    if ($('.task__taskHistory').length > 0){
        ...
        var link = "index.php?module=enggCrm_taskHistory&_spAction=bulkAdd&showHTML=0&task_id=" + record_id;
