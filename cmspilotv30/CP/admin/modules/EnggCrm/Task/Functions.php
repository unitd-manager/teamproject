<?
class CP_Admin_Modules_EnggCrm_Task_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('enggCrm_task');
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('enggCrm_task', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('enggCrm_task', 'enggCrm_timesheetLink');
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('enggCrm_task', 'core_staffLink');
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('enggCrm_task', 'enggCrm_taskHistoryLink');
