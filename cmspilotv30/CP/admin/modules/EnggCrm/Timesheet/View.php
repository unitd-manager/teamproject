<?
class CP_Admin_Modules_EnggCrm_Timesheet_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getList($dataArray) {
        ...
        if ($cpCfg['m.enggCrm.timesheet.daysLbl'] == 1){
            $lbl = 'Days';
        } else {
            $lbl = 'Hours';
        }
        ...
        {$text2}
        {$listObj->getListHeaderCell($cpCfg['m.enggCrm.staffFieldLabel'], 'staff_name')}
