<?
class CP_Admin_Modules_EnggCrm_CallRegistry_View extends CP_Common_Lib_ModuleViewAbstract
{
    function getList($dataArray){
        ...
        foreach ($dataArray as $row){
            ...
            {$listObj->getGoToDetailText($rowCounter, $row['call_registry_code'])}
        ...
        {$listObj->getListHeaderCell('Code', 'call_registry_code')}
        ...
        {$listObj->getListHeaderCell('Meeting Date', 'c.contact_date')}
    ...
    function getNew(){
        ...
        /* To get the company names from EnggCrm module in CRM. Add if else condition for other modules below */
        ...
        $formAction = "index.php?_topRm=project&module=tradingsg_companyLink&_spAction=addNewCompanyForCallRegistryForm&showHTML=0";
        $text = "
    ...
    function getEdit($row) {
        ...
        {$formObj->getDateRow('Meeting Date', 'contact_date', $row['contact_date'])}
        ...
        {$formObj->getDDRowBySQL('Reference', 'reffer', $sqlReffer, $row['reffer'], $expVl)}
        ...
        $fieldset2 = "
        {$formObj->getHTMLEditor('Meeting Notes', 'description', $row['description'], '0')}
        ";
