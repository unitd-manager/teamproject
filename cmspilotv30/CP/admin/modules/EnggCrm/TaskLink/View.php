<?
class CP_Admin_Modules_EnggCrm_TaskLink_View extends CP_Common_Lib_ModuleLinkViewAbstract
{
    /**
     *
     */
    function getNew(){
        ...
        if ($tv['srcRoom'] == "enggCrm_opportunity") {
            $sqlStaff = "
            SELECT a.staff_id
        ...
        } else if ($tv['srcRoom'] == "enggCrm_project") {
            $sqlStaff = "
            SELECT a.staff_id
                  ,CONCAT_WS(' ', a.first_name, a.last_name) AS staff_name
            FROM staff a,
        ...
        <form id='portalForm' class='yform columnar' method='post' action='{$formAction}'>
            <fieldset>
                ...
                {$formObj->getCheckBoxArrRowBySQL($cpCfg['m.enggCrm.staffFieldLabel'].' Linked', 'staff_ids[]', $sqlStaff)}
                ...
                {$formObj->getYesNoRRow('Alert '. $cpCfg['m.enggCrm.staffFieldLabel'].' by email', 'staff_alert')}
    ...
    function getEdit(){
        ...
        <form id='portalForm' class='yform columnar' method='post' action='{$formAction}'>
            <fieldset>
                ...
                {$formObj->getCheckBoxArrRowBySQL($cpCfg['m.enggCrm.staffFieldLabel'].' Linked', 'staff_ids[]', $sqlStaff, $staffArray)}
                ...
                {$formObj->getYesNoRRow('Alert '. $cpCfg['m.enggCrm.staffFieldLabel'].' by email', 'staff_alert', $row['chargeable'])}
    ...
    function getNewPortalFromDashboard(){
        ...
        $sqlProj = $fn->getDDSql('enggCrm_project', array('condn' => "status = 'WIP'"));
