<?
class CP_Admin_Modules_EnggCrm_TaskLink_Model extends CP_Common_Lib_ModuleLinkModelAbstract
{
    /**
     *
     */
    function getNewValidate() {
        ...
        $validate->validateData('category', 'Please choose the category');
    ...
    function getAdd() {
        ...
        $fa = $this->getFields();
        $id = $fn->addRecord($fa);
        $spActionObj->linkRecordsByFormField('enggCrm_task', 'core_staffLink', $id, 'staff_ids');
