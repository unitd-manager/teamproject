<?
class CP_Admin_Modules_EnggCrm_Supplier_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$displayLinkData->getLinkPortalMain('enggCrm_supplier', 'enggCrm_contactLink', 'Contacts Linked', $row)}
        {$media->getRightPanelMediaDisplay('Attachments', 'enggCrm_supplier', 'attachment', $row)}
        ";
