<?
class CP_Admin_Modules_Pos_SubCategoryLink_View extends CP_Common_Lib_ModuleLinkViewAbstract
{
    function getList($dataArray, $linkRecType) {
        ...
        foreach ($dataArray as $row){
            ...
            {$listLinkObj->getListRowEndLink($linkRecType, $row['sub_category_id'])}
            ";
