<?
class CP_Admin_Modules_Pos_Currency_Model extends CP_Common_Lib_ModuleModelAbstract
{
    ...
    function getNewValidate() {
        ...
        $validate->validateData('code', 'Please enter the Currency Code');
