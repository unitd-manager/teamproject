Util.createCPObject('cpm.tradingus.quote');
...
cpm.tradingus.quote = {
    init: function(){
        ...
        $('#portalForm select#fld_product_group_id').livequery('change', function(){
           cpm.tradingus.quote.loadCategoryDropdown.call(this);
        });

        //for edit portal product
        $('#portalForm .costs input, #portalForm .costs select')
        .live('change', cpm.tradingus.quote.calculateProductCosting);
        ...
        $('#portalForm a.next').live('click', cpm.tradingus.quote.nextLine);
        $('#portalForm a.previous').live('click', cpm.tradingus.quote.previousLine);
        ...
        $('select[name=product_id]').livequery('change', function(){
            ...
            var url = 'index.php?module=tradingus_quote&_spAction=updateProductLineItems&showHTML=0';
            ...
            cpm.tradingus.quote.loadSupplierDropdown.call(this);
        });

        $('.row-tradingus_quote__tradingsg_productLink .mark-up').livequery('change', function(){
            var parent = $(this).closest('tr');
            var rec_id = $(parent).attr('recid');
            ...
            var url = 'index.php?module=tradingus_quote&_spAction=updateSellingLineItems&showHTML=0';
        ...
        $('.row-tradingus_quote__tradingsg_productLink .client-id').livequery('change', function(){
            var parent = $(this).closest('tr');
            var rec_id = $(parent).attr('recid');
            var clientIdObj = $(this).parents('tr').find('select[name=client_id]');
            var client_id = clientIdObj.val();
            var url = 'index.php?module=tradingus_quote&_spAction=updateClientId&showHTML=0';
        ...
        $('.row-tradingus_quote__tradingsg_productLink .discount-percentage').livequery('change', function(){
            var parent = $(this).closest('tr');
        ...
        $('.row-tradingus_quote__tradingsg_productLink .qty')
        .livequery('change', cpm.tradingus.quote.quoteProductQty);

        //---------------- COST PRICE UPDATE -----------------------------
        $('.row-tradingus_quote__tradingsg_productLink .cost-price')
        .livequery('change', cpm.tradingus.quote.quoteProductCostPrice);

        //---------------- DISCOUNT TYPE UPDATE -----------------------------
        $('.row-tradingus_quote__tradingsg_productLink .discount-type').livequery('change', function(){
        ...
        //---------------- MARK UP TYPE UPDATE -----------------------------
        $('.row-tradingus_quote__tradingsg_productLink .mark-up-type').livequery('change', function(){
            var parent = $(this).closest('tr');
        ...
        $('.row-tradingus_quote__tradingsg_productLink .mark-up-amount').livequery('change', function(){
            var parent = $(this).closest('tr');
            ...
            $.get(url, {rec_id: rec_id, mark_up: mark_up}, function(json){
                ...
                $('tr.summary-row .serviceCostSum').html(json.mark_up_amount_sum);
                $('tr.summary-row .totalSp').html(json.total_selling_price_sum);
                $('tr.summary-row .selling_price_amount_sum').html(json.total_selling_price);
            });
        ...
        $('#raisePo').livequery('click', function(){
            ...
            if (!confirm(msg)){
                ...
                var url = 'index.php?module=tradingus_quote&_spAction=raisePurchaseOrder&showHTML=0&id=' + quote_id;
        ...
        $('.m-tradingus_quote #updateMarkupByGroup').livequery('click', function (e){
        ...
        $('.m-tradingus_quote #raiseGeneralQuotation')
        .livequery('click', cpm.tradingus.quote.raiseGeneralQuotation);

        /*
        $('.m-tradingus_quote #raiseGeneralQuotation').livequery('click', function (e){
            ...
            if (!confirm(msg)){
                ...
                Util.showProgressInd();
                var quote_id = $(this).attr('quote_id');
                var url = 'index.php?module=tradingus_quote&_spAction=raiseGeneralQuotation&showHTML=0&quote_id=' + quote_id;
                $.get(url, {quote_id: quote_id}, function(html){
                    Util.hideProgressInd();
                    window.location.reload(true);
                });
        ...
        */
        ...
        $('.m-tradingus_quote #deleteProducts').livequery('click', function (e){
            ...
            if (!confirm(msg)){
                ...
                Util.showProgressInd();
                var quote_id = $(this).attr('quote_id');
                var url = 'index.php?module=tradingus_quote&_spAction=deleteProductsLinked&showHTML=0&quote_id=' + quote_id;
                $.get(url, {quote_id: quote_id}, function(html){
                    Util.hideProgressInd();
                    window.location.reload(true);
                });
        ...
        $('.m-tradingus_quote #updateDiscountByGroupForm').livequery('click', function (e){
        ...
        /* Updating of discount group in quote_product table by product group */
        $('.m-tradingus_quote #updateDiscountForm').livequery('click', function (e){
        ...
        $('.m-tradingus_quote #updateMarkupByCategory').livequery('click', function (e){
            msg = "Do you like to Update Markup?";
            if (!confirm(msg)){
                return false;
            }
        ...
        /*$("#bulkAddProduct").livequery('click', function (e){
            ...
            var expObj = {
               ...
               ,callbackOnSuccess: function(){
                    ...
                    Util.closeAllDialogs();
                    Links.reloadPortalRecords('tradingus_quote#tradingus_productLink');
                }
            }
        ...
        $('.m-tradingus_quote a.addNotePo').livequery('click', function (e){
                var title = "Add Note";
                e.preventDefault();
        ...
        $('#bulkAddProduct')
        .livequery('click', cpm.tradingus.quote.quoteProductBulkAdd);

        /* Add Product in quote_product link */
        $('#addProduct')
        .livequery('click', cpm.tradingus.quote.quoteProductAdd);

        //=========================== AUTO COMPLETE ===========================
        $(".row-tradingus_quote__tradingsg_productLink input[name='product_title']")
        .livequery(cpm.tradingus.quote.quoteProductProductTitle);
        ...
        $('#raiseInvoice').livequery('click', function(){
            ...
            if (!confirm(msg)){
                ...
                Util.showProgressInd();
                var quote_id = $(this).attr('quote_id');
                var url = 'index.php?module=tradingus_quote&_spAction=raiseInvoice&showHTML=0&id=' + quote_id;
                $.get(url, {quote_id: quote_id}, function(html){
        ...
        $('.row-tradingus_quote__tradingsg_productLink td.qo-po-id').livequery('click', function (e){
            var parent = $(this).closest('tr');
            var rec_id = $(parent).attr('recid');
            var cbObj = $('input[name=qo_po_id]', parent);
            var checkedVal = cbObj.is(":checked") ? 1 : 0;

            var url = 'index.php?_topRm=order&module=tradingus_quote&_spAction=checkboxForDeleteProductsLinked&showHTML=0';
        ...
        $('.m-tradingus_quote #deleteProductChecked').livequery('click', function (e){
            ...
            if (!confirm(msg)){
                ...
                Util.showProgressInd();
                var quote_id = $(this).attr('quote_id');
                var url = 'index.php?module=tradingus_quote&_spAction=deleteCheckedProductsLinked&showHTML=0&quote_id=' + quote_id;
                $.get(url, {quote_id: quote_id}, function(html){
                    Util.hideProgressInd();
        ...
        $('.m-tradingus_quote #convertClientRequirement').livequery('click', function (e){
            ...
            if (!confirm(msg)){
                ...
                Util.showProgressInd();
                var quote_id = $(this).attr('quote_id');
                var url = 'index.php?module=tradingus_quote&_spAction=updateGeneralQuotation&showHTML=0';
                $.get(url, {quote_id: quote_id}, function(html){
                    Util.hideProgressInd();
                    window.location.reload(true);
                });
    ...
    loadSupplierDropdown: function(){
        //$(this).each(function(){
            ...
            var url = $('#scopeRootAlias').val() + 'index.php?module=tradingus_quote&_spAction=supplierJsonByProductId&showHTML=0';
    ...
    quoteProductBulkAdd: function(e) {
        ...
        var expObj = {
           ...
           ,callbackOnSuccess: function(){
                var msg = 'Generated successfully';
                Util.closeAllDialogs();
                cpm.tradingus.quote.reloadQuoteProductLink(quote_id);
                //window.location.reload(true);
            }
        }
        Util.openFormInDialog.call(this, 'portalForm', title, 300, 175, expObj);
    ...
    quoteProductAdd: function(e) {
        ...
        var quote_id       = $(this).attr('quote_id');
        Util.showProgressInd();
        var url = 'index.php?module=tradingus_quote&_spAction=addProduct&quote_id=' + quote_id + '&showHTML=0';
    ...
    reloadQuoteProductLink: function(quote_id){
        var url = 'index.php?module=tradingus_quote&_spAction=quoteProductLink&quote_id=' + quote_id + '&showHTML=0';
    ...
    calculateProductCosting: function(e){
        var url = "index.php?module=tradingus_product"
    ...
    raiseSOList: function() {
        ...
        var url = 'index.php?module=tradingus_quote&_spAction=raiseSOListValidation&showHTML=0';
        $.getJSON(url, {quote_id: quote_id}, function (json) {
            ...
            var url = 'index.php?module=tradingus_quote&_spAction=raiseSOList' +
                      '&quote_id=' + quote_id +
                      '&showHTML=0';
            var exp = {
                url: url
               ,afterOpen: function() {
                    ...
                    $('#btnRaiseSO').click(cpm.tradingus.quote.raiseSO);
                }
            };
    ...
    raiseSO: function() {
        ...
        var quote_id = $('#record_id').val();
        var url = 'index.php?module=tradingus_quote&_spAction=raiseSO&showHTML=0' +
                  '&quote_id=' + quote_id;
    ...
    duplicate: function() {
        ...
        var quote_id = $('#record_id').val();
        var url = 'index.php?module=tradingus_quote&_spAction=duplicateQuote&showHTML=0' +
                  '&quote_id=' + quote_id;
    ...
    printQuote: function() {
        ...
        var url = 'index.php?_spAction=printReport&record_id=' +
                   quote_id + '&showHTML=0&roomName=tradingus_quote&report=quote';
    ...
    nextLine: function(e) {
        ...
        var nextRow = $('.tradingus_quote__tradingus_productLink table tr[recid=' + record_id + ']').next();
        if (nextRow.length > 0) {
            $('#dialog').dialog('destroy');
            $('#dialog').remove();
    ...
    previousLine: function(e) {
        e.preventDefault();
        var record_id = $('#portalForm input[name=quote_items_id]').val();
        var prevRow = $('.tradingus_quote__tradingus_productLink table tr[recid=' + record_id + ']')
                      .prev('[recid]');
        if (prevRow.length > 0) {
            $('#dialog').dialog('destroy');
            $('#dialog').remove();
    ...
    quoteProductQty: function(e) {
        ...
        $.get(url, {rec_id: rec_id, qty: qty}, function(json){
            ...
            if (m_tradingus_quote_hasProductLinkForSplCase == 1){
                marginObj.html(json.mark_up_value);
            }
    ...
    quoteProductProductTitle: function() {
    	...
    	$(titleObj).autocomplete({
             source : 'index.php?module=tradingus_quote&_spAction=searchProductTitle&showHTML=0'
            ,minLength : 2
    		,select: function(event, ui) {
                ...
                //cpm.tradingus.quote.populateProductRelatedValues.call(product_id);
                ...
                var totalCostPriceObj = $(this ).closest('tr').find('.total-cost-price');
                var discountObj       = $(this ).closest('tr').find('.discount-percentage-amount');
                var totalSelPriceObj  = $(this ).closest('tr').find('.total-selling-price');
                var clientIdObj       = $(this ).parents('tr').find('.client-id select[name=client_id]');
                var markUpTypeObj     = $(this ).parents('tr').find('.mark-up-type select[name=mark_up_type]');
                ...
                $.get(url, {product_id: product_id, rec_id: rec_id}, function(json){
                    ...
                    totalCostPriceObj.html(json.price);
                    totalSelPriceObj.html(json.sellingPrice);
                ...
                /* Notify plugin */
                /*
                var company_id = $('.m-tradingus_quote .row_company_id option[selected=selected]').val();
                var rec_id = $('#record_id').val();
                if (company_id != '') {
                    var url = 'index.php?_topRm=finance&module=tradingus_quote&_spAction=previousOrderForClient&showHTML=0';
