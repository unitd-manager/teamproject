<?
class CP_Admin_Modules_Tradingus_Product_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('tradingus_product');
    ...
    function setLinksArray($inst) {
     ...
     /*   //------------------------------------------------------------------------------//
        ...
        //-----------------------------------------------------------------// 
        $linkObj = $inst->getLinksArrayObj('tradingus_product', 'tradingus_companyLink', array( 
    ...
    function setMediaArray($mediaArr) {
        ...
        $cpCfg = Zend_Registry::get('cpCfg');
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('tradingus_product', 'picture', 'image');
        $mediaArr->registerMedia($mediaObj, array(
        ));

        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('tradingus_product', 'relatedPicture', 'image');
