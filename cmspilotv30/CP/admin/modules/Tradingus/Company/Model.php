<?
class CP_Admin_Modules_Tradingus_Company_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
    ...
    function setSearchVar($linkRecType = '') {
        ...
        if ($company_id != "") {
            ...
            if ($tv['srcRoom'] != 'tradingus_product'){
                $searchVar->sqlSearchVar[] = "(c.category = 'Client' OR c.category = 'Both')";
            }
    ...
    function getFields(){
        ...
        $fa = $fn->addToFieldsArray($fa, 'price_category');
     ...
     *
     */
    function gettradingusCompanyTradingsgContactLinkSQL($id) {
    ...
    function gettradingusCompanyTradingsgDiscountLinkSQL($id) {
