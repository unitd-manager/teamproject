<?
class CP_Admin_Modules_Ek_Attendance_View extends CP_Common_Lib_ModuleViewAbstract
{
    //==================================================================//
    function getList($dataArray){
        ...
        foreach ($dataArray as $row){
            ...
            {$listObj->getListDataCell($row['record_date'])}
            {$listObj->getListDataCell($fn->getYesNo($row['on_leave']))}
        ...
        {$listObj->getListHeaderCell('Status', 'sa.status')}
        {$listObj->getListHeaderCell('Date', 'sa.record_date')}
        {$listObj->getListHeaderCell('On Leave', 'sa.on_leave')}
    ...
    function getEdit($row) {
        ...
        includeCPClass('fnsMod', 'student', 'FunctionsMod', false);
        ...
        $sqlStatus  = $fn->getValueListSQL('attendanceStatus');
        ...
        {$formObj->getTARow('Comments', 'comment', $row['comment'])}
        ";
        
        $text = "
        {$formObj->getFieldSetWrapped('General Details', $fieldset)}
        ";
