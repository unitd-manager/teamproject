<?
class CP_Admin_Modules_Edukloud_Company_Functions extends CP_Common_Modules_Edukloud_Company_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        $modObj = $modules->getModuleObj('edukloud_company');
    ...
    function setLinksArray($inst) {
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('edukloud_company', 'edukloud_orderLink');
		...
		*/
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('edukloud_company', 'edukloud_contactLink');
