<?
class CP_Admin_Modules_Edukloud_Company_Model extends CP_Common_Modules_Edukloud_Company_Model
{
    /**
     *
     */
     ...
     *
     */
    function getEdukloudCompanyEdukloudOrderLinkSQL($id) {
     ...
     *
     */
    function getEdukloudCompanyEdukloudContactLinkSQL($id) {
    ...
    function getCompanyAddValidate() {
        ...
        if ($reg_number != ''){
            ...
            $emailLink = $fn->getRecordDetailLink('edukloud_company', 'record_id', $rec['company_id'], $expEmail);
