...
cpm.edukloud.parent.init = function(){
}
    ...
    var expObj = {
       ...
       ,callbackOnSuccess: function(){
            ...
            Util.alert(msg, function(){
                ...
                Links.reloadPortalRecords('edukloud_parent#edukloud_orderLink', 'edukloud_parent');
...
$('#traineeSelectedForm .fld_course_id_row').livequery('change', function(){
    ...
    cpm.edukloud.parent.populateLevel.call(this);
    cpm.edukloud.parent.populateBatch.call(this);
    cpm.edukloud.parent.populateSubsidy.call(this);
    //cpm.edukloud.parent.populateDiscount.call(this);
...
$('#traineeSelectedForm #fld_year_of_enrollment').livequery('change', function(){
    ...
    var url = 'index.php?module=edukloud_orderLink&_spAction=monthList&showHTML=0';
    Util.showProgressInd();
...
$('#parentTransfer').livequery('click', function (e){
    ...
    var expObj = {
        validate: true
       ,callbackOnSuccess: function(){
            var urlRedirect = "index.php?_topRm=main&module=edukloud_parent&_action=list";
            
            var msg = 'Parent transferred successfully ..';
            Util.alert(msg, function(){
                Util.closeAllDialogs();
...
cpm.edukloud.parent.populateLevel = function(){
    var courseId = $(this).val();
    var levelObj = $(this).closest('tr').find('.fld_level_id');
    var url = $('#scopeRootAlias').val() + 'index.php?module=edukloud_levelLink&_spAction=levelValueForDropDown&showHTML=0';
    $.ajax({
        type: "POST",
        url: url,
        async: false,
...
cpm.edukloud.parent.populateBatch = function(){
    var courseId = $(this).val();
...
cpm.edukloud.parent.populateSubsidy = function(){
    var courseId   = $(this).val();
    ...
    //var url = $('#scopeRootAlias').val() + 'index.php?module=edukloud_subsidyLink&_spAction=subsidyValueForDropDown&showHTML=0';
...
cpm.edukloud.parent.populateDiscount = function(){
    var courseId = $(this).val();
