<?
class CP_Admin_Modules_Edukloud_OrderLink_Model extends CP_Common_Lib_ModuleLinkModelAbstract
{
    function getFields(){
        ...
        $fa['contact_module']   = 'edukloud_company';
    ...
    */
    function getParentFields(){
        ...
        $fa['order_status']     = 'Due';
        $fa['order_date']       =  date('Y-m-d');
        $fa['contact_module']   = 'edukloud_parent';
        ...
        for ($i= 0; $i< $count; $i++){
            ...
            if ($course_contact_id > 0){
                ...
                //to delete the record in order item
                    ...
                    $deleteSQL = "
                    DELETE FROM order_item
                    WHERE module = 'edukloud_subsidy' AND contact_id = {$trainee_id}
                    ";
                    $resultDelete  = $db->sql_query($deleteSQL);
                }
                ...
                if($discount_id){
                    ...
                    $deleteSQL = "
                    DELETE FROM order_item
                    WHERE module = 'edukloud_discount' AND contact_id = {$trainee_id}
                    ";
                    $resultDelete  = $db->sql_query($deleteSQL);
                }
                */
