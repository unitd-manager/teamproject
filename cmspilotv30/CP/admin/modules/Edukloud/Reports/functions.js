Util.createCPObject('cpm.edukloud.reports');
 
cpm.edukloud.reports = {
    init: function(){
        $('#header, #nav, #footer').slideUp(1000, function(){
            $('#header, #nav, #footer').remove();
            LoadReady.makeScrollableTable();
        });
        cpm.edukloud.reports.setSearchForm();
        ...
        $('.search select[name=report]').change(function(){
            ...
            var url = 'index.php?_topRm=reports&module=edukloud_reports&_spAction=search&showHTML=0&report=' + report;
    ...
    setSearchForm: function(){
        $('table.search input.button').livequery('click', function(e) {
            ...
            var url = 'index.php?_topRm=reports&module=edukloud_reports&_spAction=displayReport&showHTML=0' + allVars;
            $.ajax({
                type: "GET",
                url: url,
                dataType: "html",
