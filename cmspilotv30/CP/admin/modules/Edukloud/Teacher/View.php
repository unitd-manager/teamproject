<?
class CP_Admin_Modules_Edukloud_Teacher_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getEdit($row) {
		...
		";
        //{$formObj->getYesNoRRow('Assessor', 'assessor', $row['assessor'])}
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Picture', 'edukloud_teacher', 'picture', $row)}
        {$media->getRightPanelMediaDisplay('Attachments', 'edukloud_teacher', 'attachment', $row)}
        {$displayLinkData->getLinkPortalMain('edukloud_teacher', 'edukloud_courseLink', 'Course Linked', $row)}
        {$displayLinkData->getLinkPortalMain('edukloud_teacher', 'edukloud_batchLink', 'Batch Linked', $row)}
        ";
        return $text;
    }
