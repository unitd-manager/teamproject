<?
class CP_Admin_Modules_Edukloud_GiroPayment_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
    ...
    function getGiroPaymentSubmit() {
        ...
        /* Updation of Invoice table for Giro Payment success or failed */
    ...
    */
    function getGenerateDBSTxtFile() {
        ...
        $text .= $this->getTextFileForDBS($month);
    ...
    *
    */
    function getTextFileForDBS($month) {
        $fn = Zend_Registry::get('fn');
        $validate = Zend_Registry::get('validate');
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            $amount =  $row['total_invoice_amount'] * 100;
            //$amount =  120 * 100;
