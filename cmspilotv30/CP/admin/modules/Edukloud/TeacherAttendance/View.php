<?
class CP_Admin_Modules_Edukloud_TeacherAttendance_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getNew(){
        ...
        $formObj = Zend_Registry::get('formObj');
   		...
   		$sqlTeacher = getCPModuleObj('edukloud_teacher')->model->getTeacherSQL();
...
/*        $sqlTeacher = $fn->getDDSql('edukloud_teacher');
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'edukloud_teacherAttendance', 'attachment', $row)}
        ";
