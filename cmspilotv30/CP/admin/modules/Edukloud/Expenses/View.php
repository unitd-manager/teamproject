<?
class CP_Admin_Modules_Edukloud_Expenses_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'edukloud_expenses', 'attachment', $row)}
        ";
