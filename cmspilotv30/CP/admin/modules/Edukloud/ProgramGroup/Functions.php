<?
class CP_Admin_Modules_Edukloud_ProgramGroup_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        $modObj = $modules->getModuleObj('edukloud_programGroup');
   ...
   function setLinksArray($inst) {
       $linkObj = $inst->getLinksArrayObj('edukloud_programGroup', 'edukloud_subsidyDiscountLink');
    ...
    *
    */
    function getEdukloudProgramGroupEdukloudSubsidyDiscountLinkAddLinkCallback($program_group_id, $row) {
    ...
    *
    */
    function getEdukloudProgramGroupEdukloudSubsidyDiscountLinkDeleteLinkCallback($program_group_id, $subsidy_discount_id) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
    ...
    *
    */
    function getEdukloudProgramGroupEdukloudSubsidyDiscountLinkAddAllLinkCallback($program_group_id) {
        $fn = Zend_Registry::get('fn');
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
    ...
    *
    */
    function getEdukloudProgramGroupEdukloudSubsidyDiscountLinkRemoveAllLinkCallback($program_group_id) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
