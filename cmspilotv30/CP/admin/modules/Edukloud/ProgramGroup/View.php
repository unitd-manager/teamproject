<?
class CP_Admin_Modules_Edukloud_ProgramGroup_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$displayLinkData->getLinkPortalMain('edukloud_programGroup', 'edukloud_subsidyDiscountLink', 'Subsidy Discount Link', $row)}
        ";
