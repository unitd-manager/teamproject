<?
class CP_Admin_Modules_Edukloud_Invoice_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getEdit($row) {
        ...
        $expInvNo  = array('isEditable' => $cpCfg['m.pms.invoice.codeEditable']);
    ...
    function getRightPanel($row) {
        ...
        $text = "
        {$media->getRightPanelMediaDisplay('Attachments', 'pms_invoice', 'attachment', $row)}
        ";
