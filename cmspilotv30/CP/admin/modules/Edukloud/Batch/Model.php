<?
class CP_Admin_Modules_Edukloud_Batch_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
    function getSQL() {
        ...
        $extraFieldNames = '';
        $extraTableNames = '';
        if ($cpCfg['m.edukloud.batch.showSubjectPvt']) {
        ...
        if ($cpCfg['m.edukloud.batch.showClassPvt']) {
     ...
     *
     */
    function getEdukloudBatchEdukloudContactLinkSQL($id) {
     ...
     *
     */
    function getEdukloudBatchEdukloudAssessorLinkSQL($id) {
        $formObj = Zend_Registry::get('formObj');
     ...
     *
     */
    function getEdukloudBatchEdukloudTeacherLinkSQL($id) {
        $cpCfg = Zend_Registry::get('cpCfg');

        $sqlAppend = '';
        if($cpCfg['m.edukloud.batch.showTrainerOnly']){
     ...
     *
     */
    function getEdukloudBatchEdukloudTeacherLinkLinkedIdsSQL() {
        $tv     = Zend_Registry::get('tv');
        $cpCfg  = Zend_Registry::get('cpCfg');
     ...
     *
     */
    function getEdukloudBatchEdukloudAssessorLinkLinkedIdsSQL() {
        $tv = Zend_Registry::get('tv');
