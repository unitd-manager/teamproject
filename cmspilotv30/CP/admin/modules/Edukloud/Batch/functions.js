Util.createCPObject('cpm.edukloud.batch');
cpm.edukloud.batch.init = function(){
    $('.edukloud_batch__edukloud_studentFeedbackLink select[name=group]').livequery('change', function(){
        Util.showProgressInd('Populating related content.... Please wait');

        cpm.edukloud.batch.populateRelatedQuestions.call(this);
    });
    
}

cpm.edukloud.batch.populateRelatedQuestions = function(){
    feedback_group = $(this).val();
    batch_id = $('input:hidden[name=batch_id]').val();
    
    var url = $('#scopeRootAlias').val() + 'index.php?module=edukloud_batch&_spAction=feedbackQuestions&showHTML=0';
    ...
    var expObj = {
       ...
       ,callbackOnSuccess: function(){
            ...
            Util.alert(msg, function(){
                ...
                Links.reloadPortalRecords('edukloud_batch#edukloud_contactLink', 'edukloud_batch');
            });
        }
    }
...
$("#takeAttendance").livequery('click', function (e){
    ...
    var expObj = {
       ...
       ,callbackOnSuccess: function(){
            ...
            Util.alert(msg, function(){
                Util.closeAllDialogs();
                Links.reloadPortalRecords('edukloud_batch#edukloud_attendance', 'edukloud_batch');
...
$("#studentGrade").livequery('click', function (e){
    ...
    var expObj = {
       ...
       ,callbackOnSuccess: function(){
            ...
            Util.alert(msg, function(){
                Util.closeAllDialogs();
                Links.reloadPortalRecords('edukloud_batch#edukloud_studentGrade', 'edukloud_batch');
                window.location.reload(true);
            });
        }
    }
...
$("#studentFeedback").livequery('click', function (e){
    ...
    var expObj = {
       ...
       ,callbackOnSuccess: function(){
            ...
            Util.alert(msg, function(){
                Util.closeAllDialogs();
                Links.reloadPortalRecords('edukloud_batch#edukloud_feedback', 'edukloud_batch');
                window.location.reload(true);
            });
        }
    }
...
$(".editStudentFeedback").livequery('click', function (e){
    ...
    var expObj = {
       ...
       ,callbackOnSuccess: function(){
            ...
            Util.alert(msg, function(){
                Util.closeAllDialogs();
                Links.reloadPortalRecords('edukloud_batch#edukloud_student_feedback', 'edukloud_batch');
            });
        }
    }
...
$('input#marks').livequery('change', function(){
    ...
    var url = 'index.php?module=edukloud_batch&_spAction=updateGrade&showHTML=0';
    grade = 'input#fld_' + batch_history_id + '_grade';
    $.get(url, {mark: mark}, function(html){
        $(grade).val(html);
    });

    var url = 'index.php?module=edukloud_batch&_spAction=updateStudentResult&showHTML=0';
