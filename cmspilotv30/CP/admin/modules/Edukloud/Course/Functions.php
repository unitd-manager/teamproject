<?
class CP_Admin_Modules_Edukloud_Course_Functions extends CP_Common_Modules_Edukloud_Course_Functions
{
   function setLinksArray($inst) {
       $linkObj = $inst->getLinksArrayObj('edukloud_course', 'edukloud_batchLink');
	   ...
	   //------------------------------------------------------------------------------//
       $linkObj = $inst->getLinksArrayObj('edukloud_course', 'edukloud_courseSubsidyLink');
       $inst->registerLinksArray($linkObj, array(
       ...
       //------------------------------------------------------------------------------//
       $linkObj = $inst->getLinksArrayObj('edukloud_course', 'edukloud_subjectLink');
       $inst->registerLinksArray($linkObj, array(
	   ...
	   //------------------------------------------------------------------------------//
       $linkObj = $inst->getLinksArrayObj('edukloud_course', 'edukloud_levelLink');
       $inst->registerLinksArray($linkObj, array(
    ...
    /**
    */
    function getEdukloudCourseEdukloudBatchLinkPortalSearch() {
