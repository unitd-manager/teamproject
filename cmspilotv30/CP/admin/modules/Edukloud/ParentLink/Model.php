<?
class CP_Admin_Modules_Edukloud_ParentLink_Model extends CP_Common_Lib_ModuleLinkModelAbstract
{
    function getNewValidate() {
        ...
        if ($id_card_no != ''){
            ...
            $IdCardlink = $fn->getRecordDetailLink('edukloud_parent', 'record_id', $rec['parent_id'], $expIdCard);
    ...
    function getAdd(){
        ...
        $modObj = getCPModuleObj('edukloud_parent');
