...
Util.createCPObject('cpm.edukloud.paymentSummary');

cpm.edukloud.giroPayment = {
    init: function(){
        $('.click-all-top .check-all').click(cpm.edukloud.paymentSummary.checkAllCol);
        $('.click-all-top .uncheck-all').click(cpm.edukloud.paymentSummary.uncheckAllCol);
    },
...
$('.m-edukloud_paymentSummary form.giroForm .invoiceCode').livequery('click', function(e){
    var invoice_code  = $(this).val();
    var is_checked  = $(this).is(':checked');

    var url = 'index.php?module=edukloud_paymentSummary&_spAction=setInvoiceCodeForSession&showHTML=0';
...
$('#generateReceiptForParent').livequery('click', function (e){
    ...
    $("select[name='mode_of_payment']").livequery('change', function (e){
        cpm.edukloud.giroPayment.populatePaymentMode.call(this);
    });
    ...
    var expObj = {
       ...
       ,callbackOnSuccess: function(){
            ...
            var url = "index.php?_topRm=finance&module=edukloud_order&_spAction=printGroupReceiptInFpdf&showHTML=0";
...
cpm.edukloud.giroPayment.populatePaymentMode = function(){
...
$('.receiptFormForParent .populateAmountPayable').livequery('click', function (e){
    ...
    var url = 'index.php?_topRm=finance&module=edukloud_order&_spAction=calculateAmountPayable&showHTML=0';
    Util.showProgressInd();
