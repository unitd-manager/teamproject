<?
class CP_Admin_Modules_Edukloud_PaymentSummary_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
    ...
    function getGenerateReceiptForParentFormSubmit() {
        ...
        #$cpUtil->redirect("index.php?_topRm=finance&module=edukloud_order&_spAction=printGroupReceiptInFpdf&showHTML=0");
