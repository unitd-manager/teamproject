<?
class CP_Admin_Modules_Edukloud_CreditNote_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'edukloud_creditNote', 'attachment', $row)}
        ";
