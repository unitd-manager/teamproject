<?
class CP_Admin_Modules_Edukloud_Order_Functions
{
    function setModuleArray($modules){
        $cpCfg = Zend_Registry::get('cpCfg');
        $modObj = $modules->getModuleObj('edukloud_order');
    ...
    function setActionsArray($actArrayObj){
        ...
        $actArrayObj->registerAction($actObj, array(
            'title' => 'Print'
           ,'url' => "index.php?module=edukloud_order&_spAction=printOrder"
        ));
    }
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('edukloud_order', 'ecommerce_orderItemLink');
        ...
        //------------------------------------------------------------------------------//
        /*$linkObj = $inst->getLinksArrayObj('edukloud_order', 'edukloud_paymentLink');
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('edukloud_order', 'edukloud_insuranceLink');
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('edukloud_order', 'attachment', 'attachment');
