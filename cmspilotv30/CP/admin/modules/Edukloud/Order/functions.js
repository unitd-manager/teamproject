$("select[name='subsidy_paid']").change(function(){
    ...
    var url = 'index.php?_topRm=reports&module=edukloud_order&_spAction=updateSubsidyStatus&showHTML=0&order_item_id=' + order_item_id + '&subsidy_paid_status' + subsidy_paid_status;
...
Util.createCPObject('cpm.edukloud.order');

$('.check-all').livequery('click', function (e){
    cpm.edukloud.order.checkAllRow.call(this)
});

$('.uncheck-all').livequery('click', function (e){
    cpm.edukloud.order.uncheckAllRow.call(this)
});
...
$('.cancelInvoice').livequery('click', function (e){
    ...
    if (!confirm(msg)){
        ...
        var url = 'index.php?_topRm=finance&module=edukloud_order&_spAction=cancelInvoice&showHTML=0';
        Util.showProgressInd();
...
cpm.edukloud.order = {
    init: function(){
        $('.check-all').click(cpm.edukloud.order.checkAllRow);
        $('.click-all-side .uncheck-all').click(cpm.edukloud.order.uncheckAllRow);
    },
    ...
    printOrder:function(){
        ...
        var url = 'index.php?module=edukloud_order&_spAction=printOrder&order_id=' + recordId;
        $.get(url, function(html){
        //alert ('Status Updated Succesfully');
        //Util.hideProgressInd();
        });
...
$('#deleteInvoicePvt').livequery('click', function (e){
    ...
    if (!confirm(msg)){
        ...
        var url = 'index.php?_topRm=finance&module=edukloud_order&_spAction=deleteInvoiceFormPvt&showHTML=0';
        Util.showProgressInd();
...
$('.editReceiptPvt').livequery('click', function (e){
    ...
    $("select[name='mode_of_payment']").livequery('change', function (e){
        cpm.edukloud.order.populatePaymentMode.call(this);
    });
...
$(".clearInvoiceCode").livequery('click', function (e){
    ...
    var url = 'index.php?module=edukloud_order&_spAction=clearInvoice&showHTML=0';
...
/*$("select[name='status']").change(function(){
    ...
    var url = 'index.php?_topRm=finance&module=edukloud_order&_spAction=updateInvoiceStatus&showHTML=0';
    Util.showProgressInd();
...
$('#generateReceiptPvt').livequery('click', function (e){
    ...
    if (!confirm(msg)){
        ...
        cpm.edukloud.order.populateReceiptModeOfPayment.call(this);
...
$('#generateMiscReceiptPvt').livequery('click', function (e){
    ...
    if (!confirm(msg)){
        ...
        $(".miscReceiptFormForPvt input[name='late_fees']").livequery('change', function(e){
            cpm.edukloud.order.populateMiscTotalAmount.call(this);
        });
...
$('input.invoiceCode').livequery('click', function (e){
    ...
    var url = 'index.php?_topRm=finance&module=edukloud_order&_spAction=populateReceiptAmount&showHTML=0';
    $.get(url,{invoice_code: invoice_code ,checkedVal: checkedVal}, function(html){
        $('#totalAmountPayable').html('');
        $('input[id=fld_amount]').val(html);
    });
    
    var url = 'index.php?module=edukloud_order&_spAction=populateDiscountAmount&showHTML=0';
    $.get(url,{invoice_code: invoice_code ,checkedVal: checkedVal}, function(html){
...
$('input.invoiceCodePvt').livequery('click', function (e){
    ...
    var url = 'index.php?_topRm=finance&module=edukloud_order&_spAction=populateReceiptAmountPvt&showHTML=0';
...
$('input.invoiceCodeMiscPvt').livequery('click', function (e){
    ...
    var url = 'index.php?_topRm=finance&module=edukloud_order&_spAction=populateReceiptAmountMiscPvt&showHTML=0';
    $.get(url,{invoice_hist_id: invoice_hist_id,checkedVal:checkedVal}, function(html){
        $('input[id=fld_amount]').val(html);
        Util.hideProgressInd();
    });
...
$('input.receiptCode').livequery('click', function (e){
    ...
    var url = 'index.php?_topRm=finance&module=edukloud_order&_spAction=populateRefundAmount&showHTML=0';
...
$("#fld_invoice_id").livequery('change', function(){
    ...
    var url = 'index.php?_topRm=finance&module=edukloud_order&_spAction=populateCreditNoteAmount&showHTML=0';
    $.get(url,{invoice_id: invoice_id}, function(html){
        $('input[id=fld_amount]').val(html);
        Util.hideProgressInd();
    });
...
cpm.edukloud.order.populatePaymentMode = function(){
...
cpm.edukloud.order.populateReceiptModeOfPayment = function(){
    $("select[name='mode_of_payment']").livequery('change', function (e){
        var paymentMode = $(this).val();
        if (paymentMode == 'Cheque') {
            Util.showProgressInd();
...
cpm.edukloud.order.populateMiscTotalAmount = function(){
    ...
    var url = 'index.php?_topRm=finance&module=edukloud_order&_spAction=populateMiscTotalAmount&showHTML=0';
...
$(".invoiceDisplay select[name='status']").livequery('change', function (e){
    ...
    var url = 'index.php?module=edukloud_order&_spAction=invoiceRecords&showHTML=0';
...
$('.receiptForm .populateAmountPayable').livequery('click', function (e){
    ...
    var url = 'index.php?module=edukloud_order&_spAction=calculateAmountPayable&showHTML=0';
    Util.showProgressInd();
