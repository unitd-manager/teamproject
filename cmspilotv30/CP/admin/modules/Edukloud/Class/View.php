<?
class CP_Admin_Modules_Edukloud_Class_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'edukloud_class', 'attachment', $row)}
		{$displayLinkData->getLinkPortalMain('edukloud_class', 'edukloud_contactLink', 'Contact Linked', $row)}
        ";
