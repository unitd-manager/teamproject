<?
class CP_Admin_Modules_ManPower_StaffAttendance_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getNew(){
        ...
        if($cpCfg['cp.hasMultiUniqueSites'] == true) {
            $appendStaffSql = "WHERE site_id = '{$_SESSION['cp_site_id']}'"; 
        }
    ...
    function getQuickSearch() {
        ...
        if ($userGroupID == 1 ){
            ...
            FROM staff a 
            WHERE a.staff_login_type = 'Staff'
            {$appendStaffSql}
            ORDER BY staff_name
            ";
