<?
class CP_Admin_Modules_ManPower_TimesheetLink_View extends CP_Common_Lib_ModuleLinkViewAbstract
{
    /**
     *
     */
    function getNew(){
        ...
        WHERE ts.task_id = {$tv['srcRoomId']}              
        ";
        $extFlds = '';
        
        if ($tv['srcRoom'] == 'manPower_task'){
        ...
        <form id='portalForm' class='yform columnar' method='post' action='{$formAction}'>
            <fieldset>
                {$formObj->getDDRowBySQL("{$cpCfg['m.project.staffFieldLabel']} Name", 'staff_id', $sqlStaff, $_SESSION['staff_id'])}
    ...
    function getEdit(){
        ...
        <form id='portalForm' class='yform columnar' method='post' action='{$formAction}'>
            <fieldset>
                {$formObj->getDDRowBySQL("{$cpCfg['m.project.staffFieldLabel']} Name", 'staff_id', $sqlStaff, $row['staff_id'])}
