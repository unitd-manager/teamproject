<?
class CP_Admin_Modules_ManPower_Task_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('manPower_task');
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('manPower_task', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('manPower_task', 'manPower_timesheetLink');
        ...
        $inst->registerLinksArray($linkObj, array(
           ...
           ,'anchorFieldsArr'       => array(
                 'entry_date' => $inst->getLinkAnchorObj(
                     'entry_date'
                    ,'timesheet_id'
                    ,false
                    ,'manPower_timesheet'
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('manPower_task', 'core_staffLink');
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('manPower_task', 'project_taskHistoryLink');
