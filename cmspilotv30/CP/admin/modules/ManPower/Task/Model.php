<?
class CP_Admin_Modules_ManPower_Task_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
    ...
    function setSearchVar() {
        ...
        if ($task_id != "") {
            ...
            if ($_SESSION['userGroupType'] != "Super Administrator") {
                $searchVar->sqlSearchVar[] = "t.staff_id  = '{$_SESSION['staff_id']}' OR ts.staff_id = '{$_SESSION['staff_id']}'";
            }
     ...
     *
     */
    function getManPowerTaskManPowerTimesheetLinkSQL($id) {
     ...
     *
     */
    function getManPowerTaskProjectTaskHistoryLinkSQL($id) {
