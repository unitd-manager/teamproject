<?
class CP_Admin_Modules_ManPower_Order_Functions
{
    //==================================================================//
    function setModuleArray($modules){
        $cpCfg = Zend_Registry::get('cpCfg');
        $modObj = $modules->getModuleObj('manPower_order');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('manPower_order', 'ecommerce_orderItemLink');
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('manPower_order', 'manPower_invoiceLink');
        $inst->registerLinksArray($linkObj, array(
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('manPower_order', 'manPower_receiptLink');
        $inst->registerLinksArray($linkObj, array(
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('manPower_order', 'attachment', 'attachment');

        $mediaArr->registerMedia($mediaObj, array(
        ));

        $mediaObj = $mediaArr->getMediaObj('manPower_order', 'label', 'attachment');
