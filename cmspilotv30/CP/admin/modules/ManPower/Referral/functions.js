Util.createCPObject('cpm.manPower.referral');
cpm.manPower.referral.init = function(){

    $('.m-manPower_referral input[name=documents]').livequery('click', function (e){
        ...
        var url = 'index.php?_topRm=admin&module=manPower_referral&_spAction=companyDocumentSubmit&showHTML=0';
