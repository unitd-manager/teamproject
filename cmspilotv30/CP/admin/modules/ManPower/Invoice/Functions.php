<?
class CP_Admin_Modules_ManPower_Invoice_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('manPower_invoice');
    ...
    function setLinksArray($inst) {
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('manPower_invoice', 'manPower_invoiceItem');
