<?
class CP_Admin_Modules_AgileIms_Batch_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('agileIms_batch');
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('agileIms_batch', 'picture', 'image');
        $mediaObj = $mediaArr->getMediaObj('agileIms_batch', 'attachment', 'attachment');
    ...
    */
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('agileIms_batch', 'agileIms_teacherLink');        
	   ...
	   //------------------------------------------------------------------------------//
       $linkObj = $inst->getLinksArrayObj('agileIms_batch', 'agileIms_assessorLink');
       $inst->registerLinksArray($linkObj, array(
        ...
        $linkObj = $inst->getLinksArrayObj('agileIms_batch', 'agileIms_attendance');               
        $inst->registerLinksArray($linkObj, array(
        ...
        $linkObj = $inst->getLinksArrayObj('agileIms_batch', 'agileIms_feedback');                
        $inst->registerLinksArray($linkObj, array(
    ...
    *
    */
    function getAgileImsBatchAgileImsContactLinkAddLinkCallback($course_contact_id, $row) {
     ...
     *
     */
    function getAgileImsBatchAgileImsContactLinkDeleteLinkCallback($batch_id, $contact_id) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
        $fn = Zend_Registry::get('fn');
     ...
     *
     */
    function getAgileImsBatchAgileImsContactLinkAddAllLinkCallback($batch_id, $newly_created_contact_ids) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
     ...
     *
     */
    function getAgileImsBatchAgileImsContactLinkRemoveAllLinkCallback($batch_id, $removed_contact_ids) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
