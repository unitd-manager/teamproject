<?
class CP_Admin_Modules_AgileIms_ProgramGroup_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        $modObj = $modules->getModuleObj('agileIms_programGroup');
   ...
   function setLinksArray($inst) {
       $linkObj = $inst->getLinksArrayObj('agileIms_programGroup', 'agileIms_subsidyDiscountLink');
    ...
    *
    */
    function getAgileImsProgramGroupAgileImsSubsidyDiscountLinkAddLinkCallback($program_group_id, $row) {
    ...
    *
    */
    function getAgileImsProgramGroupAgileImsSubsidyDiscountLinkDeleteLinkCallback($program_group_id, $subsidy_discount_id) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
    ...
    *
    */
    function getAgileImsProgramGroupAgileImsSubsidyDiscountLinkAddAllLinkCallback($program_group_id) {
        $fn = Zend_Registry::get('fn');
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
    ...
    *
    */
    function getAgileImsProgramGroupAgileImsSubsidyDiscountLinkRemoveAllLinkCallback($program_group_id) {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
