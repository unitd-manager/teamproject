<?
class CP_Admin_Modules_AgileIms_ProgramGroup_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
        $SQL   = "
        SELECT pg.*
     ...
     *
     */
    function getAgileImsProgramGroupAgileImsSubsidyDiscountLinkSQL($id) {
