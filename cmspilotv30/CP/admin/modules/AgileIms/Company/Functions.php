<?
class CP_Admin_Modules_AgileIms_Company_Functions extends CP_Common_Modules_AgileIms_Company_Functions
{
    /**
     *
     */
    ...
    function setLinksArray($inst) {
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('agileIms_company', 'agileIms_orderLink');
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('agileIms_company', 'agileIms_contactLink');
    ...
    function getPrintVoucher() {
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            if($row['module'] == 'agileIms_course'){
                $courseTxt = 'Programme Fee :' . '[ ' . $row['contact_name'] .' ]';
            }
            else if($row['module'] == 'agileIms_subsidy'){
                $courseTxt = 'Rebate for Tuition Fee :' . '[ ' . $row['contact_name'] .' ]';
            }
            else if($row['module'] == 'agileIms_discount'){
                $courseTxt = 'Discount';
