<?
class CP_Admin_Modules_AgileIms_Reports_Model extends CP_Common_Lib_ModuleModelAbstract
{
    ...
    function __construct() {
        ...
        $this->reportsArray = array( 
           ...
           ,'subsidyPaidHistoryReport'    => $this->getReportObj('subsidyPaidHistoryReport', 'Subsidy Paid History Report')
    ...
    function getCompanyContactSqlByEnrollmentType(){
        ...
        while ($row = $db->sql_fetchrow($result)) {
            $json[] = array("value" => $row['company_contact_id'], "caption" => $row['company_contact_name']);
        }
