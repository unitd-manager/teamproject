<?
class CP_Admin_Modules_AgileIms_Order_Functions
{
    function setModuleArray($modules){
        $cpCfg = Zend_Registry::get('cpCfg');
        $modObj = $modules->getModuleObj('agileIms_order');
    ...
    function setActionsArray($actArrayObj){
        ...
        $actArrayObj->registerAction($actObj, array(
            'title' => 'Print'
           ,'url' => "index.php?module=agileIms_order&_spAction=printOrder"
        ));
    }
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('agileIms_order', 'ecommerce_orderItemLink');
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('agileIms_order', 'agileIms_insuranceLink');
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('agileIms_order', 'attachment', 'attachment');
