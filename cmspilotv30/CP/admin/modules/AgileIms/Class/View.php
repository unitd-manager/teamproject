<?
class CP_Admin_Modules_AgileIms_Class_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'agileIms_class', 'attachment', $row)}
		{$displayLinkData->getLinkPortalMain('agileIms_class', 'agileIms_contactLink', 'Students Linked', $row)}
        ";
