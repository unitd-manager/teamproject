<?
class CP_Admin_Modules_AgileIms_Teacher_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
    ...
    function setSearchVar($linkRecType = '') {
        ...
        if ($teacher_id != "") {
            ...
            if ($tv['keyword'] != "") {
                ...
                OR t.email LIKE '%{$tv['keyword']}%'
                OR t.teacher_code LIKE '%{$tv['keyword']}%'
                )";
            }
        }        
    }
    ...
    function getNewValidate() {
        ...
        $validate->validateData('first_name', 'Please enter Teacher name');
     ...
     *
     */
    function getAgileImsTeacherAgileImsCourseLinkSQL($id) {
    ...
    function getTeacherBySubjectJSON(){
        ...
        $SQL = "
        SELECT t.teacher_id
              ,t.first_name AS teacher_details
        FROM teacher t
        ...
        while ($row = $db->sql_fetchrow($result)) {
            $json[] = array("value" => $row['teacher_id'], "caption" => $row['teacher_details']);
        }
