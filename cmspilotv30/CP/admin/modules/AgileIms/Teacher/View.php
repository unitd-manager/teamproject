<?
class CP_Admin_Modules_AgileIms_Teacher_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    function getList($dataArray){
        ...
        foreach ($dataArray as $row){
            ...
            {$listObj->getListDataCell($row['trainer_type'])}
        ...
        {$listObj->getListHeaderCell('Name', 't.first_name')}
        {$listObj->getListHeaderCell('Email', 't.email')}
        {$listObj->getListHeaderCell('Trainer Type', 't.trainer_type')}
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Picture', 'agileIms_teacher', 'picture', $row)}
        {$media->getRightPanelMediaDisplay('Attachments', 'agileIms_teacher', 'attachment', $row)}
        {$displayLinkData->getLinkPortalMain('agileIms_teacher', 'agileIms_courseLink', 'Course Linked', $row)}
        {$displayLinkData->getLinkPortalMain('agileIms_teacher', 'agileIms_batchLink', 'Batch Linked', $row)}
        ";
        return $text;
    }
