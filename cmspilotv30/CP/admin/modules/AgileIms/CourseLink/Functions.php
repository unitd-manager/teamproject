<?
class CP_Admin_Modules_AgileIms_CourseLink_Functions
{
    function setModuleArray($modules){
        $fn = Zend_Registry::get('fn');
        $tv = Zend_Registry::get('tv');
    
        $modObj = $modules->getModuleObj('agileIms_courseLink');
        if ($tv['srcRoom'] == 'agileIms_teacher' || $tv['srcRoom'] == 'agileIms_document'){
