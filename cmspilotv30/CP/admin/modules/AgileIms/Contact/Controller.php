<?
class CP_Admin_Modules_AgileIms_Contact_Controller extends CP_Common_Lib_ModuleControllerAbstract
{
    ...
    */
    function getPrintEnrollmentPdf() {
        return $this->view->getPrintEnrollmentPdf();
    }

    /**
    */
    function getCancelEnrollmentForStudent() {
        return $this->model->getCancelEnrollmentForStudent();
    }
}