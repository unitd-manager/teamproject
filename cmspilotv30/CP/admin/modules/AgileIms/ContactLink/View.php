<?
class CP_Admin_Modules_AgileIms_ContactLink_View extends CP_Common_Lib_ModuleLinkViewAbstract
{
    function getList($dataArray, $linkRecType) {
        ...
        if ($tv['srcRoom'] == 'agileIms_class' && $tv['lnkRoom'] == 'agileIms_contactLink') {
    ...
    */
    function getNew(){
        ...
        if ($tv['srcRoom'] == 'agileIms_resources' && $tv['lnkRoom'] == 'agileIms_contactLink') {
    ...
    */
    function getNewForResources(){
        ...
        $sqlContact = $fn->getDDSql('agileIms_contact');
