<?
class CP_Admin_Modules_AgileIms_Course_Functions extends CP_Common_Modules_AgileIms_Course_Functions
{
   function setLinksArray($inst) {

       $linkObj = $inst->getLinksArrayObj('agileIms_course', 'agileIms_batchLink');
	   ...
	   //------------------------------------------------------------------------------//
       $linkObj = $inst->getLinksArrayObj('agileIms_course', 'agileIms_courseSubsidyLink');
       $inst->registerLinksArray($linkObj, array(
       ...
       //------------------------------------------------------------------------------//
       $linkObj = $inst->getLinksArrayObj('agileIms_course', 'agileIms_subjectLink');
       $inst->registerLinksArray($linkObj, array(
	   ...
	   //------------------------------------------------------------------------------//
       $linkObj = $inst->getLinksArrayObj('agileIms_course', 'agileIms_levelLink');
       $inst->registerLinksArray($linkObj, array(
    ...
    /**
    */
    function getAgileImsCourseAgileImsBatchLinkPortalSearch() {
