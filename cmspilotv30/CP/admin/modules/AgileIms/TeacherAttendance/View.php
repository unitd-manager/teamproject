<?
class CP_Admin_Modules_AgileIms_TeacherAttendance_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getNew(){
        ...
        $formObj = Zend_Registry::get('formObj');
   		...
   		$sqlTeacher = getCPModuleObj('agileIms_teacher')->model->getTeacherSQL();
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'agileIms_teacherAttendance', 'attachment', $row)}
        ";
