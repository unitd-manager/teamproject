<?
class CP_Admin_Modules_AgileIms_Invoice_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getEdit($row) {
        ...
        $expInvNo  = array('isEditable' => $cpCfg['m.agileIms.invoice.codeEditable']);
    ...
    function getRightPanel($row) {
        ...
        $text = "
        {$media->getRightPanelMediaDisplay('Attachments', 'agileIms_invoice', 'attachment', $row)}
        ";
    ...
    function getEditInvoiceForm() {
        ...
        $formAction = "index.php?module=agileIms_invoice&_spAction=editInvoiceFormSubmit&showHTML=0";
