<?
class CP_Admin_Modules_AgileIms_SubsidyHistory_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
        ...
        if ($tv['record_id'] != '') {
            ...
            if ($tv['keyword'] != "") {
                $searchVar->sqlSearchVar[] = "(
                                        ...
                                        sh.subsidy_code   LIKE '%{$tv['keyword']}%' OR
                                        o.cust_first_name LIKE '%{$tv['keyword']}%'
                )";
            }
        }        
    }
