<?
class CP_Admin_Modules_AgileIms_Refund_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        $text ="
        {$media->getRightPanelMediaDisplay('Attachments', 'agileIms_refund', 'attachment', $row)}
        ";
