<?
class CP_Admin_Modules_Tradingin_Invoice_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
     ...
     */
     function getGenerateInvoiceForm() {
        ...
        $formAction = "index.php?_topRm=finance&module=tradingin_order&_spAction=generateInvoiceFormSubmit&showHTML=0";
     ...
     */
     function getEditInvoiceForm() {
        ...
        $formAction = "index.php?_topRm=finance&module=tradingin_order&_spAction=editInvoiceFormSubmit&showHTML=0";
