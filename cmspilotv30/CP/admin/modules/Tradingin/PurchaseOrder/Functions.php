<?
class CP_Admin_Modules_Tradingin_PurchaseOrder_Functions
{
    /**
     *
     */
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('tradingin_purchaseOrder');
    ...
    function setMediaArray($mediaArr) {
        $mediaObj = $mediaArr->getMediaObj('tradingin_purchaseOrder', 'attachment', 'attachment');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('tradingin_purchaseOrder', 'tradingsg_productLink');
    ...
    function setReportsArray($repInst) {
        ...
        $repInst->setReportArrayObj('tradingin_purchaseOrder', 'purchaseOrder');
        $arr = &$repInst->reportsArray['tradingin_purchaseOrder']['purchaseOrder'];
