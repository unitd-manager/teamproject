<?
class CP_Admin_Modules_Tradingin_Order_Functions
{
    //==================================================================//
    function setModuleArray($modules){
        $cpCfg = Zend_Registry::get('cpCfg');
        $modObj = $modules->getModuleObj('tradingin_order');
    ...
    function setLinksArray($inst) {
        ...
        $linkObj = $inst->getLinksArrayObj('tradingin_order', 'ecommerce_orderItemLink');
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('tradingin_order', 'tradingsg_invoiceLink');
        $inst->registerLinksArray($linkObj, array(
        ...
        //------------------------------------------------------------------------------//
        $linkObj = $inst->getLinksArrayObj('tradingin_order', 'tradingsg_receiptLink');
        $inst->registerLinksArray($linkObj, array(
    ...
    function setMediaArray($mediaArr) {
        ...
        //------------------------------------------------------------------------------//
        $mediaObj = $mediaArr->getMediaObj('tradingin_order', 'attachment', 'attachment');

        $mediaArr->registerMedia($mediaObj, array(
        ));

        $mediaObj = $mediaArr->getMediaObj('tradingin_order', 'label', 'attachment');
     ...
     *
    */
    function getTradinginOrderEcommerceOrderItemLinkPortalSearch1() {
        $db = Zend_Registry::get('db');
        $dbUtil = Zend_Registry::get('dbUtil');
        $fn = Zend_Registry::get('fn');
