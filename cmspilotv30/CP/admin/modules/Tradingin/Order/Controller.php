<?
class CP_Admin_Modules_Tradingin_Order_Controller extends CP_Common_Lib_ModuleControllerAbstract
{
    /**
     *
     */
    ...
    function getGenerateInvoiceForm() {
        $modObj = getCPModuleObj('tradingin_invoice');
    ...
    function getGenerateReceiptForm() {
        $modObj = getCPModuleObj('tradingin_receipt');
