<?
class CP_Admin_Modules_Ecard_Contact_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
        ...
        SELECT c.*
              ...
              ,IF((ISNULL(c.inv_email_opened) OR c.inv_email_opened = '') AND login_count > 0, 1, c.inv_email_opened) AS email_opened
        FROM contact c
        {$extraTableNames}
        ";
