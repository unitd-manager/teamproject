<?
class CP_Admin_Modules_Directory_Borough_Model extends CP_Common_Modules_Directory_Borough_Model
{
    /**
     *
     */
    function getNewValidate() {
        ...
        $validate->validateData('title', 'Please enter the borough name');
    ...
    function getExportData($dataArray){
        ...
        $fa = array(
              'title' => $phpExcel->getFldObj('Borough')
