<?
class CP_Admin_Modules_Directory_SocialMedia_Model extends CP_Common_Modules_Directory_SocialMedia_Model
{
    ...
    function getFields() {
        ...
        $fa = $fn->addToFieldsArray($fa, 'embed_code1');
        $fa = $fn->addToFieldsArray($fa, 'embed_code2');
