<?
class CP_Admin_Modules_Edukite_Task_View extends CP_Common_Modules_Edukite_Task_View
{
    //==================================================================//
    ...
    function getRightPanel($row){
        ...
        {$displayLinkData->getLinkPortalMain("edukite_task", "edukite_studentLink", "Students Linked", $row)}
        {$displayLinkData->getLinkPortalMain("edukite_task", "edukite_classLink", "Classes Linked", $row)}
        ";
        return $text;
    }
