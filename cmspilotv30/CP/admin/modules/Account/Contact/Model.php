<?
class CP_Admin_Modules_Account_Contact_Model extends CP_Common_Lib_ModuleModelAbstract
{
    function getSQL() {
    ...
    function setSearchVar($linkRecType = '') {
        ...
        if ($contact_id != "") {
            ...
            if ($tv['special_search'] == 'Invalid Emails' ) {
                $searchVar->sqlSearchVar[] = "c.invalid_email = 1";
            }

            if ($language != '' ) {
                $searchVar->sqlSearchVar[] = "c.language = '{$language}'";
            }
