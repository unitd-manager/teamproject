<?
class CP_Admin_Widgets_AgileIms_StudentStatusReports_Model extends CP_Common_Lib_WidgetModelAbstract
{
    function getSQL(){
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'agileIms_studentStatusReports');
