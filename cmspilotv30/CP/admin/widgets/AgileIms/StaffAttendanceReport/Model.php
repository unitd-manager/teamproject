<?
class CP_Admin_Widgets_AgileIms_StaffAttendanceReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
    ...
    function setSearchVar() {
        ...
        $searchVar->sortOrder = 'sa.record_date DESC, sa.staff_attendance_id DESC';
    }
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'agileIms_attendanceReports');
    ...
    function getExportToExcel(){
        ...
        $file_name = "Staff_Attendance_" . date("d-m-Y") . ".xls";
        ...
        LEFT JOIN (staff s) ON (sa.staff_id = s.staff_id)
        {$sqlAppend}
        ORDER BY sa.record_date DESC, sa.staff_attendance_id DESC
        ";
