<?
class CP_Admin_Widgets_AgileIms_StaffAttendanceOverallReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
    ...
    function getExportToExcel(){
        ...
        $file_name = "Staff_Attendance_Overall_Report_" . date("d-m-Y") . ".xls";
