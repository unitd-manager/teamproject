<?
class CP_Admin_Widgets_AceIms_DailyCollectionReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    function getSQL(){
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'aceIms_dailyCollectionReport');
    ...
    function getExportToExcel(){
        ...
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, 'ITEM');
