<?
class CP_Admin_Widgets_AceIms_InvoiceSummaryReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    function getSQL(){
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'aceIms_invoiceSummaryReport');
    ...
    function getExportToExcel(){
        ...
        $file_name = "InvoiceSummaryReport_" . date("d-m-Y") . ".xls";
