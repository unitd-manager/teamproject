<?
class CP_Admin_Widgets_AceIms_InvoiceListingReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    function getSQL(){
...
//        $searchVar->sortOrder = '';
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'aceIms_invoiceListingReport');
