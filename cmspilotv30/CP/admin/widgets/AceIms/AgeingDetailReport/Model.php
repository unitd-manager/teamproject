<?
class CP_Admin_Widgets_AceIms_AgeingDetailReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    function getSQL(){
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'aceIms_ageingDetailReport');
    ...
    function getExportToExcel(){
        ...
        $file_name = "AgeingDetailReport_" . date("d-m-Y") . ".xls";
