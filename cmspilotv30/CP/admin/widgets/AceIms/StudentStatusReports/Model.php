<?
class CP_Admin_Widgets_AceIms_StudentStatusReports_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     * Student Name | Reg No | NRIC No | Course Title | Start Date | End Date | Gender | Nationality | DOB | Mobile | Phone
       Status | Parent Name
     * SQL to find the list of contacts, their personal details along with course details they are studying
     */
    function getSQL(){
        $SQL = "
        SELECT c.contact_id
    ...
    /**
     * Search var condition if status is selected
     */
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'aceIms_studentStatusReports');
    ...
    /**
     * Student Name | Reg No | NRIC No | Course Title | Start Date | End Date | Status | Gender | Nationality | DOB | Mobile | 
       Phone | Parent Name
     * Export to excel function to find the list of contacts, their personal details along with course details they are studying
     */
