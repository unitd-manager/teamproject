<?
class CP_Admin_Widgets_AceIms_CalendarDisplay_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    function getSQL(){
        ...
        if ($cpCfg['w.aceIms.calendarDisplay.hasPvt']) {
            $SQL = "
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'aceIms_calendarDisplay');
    ...
    function getEventDetails(){
        ...
        while ($row = $db->sql_fetchrow($result)) {
             ...
             $batchLink = 'index.php?widget=aceIms_calendarDisplay&_spAction=batchDetails&showHTML=0&batch_id='. $row['batch_id'];
    ...
    function getBatchDetails(){
        ...
        $batchLink = 'index.php?_topRm=main&module=aceIms_batch&_action=edit&batch_id=' . $batch_id;
