<?
class CP_Admin_Widgets_AceIms_TraineeNotLinked_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'aceIms_traineeNotLinked');
