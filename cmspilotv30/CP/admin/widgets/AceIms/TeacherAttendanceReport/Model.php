<?
class CP_Admin_Widgets_AceIms_TeacherAttendanceReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    function getSQL(){
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'aceIms_teacherAttendanceReport');
    ...
    function getExportToExcel(){
        ...
        $file_name = "TeacherAttendanceReport_" . date("d-m-Y") . ".xls";
