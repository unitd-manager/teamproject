<?
class CP_Admin_Widgets_Project_EmployeeReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    ...
    function getExportToExcel(){
        ...
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, 'Part Time / Full Time');
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, 'Hours Worked');
       ...
       /******************** FORMAT HEADER *******************/
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $row['employee_work_type']);
            $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $row['employee_hours']);
            $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $amount);
    ...
    function getExportToExcel1($dataArray = ''){
        ...
        $fa = array(
              'Project_name'      => $phpExcel->getFldObj('Project Name')
             ,'employee_name'     => $phpExcel->getFldObj('Employee Name')
             ,'employee_work_type'=> $phpExcel->getFldObj('Part Time / Full Time')
             ,'employee_hours'    => $phpExcel->getFldObj('Hours Worked')
