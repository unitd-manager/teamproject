<?
class CP_Admin_Widgets_Project_FormCCsNotfiledCompanyReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    function getSQL(){
        $SQL = "
    ...
    function setSearchVar() {
        ...
        $searchVar->sqlSearchVar[] = "t.title = 'Form C / Form CS'";
        ...
        $searchVar->sortOrder = 'c.company_name ASC, t.due_date ASC';
    }
    ...
    function getExportToExcel(){
        ...
        WHERE c.group_name = '{$group_name}'
          AND t.title = 'Form C / Form CS'
          AND c.status != 'Strike Off'
          AND p.work_status != 'Complete'
          AND t.status != 'Complete'
        ORDER BY c.company_name ASC, t.due_date ASC
        ";
    ...
    function getExportToPdf(){
        ...
        <table>
            <tbody>
                <tr>
                    <td align="center"><strong>Form C / Form CS not filed report for ' . $prefix_month .' Year End Companies</strong></td>
                </tr>
                <tr>
                    <td></td>
                </tr>
