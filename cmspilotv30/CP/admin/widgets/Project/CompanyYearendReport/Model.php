<?
class CP_Admin_Widgets_Project_CompanyYearendReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'project_companyYearendReport');
    ...
    function getExportToExcel(){
        ...
        $file_name = "CompanyYearend_" . date("d-m-Y") . ".xls";
    ...
    function getExportToPdf(){
        ...
        <table>
            <tbody>
                <tr>
                    <td align="center"><strong>Company report for ' . $prefix_month .' Year End</strong></td>
                </tr>
                <tr>
                    <td></td>
                </tr>
        ...
        <table border="1" width="100%" cellpadding="4">
            <tr bgcolor="#B6E5F9">
                ...
                <td width="93%"><strong>Company Name</strong></td>
            </tr>
        ';
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            <tr>
                ...
                <td width="93%">' . $row['company_name'] . '</td>
            </tr>
            ';
            $count++;
        }
