<?
class CP_Admin_Widgets_Project_SalesByMonth_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    function getSQL(){
        $SQL = "
        SELECT DATE_FORMAT(start_date, '%b %Y') AS yearMonth
              ,SUM(project_value{$this->getFldSfx()}) AS project_value_ref
        FROM `project`
        ";
