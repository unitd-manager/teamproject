<?
class CP_Admin_Widgets_Project_InvoiceByMonthReports_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'project_invoiceByMonthReports');
    ...
    function getExportToExcel(){
        ...
        SELECT DATE_FORMAT(i.invoice_date, '%b %Y') AS invoice_month
         ...
         AND (i.invoice_date BETWEEN '{$last12Month}' AND '{$today}')
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $row['invoice_amount_monthly']);
        }
