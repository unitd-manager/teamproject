<?
class CP_Admin_Widgets_Project_AGMFileStatusReports_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    //Company Name | Last AGM Date |  Last AR Date | Date of Accounts Laid | Next AGM Due Date
    function getSQL(){
        $SQL = "
    ...
    function setSearchVar() {
        ...
        $searchVar->sqlSearchVar[] = "t.title = 'AGM Date'";
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'project_aGMFileStatusReports');
    ...
    function getExportToExcel(){
        ...
        $file_name = "AgmNotFiled_" . date("d-m-Y") . ".xls";
    ...
    function getExportToPdf(){
        ...
        <table>
            <tbody>
                <tr>
                    <td align="center"><strong>AGM not filed report for ' . $prefix_month .' Year End Companies</strong></td>
                </tr>
                <tr>
                    <td></td>
                </tr>
        ...
        $download_title = "AGM-not-filed-report" . date("d-m-Y") .'.pdf';
