<?
class CP_Admin_Widgets_Logistics_IncomeByMonth_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    function getSQL(){
        ...
        $SQL = "
        SELECT DATE_FORMAT(o.order_date, '%Y') AS invoice_year
              ,(SUM(o.amount)) AS invoice_amount_yearly
        FROM order o
        ";
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'logistics_incomeByMonth');
