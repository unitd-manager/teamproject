<?
class CP_Admin_Widgets_Pms_CalendarDisplay_Controller extends CP_Common_Lib_WidgetControllerAbstract
{
    var $handle = 'calendar1';
    var $cssClass = '';
    var $eventAction = 'index.php?widget=pms_calendarDisplay&_spAction=eventDetails&showHTML=0';
