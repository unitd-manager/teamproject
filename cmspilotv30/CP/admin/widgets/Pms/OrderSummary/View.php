<?
class CP_Admin_Widgets_Pms_OrderSummary_View extends CP_Common_Lib_WidgetViewAbstract
{
    /**
     *
     */
    function getWidget() {
        ...
        $textSubsidySummary = '';
        if ($cpCfg['w.pms.orderSummary.hasSubsidySummary']) {
        ...
        if ($cpCfg['w.pms.orderSummary.alignRightForInstitute']) {
            $addClass = '';
        } else {
            $addClass = 'c50l';
        }
