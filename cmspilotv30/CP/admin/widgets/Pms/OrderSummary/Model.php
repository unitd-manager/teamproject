<?
class CP_Admin_Widgets_Pms_OrderSummary_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    ...
    function getTotalOutstandingInvoices($title='') {
        ...
        if ($cpCfg['w.pms.orderSummary.outstandingInvoiceForInstitute']) {
            $tableAbb = 'i';
        } else {
            $tableAbb = 'o';
        }
        ...
        if ($title == 'Subsidy Summary'){
            $sqlAppend .= " AND oi.module = 'pms_subsidy' ";
        }
        else if ($title == 'Invoice Summary'){
            $sqlAppend .= " AND oi.module = 'pms_course' ";
        }
        
        if ($cpCfg['w.pms.orderSummary.outstandingInvoiceForPvt']) {
            // Was there earlier
            /*$SQL = "
            SELECT
            ...
            */
            ...
            ";
        } else if ($cpCfg['w.pms.orderSummary.outstandingInvoiceForInstitute']) {
            $SQL = "
    ...
    function getTotalInvoicesDueThisMonth($title='') {
        ...
        if ($cpCfg['w.pms.orderSummary.invoiceDueThisMonthForInstitute']) {
            $tableAbb = 'i';
        } else {
            $tableAbb = 'o';
        }
        ...
        if ($cpCfg['w.pms.orderSummary.invoiceDueThisMonthForPvt']) {
            $SQL = "
            ...
            ";
        } else if ($cpCfg['w.pms.orderSummary.invoiceDueThisMonthForInstitute']) {
            $SQL = "
    ...
    function getTotalLateInvoices($title='') {
        ...
        if ($cpCfg['w.pms.orderSummary.lateInvoiceForInstitute']) {
            $tableAbb = 'i';
        } else {
            $tableAbb = 'o';
        }
        ...
        if ($cpCfg['w.pms.orderSummary.lateInvoiceForPvt']) {
            $SQL = "
            SELECT ABS(SUM(irh.amount)) AS total
            FROM invoice_receipt_history irh
            WHERE irh.invoice_paid_status IS NULL
            ...
            ";
        } else if ($cpCfg['w.pms.orderSummary.lateInvoiceForInstitute'])  {
            $SQL = "
            SELECT ABS(SUM(i.invoice_amount)) AS total
            FROM `invoice` i
            WHERE i.status = 'Due'
    ...
    function getTotalOverDueInvoices($title='') {
        ...
        if ($cpCfg['w.pms.orderSummary.overDueInvoiceForInstitute']) {
            $tableAbb = 'i';
        } else {
            $tableAbb = 'o';
        }
        ...
        ";
        */
        if ($cpCfg['w.pms.orderSummary.overDueInvoiceForPvt']) {
            $SQL = "
            SELECT ABS(SUM(irh.amount)) AS total
            FROM invoice_receipt_history irh
            WHERE irh.invoice_paid_status IS NULL
            ...
            ";
        } else if ($cpCfg['w.pms.orderSummary.overDueInvoiceForInstitute']) {
            $SQL = "
            SELECT ABS(SUM(i.invoice_amount)) AS total
            FROM `invoice` i
            WHERE i.status = 'Due'
    ...
    function getTotalInvoicesThisMonth($title='') {
        ...
        if ($cpCfg['w.pms.orderSummary.invoiceThisMonthForInstitute']) {
            $tableAbb = 'i';
        } else {
            $tableAbb = 'o';
        }
        ...
        if ($cpCfg['w.pms.orderSummary.invoiceThisMonthForPvt']) {
            $SQL = "
            SELECT ABS(SUM(irh.amount)) AS total
            FROM invoice_receipt_history irh
            WHERE irh.invoice_paid_status IS NULL
              AND DATE_FORMAT(irh.invoice_date, '%Y-%m') = '{$thisMonth}'
            ";
        } else if ($cpCfg['w.pms.orderSummary.invoiceThisMonthForInstitute']) {
            $SQL = "
            SELECT ABS(SUM(i.invoice_amount)) AS total
            FROM `invoice` i
    ...
    function getTotalInvoiceLastMonth($title='') {
        ...
        if ($cpCfg['w.pms.orderSummary.invoiceDueLastMonthForInstitute']) {
            $tableAbb = 'i';
        } else {
            $tableAbb = 'o';
        }
        ...
        if ($cpCfg['w.pms.orderSummary.invoiceDueLastMonthForPvt']) {
            $SQL = "
            SELECT ABS(SUM(irh.amount)) AS total
            FROM invoice_receipt_history irh
            WHERE irh.invoice_paid_status IS NULL
            ...
            ";
        } else if ($cpCfg['w.pms.orderSummary.invoiceDueLastMonthForInstitute']) {
            $SQL = "
            SELECT ABS(SUM(i.invoice_amount)) AS total
            FROM `invoice` i
    ...
    function getTotalInvoicesPaidThisMonth($title='') {
        ...
        if ($cpCfg['w.pms.orderSummary.invoicePaidThisMonthForInstitute']) {
            $tableAbb = 'i';
        } else {
            $tableAbb = 'o';
        }
        ...
        if ($cpCfg['w.pms.orderSummary.invoicePaidThisMonthForPvt']) {
            $SQL = "
            SELECT ABS(SUM(irh.amount)) AS total
            FROM invoice_receipt_history irh
    ...
    function getTotalInvoicesPaidLastMonth($title='') {
        ...
        if ($cpCfg['w.pms.orderSummary.invoicePaidLastMonthForInstitute']) {
            $tableAbb = 'i';
        } else {
            $tableAbb = 'o';
        }
        ...
        if ($cpCfg['w.pms.orderSummary.invoicePaidLastMonthForPvt']) {
            $SQL = "
            SELECT ABS(SUM(irh.amount)) AS total
            FROM invoice_receipt_history irh
            WHERE irh.invoice_paid_status = 'Paid'
              AND DATE_FORMAT(irh.invoice_date, '%Y-%m') = '{$lastMonth}'
            ";
        } else if ($cpCfg['w.pms.orderSummary.invoicePaidLastMonthForInstitute']) {
            $SQL = "
            SELECT ABS(SUM(i.invoice_amount)) AS total
            FROM `invoice` i
            WHERE i.status = 'Paid'
    ...
    function getTotalInvoicesPaidLastThreeMonth($title='') {
        ...
        if ($cpCfg['w.pms.orderSummary.invoicePaidLastThreeMonthForInstitute']) {
            $tableAbb = 'i';
        } else {
            $tableAbb = 'o';
        }
        ...
        if ($cpCfg['w.pms.orderSummary.invoicePaidLastThreeMonthForPvt']) {
            $SQL = "
            SELECT ABS(SUM(irh.amount)) AS total
            FROM invoice_receipt_history irh
            WHERE irh.invoice_paid_status = 'Paid'
              AND irh.invoice_date < '{$ninetyDaysBefore}'
            ";
        } else if ($cpCfg['w.pms.orderSummary.invoicePaidLastThreeMonthForInstitute']) {
            $SQL = "
            SELECT ABS(SUM(i.invoice_amount)) AS total
            FROM `invoice` i
            WHERE i.status = 'Paid'
    ...
    function getTotalInvoicesPaidThisYear($title='') {
        ...
        if ($cpCfg['w.pms.orderSummary.invoicePaidThisYearForInstitute']) {
            $tableAbb = 'i';
        } else {
            $tableAbb = 'o';
        }
        ...
        if ($cpCfg['w.pms.orderSummary.invoicePaidThisYearForPvt']) {
            $SQL = "
            SELECT ABS(SUM(irh.amount)) AS total
            FROM invoice_receipt_history irh
            WHERE irh.invoice_paid_status = 'Paid'
            ...
            ";
        } else if ($cpCfg['w.pms.orderSummary.invoicePaidThisYearForInstitute']) {
