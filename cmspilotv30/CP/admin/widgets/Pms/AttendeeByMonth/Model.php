<?
class CP_Admin_Widgets_Pms_AttendeeByMonth_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'pms_attendeeByMonth');
    ...
    function getInvoiceByMonthSQL(){
        ...
        if ($cpCfg['w.pms.attendanceByMonth.invoiceByMonthForPvt']) {
            $SQL = "
    ...
    function getAttendeeByCourseSQL(){
        ...
        if ($site_id) {
            $appendSql = " AND cc.site_id = {$site_id}";
            $appendsql2 = "WHERE cc.site_id = {$site_id}";
        }
