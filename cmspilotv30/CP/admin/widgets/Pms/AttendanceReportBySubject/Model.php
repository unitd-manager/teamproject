<?
class CP_Admin_Widgets_Pms_AttendanceReportBySubject_Model extends CP_Common_Lib_WidgetModelAbstract
{
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'pms_incomeByCourse');
