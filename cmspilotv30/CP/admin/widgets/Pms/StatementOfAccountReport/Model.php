<?
class CP_Admin_Widgets_Pms_StatementofAccountReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    ...
    function setSearchVar() {
        ...
        $searchVar->sortOrder = 'parent_name ASC';
    }
    ...
    function setSearchVarOld() {
        ...
        //$searchVar->sqlSearchVar[] = "i.invoice_sent_out = 1";
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'pms_statementofAccountReport');
    ...
    function getExportToExcelOld(){
        ...
        if ($start_date != '' && $end_date == '') {
            $end_date = date('Y-m-d');
            $appendSql .= "'{$start_date}' AND '{$end_date}'";
        } else if ($start_date == '' && $end_date != ''){
            $start_date = date('Y') . '-01-01';
            $appendSql .= "'{$start_date}' AND '{$end_date}'";
        } else if ($start_date != '' && $end_date != '') {
        ...
        if ($parent_id == '') {
            ...
            $actSheet->setCellValueByColumnAndRow($colc++, $rowc, 'Please choose the parent');
        ...
        $prev_outstanding_amount = $this->getPreviousOutstandingBalanceAmount($parent_id, $start_date);

        $colc = 0;
        $rowc++;
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, 'OPENING BALANCE');
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, '');
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, '');
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, '');
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, '');
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, '');
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $prev_outstanding_amount);
        ...
        WHERE i.status = 'Due'
            ...
            AND i.invoice_date BETWEEN {$appendSql}
        ...
        $colc = 0;
        $rowc++;
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $this->getPastBalanceAmount($parent_id, $end_date, 30));
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $this->getPastBalanceAmount($parent_id, $end_date, 60));
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $this->getPastBalanceAmount($parent_id, $end_date, 61));
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $outstanding_amount);
