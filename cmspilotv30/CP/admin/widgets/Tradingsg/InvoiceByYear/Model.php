<?
class CP_Admin_Widgets_Tradingsg_InvoiceByYear_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    ...
    function getExportToExcel(){
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            $actSheet->setCellValueByColumnAndRow($colc++, $rowc, number_format($row['invoice_amount_yearly'],2));
        }
