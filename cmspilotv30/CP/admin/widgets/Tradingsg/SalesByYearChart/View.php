<?
class CP_Admin_Widgets_Tradingsg_SalesByYearChart_View extends CP_Common_Lib_WidgetViewAbstract
{
    /**
     *
     */
    function getWidget() {
        ...
        <script type='text/javascript' src='https://www.google.com/jsapi'></script>
            <script type='text/javascript'>
                ...
                chart.draw(data, {colors: ['#660066'], width: 525, height: 240, title: '',
