<?
class CP_Admin_Widgets_Tradingsg_DetailSummaryByClient_View extends CP_Common_Lib_WidgetViewAbstract
{
    //==================================================================//
    function getWidget() {
                ...
                if($row['site_id'] == $cpSiteIdSession){
                    ...
                    if($rowInv['invoice_code_vat_quote'] != ''){
                        if($rowInv['invoice_id'] > 5626){
                            ...
                            }else if($rowInv['selling_company'] == 'V-United Impex'){
                                $invoiceCode = 'INVL -' . $rowInv['invoice_code_vat_quote'];
                            }else{
                                $invoiceCode = 'INVQ -' . $rowInv['invoice_code_vat_quote'];
                            }
                        }
                        $todaylink = "<a target = '_blank' href = 'index.php?_topRm=finance&module=tradingin_order&record_id={$rowInv['order_id']}&_action=edit'>";
                    }
                    else {
