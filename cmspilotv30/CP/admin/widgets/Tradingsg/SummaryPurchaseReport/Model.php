<?
class CP_Admin_Widgets_Tradingsg_SummaryPurchaseReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    ...
    function setSearchVar() {
        ...
        $searchVar->groupBy   = 'pop.supplier_id, pop.quote_id';
    ...
    function getExportToExcel(){
        ...
        $file_name = "SummaryPurchase__" . date("d-m-Y") . ".xls";
        ...
        $appendSql .= "AND c.gst_applied = 1 AND q.status != 'Cancelled'";
        ...
        WHERE o.order_date != ''
            {$appendSql}
        GROUP BY pop.supplier_id, pop.quote_id
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $row['formatted_quote_date']);
