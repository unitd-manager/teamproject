<?
class CP_Admin_Widgets_Labsg_PatientVisitChart_View extends CP_Common_Lib_WidgetViewAbstract
{
    /**
     *
     */
    function getWidget() {
        ...
        <div class='tableOuter' id='no_of_visits_div' style='height: 335px; width: 623px;'>
        </div>
