<?
class CP_Admin_Widgets_Labsg_TreatmentHistoryChart_View extends CP_Common_Lib_WidgetViewAbstract
{
    /**
     *
     */
    function getWidget() {
        ...
        $text = "
        <h2>Treatment History - Current Month</h2>
        <div class='tableOuter' id='piechart' style='height: 335px;'>
        </div>
