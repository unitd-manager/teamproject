<?
class CP_Admin_Widgets_EnterpriseIms_StudentStatusReports_Model extends CP_Common_Lib_WidgetModelAbstract
{
    function getSQL(){
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'enterpriseIms_studentStatusReports');
