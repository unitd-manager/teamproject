<?
class CP_Admin_Widgets_EnterpriseIms_OrderSummary_View extends CP_Common_Lib_WidgetViewAbstract
{
    /**
     *
     */
    function getWidget() {
        ...
        $textSubsidySummary = '';
        if ($cpCfg['w.enterpriseIms.orderSummary.hasSubsidySummary']) {
        ...
        if ($cpCfg['w.enterpriseIms.orderSummary.alignRightForInstitute']) {
            $addClass = '';
        } else {
            $addClass = 'c50l';
        }
