<?
class CP_Admin_Widgets_EnterpriseIms_AttendeeByMonth_View extends CP_Common_Lib_WidgetViewAbstract
{
    /**
     *
     */
    ...
    function getAttendeeByCourse(){
        ...
        $text = "
        <h2>Trainee by {$modulesArr['enterpriseIms_course']['title']}</h2>
        ...
        <script type='text/javascript' src='https://www.google.com/jsapi'></script>
            <script type='text/javascript'>
                ...
                var options = {
                  'title':'Trainee by {$modulesArr['enterpriseIms_course']['title']}',
                  'is3D':true,
                  'width':900,
                  'height':320
                }
