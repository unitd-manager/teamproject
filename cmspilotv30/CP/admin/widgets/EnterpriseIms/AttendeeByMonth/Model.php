<?
class CP_Admin_Widgets_EnterpriseIms_AttendeeByMonth_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'enterpriseIms_attendeeByMonth');
    ...
    function getInvoiceByMonthSQL(){
        ...
        if ($cpCfg['w.enterpriseIms.attendanceByMonth.invoiceByMonthForPvt']) {
            $SQL = "
    ...
    function getAttendeeByCourseSQL(){
        ...
        if ($site_id) {
            $appendSql = " AND cc.site_id = {$site_id}";
            $appendWhere = "WHERE cc.site_id = {$site_id}";
        }
