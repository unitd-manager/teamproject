<?
class CP_Admin_Widgets_EnterpriseIms_CalendarDisplay_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    function getSQL(){
        ...
        if ($cpCfg['w.enterpriseIms.calendarDisplay.hasPvt']) {
            $SQL = "
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'enterpriseIms_calendarDisplay');
    ...
    function getEventDetails(){
        ...
        while ($row = $db->sql_fetchrow($result)) {
             ...
             $batchLink = 'index.php?widget=enterpriseIms_calendarDisplay&_spAction=batchDetails&showHTML=0&batch_id='. $row['batch_id'];
    ...
    function getBatchDetails(){
        ...
        $batchLink = 'index.php?_topRm=main&module=enterpriseIms_batch&_action=edit&batch_id=' . $batch_id;
