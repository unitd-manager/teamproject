<?
class CP_Admin_Widgets_ManPower_ProjectPositionReport_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
    ...
    function setSearchVar() {
        ...
        $searchVar->sqlSearchVar[] = "p.position != ''";
        ...
        if ($month == '' && $year == '') {
            ...
            $searchVar->sqlSearchVar[] = "p.creation_date BETWEEN '{$startDate}' AND '{$endDate}'";
        }
       ...
       $searchVar->groupBy = 'p.position';
       $searchVar->sortOrder = 'p.creation_date';
    }
    /**
     *
     */
    ...
    function getExportToExcel(){
        ...
        $file_name = "ProjectPosition_" . date("d-m-Y") . ".xls";
        ...
        $actSheet->setCellValueByColumnAndRow($colc++, $rowc, 'No. of Projects');
        /******************** FORMAT HEADER *******************/
        $headStyle = array(
        ...
        if ($month == '' && $year == '') {
            ...
            $sqlAppend .= "AND p.creation_date BETWEEN '{$startDate}' AND '{$endDate}'";
        }
        ...
        while ($row = $db->sql_fetchrow($result)) {
            ...
            $actSheet->setCellValueByColumnAndRow($colc++, $rowc, $row['no_of_project']);
        }
