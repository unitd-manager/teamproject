Util.createCPObject('cpt.course');
...
cpt.course = {
	init: function(){
        ...
        $(".ui-datepicker-trigger").attr('src', '/admin/images/calendar_icon.png');
        ...
        .livequery(cpt.course.mobileSearch);

        $("input[name='email_search']")
        .livequery(cpt.course.emailSearch);

        $(".navbar-toggle").livequery('click', function(){
            $("aside#col1").slideToggle();
            $(".navbar-toggle").addClass('displayNone');
        });

        $(".hlist.noBg .glyphicon.glyphicon-remove-circle").livequery('click', function(){
            $("aside#col1").slideToggle();
            $(".navbar-toggle").removeClass('displayNone');
        });
        ...
        $('.v-list .cpSearch td.dateRange .hasDatepicker').livequery('change', function(e){
        ...
        $('.v-list .cpSearch div.type-text.ym-fbox-text.dateRange .hasDatepicker').livequery('change', function(e){
            var parent    = $(this).closest(".type-text.ym-fbox-text");
            var dateCheck = $(this).val();
        ...
        $('.v-list .type-text.ym-fbox-text .hasDatepicker, .v-edit .hasDatepicker, .v-new .hasDatepicker').livequery('change', function(e){
            var parent    = $(this).closest(".type-text.ym-fbox-text");
            var dateCheck = $(this).val();
