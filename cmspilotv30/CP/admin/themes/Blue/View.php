<?
class CP_Admin_Themes_Blue_View extends CP_Admin_Lib_ThemeViewAbstract
{
    ...
    function getNavPanel(){
        ...
        $text = "
        <div class='floatbox'>
        <div class='float_left roomsWrapper'>
            <div class='hlist noBg'>
                {$rooms}
            </div>
        </div>
	...
	function getLoginThemeOutput() {
        ...
        /*if ($cpCfg['cp.ucSystemLoginText'] == 1) {
            $loginTitle ="
            <div class='floatbox'>
                <div class='float_left'><img src='images/logo-print.png'></div>
            </div>
            ";
        }*/
        ...
        if ($cpCfg['cp.enterpirseLoginText'] == 1) {
            $loginTitle ="
            <div class='floatbox'>
                <div class='float_left'><img src='images/logo-print.jpg'></div>
                <div class='float_left loginTitle'><h1>Welcome to Institute Management System</h1></div>
        ...
        if ($cpCfg['cp.engineeringLoginText'] == 1) {
            $loginTitle ="
            <div class='floatbox'>
                <div class='float_left'><img src='images/logo-print.jpg'></div>
                <div class='float_left loginTitle'><h1>Welcome to Engineering Management System</h1></div>
            </div>
            ";
        }
        ...
        $loginTitle ="
        <div class='floatbox'>
            <div class='float_left loginTitle'><h1>{$loginText}</h1></div>
        </div>
        ";
                ...
                <div class='page_margins'>
                    <div class='page'>
				        <div class='getStarted'>
				            <a class='getStartedContentTask button' href='#'>Get Started</a>
				        </div>
