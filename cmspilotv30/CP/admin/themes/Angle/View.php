<?
class CP_Admin_Themes_Angle_View extends CP_Admin_Lib_ThemeViewAbstract
{
    ...
    function getHeaderPanel() {
        ...
        if (isLoggedInAdmin()) {
            ...
            //$logoText = "<img src='images/logo.jpg' />";
        }
	...
	function getLoginThemeOutput() {
        ...
        if ($cpCfg['cp.hospitalManagementLoginText'] == 1) {
            $loginTitle ="
            <div class='floatbox'>
                <div class='float_left'><img src='images/logo-print.jpg'></div>
                <div class='float_left loginTitle'><h1>Welcome to Mediway Medical Centre</h1></div>
            </div>
            ";
        }
        ...
        if ($cpCfg['cp.hospitalManagementLoginText'] == 1) {
            ...
            <div class='floatbox'>
                <div class='float_left'><img src='images/logo-print.jpg'></div>
                <div class='float_left loginTitle'><h1>Welcome to Hospital Management System</h1></div>
            </div>
            ";
        }

        if ($cpCfg['cp.vunitedLoginText'] == 1) {
            $loginTitle ="
            <div class='floatbox'>
                <div class='float_left'><img src='images/logo-print.jpg'></div>
                <div class='float_left loginTitle'><h1>Welcome to bi3 Offline Shopping</h1></div>
            </div>
            ";
        }
