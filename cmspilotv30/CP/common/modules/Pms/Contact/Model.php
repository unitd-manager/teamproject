<?
class CP_Common_Modules_Pms_Contact_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
    function getSQL() {
        ...
        if ($course_id != "" || ($course_status != '' && $cpCfg['m.pms.course.hasCourseContactStatus'])) {
            if ($course_status != '') {
