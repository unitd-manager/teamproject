<?
class CP_Common_Modules_AgileIms_Contact_Model extends CP_Common_Lib_ModuleModelAbstract
{
    /**
     *
     */
    function getSQL() {
        ...
        if ($course_id != "" || ($course_status != '' && $cpCfg['m.agileIms.course.hasCourseContactStatus'])) {
            if ($course_status != '') {
