<?
class CP_Www_Plugins_Member_Login_View extends CP_Common_Lib_PluginViewAbstract
{
    /**
     *
     */
    ...
    function getLoginLink() {
        ...
        /** if there is a hook in the current theme then use that **/
    ...
    function getLogoutLink() {
        ...
        if (method_exists($theme->fns, 'getLogoutLinkHook')){
            return $theme->fns->getLogoutLinkHook();
        }        
