Util.createCPObject('cpm.edukite.class');

cpm.edukite.class = {
    init: function(){
    //--------------------------- STUDENT LINK IN class-----------------------------
        ...
        $('.leftInfoList').on('click', 'a.studentLinkArrow', function(e){
            ...
            var url = '/index.php?module=edukite_class&_spAction=linkStudentToRightPanel' +
                      '&showHTML=0';
            ...
            $.get(url, {student_id:student_id, class_id:class_id} , function(data){
                $('.rightInfoList').html(data);
                Util.hideProgressInd();
                //cpm.edukite.class.reloadLeftPanelStudent(class_id);
            });
        ...
        $('.rightInfoList').on('click', 'a.studentLinkDelete', function(e){
            ...
            var url = '/index.php?module=edukite_class&_spAction=deleteLinkedStudents' +
                      '&showHTML=0';
            Util.showProgressInd();
            $.get(url, {student_id:student_id, class_id:class_id} , function(data){
                $('.rightInfoList').html(data);
        ...
        $('.leftInfoList').on('click', 'a.selectAllStudent', function(e){
            ...
            if (!confirm(msg)){
                ...
                var url = '/index.php?module=edukite_class&_spAction=linkAllStudentToRightPanel' +
                          '&showHTML=0';
                Util.showProgressInd();
        ...
        $('.rightInfoList').on('click', 'a.removeAllStudent', function(e){
            ...
            if (!confirm(msg)){
                ...
                var url = '/index.php?module=edukite_class&_spAction=deleteAllLinkedStudents' +
                          '&showHTML=0';
                Util.showProgressInd();
                $.get(url, {class_id:class_id} , function(data){
                    $('.rightInfoList').html(data);
        ...
        $("#studentSearch a.submit").livequery('click', function(){
        	...
        	var url = '/index.php?module=edukite_class&_spAction=studentDisplayAfterSearch' +
                      '&showHTML=0';
            Util.showProgressInd();
            $.get(url,{student_name: student_name, class_id: class_id}, function(html){
    ...
    reloadLeftPanelStudent: function(class_id){
        var url = '/index.php?module=edukite_class&_spAction=studentList&showHTML=0';
        $.get(url, {class_id:class_id} , function(data){
