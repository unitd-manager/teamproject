<?
class CP_Www_Widgets_Media_FlexSlider_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    function getDataArray() {
        ...
        if ($c->type == 'picture'){
            $record_id = ($c->record_id != '') ? $c->record_id : $tv['room'];
            $dataArray = $media->getMediaFilesArray($c->module, $c->recordType, $record_id);
        }
