...
function CheckAuthentication()
{
    ...
    /************** Added by CP ****************/
	return isset($_SESSION['isAuthorizedForCKFinderUpload']) && $_SESSION['isAuthorizedForCKFinderUpload'];
...
/************** Added by CP ****************/
$baseUrl = $_SESSION['fckEditorMediaFolder'];
...
/************** Added by CP ****************/
$baseDir = $_SESSION['UserFilesAbsolutePath'] . "/";
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,zip,vcs',
		'deniedExtensions' => '');
