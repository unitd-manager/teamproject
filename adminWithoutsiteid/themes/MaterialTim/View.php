<?
class CPL_Admin_Themes_MaterialTim_View extends CP_Admin_Themes_MaterialTim_View
{
                ...
                $logged_IN_text_Logout = "
                    <div class='float_right logoutWrap'>
                        <span class='username'>
                            ...
                            {$ln->gd('cp.lbl.welcome', 'Welcome')} {$_SESSION['userFullName']}
                        </span>
                        <div class='txtRight'>
    ...
    function getHomeMenuDisplay(){
        ...
        if ($rowsTr != ''){
            $textSiteMap = "
            <a class='homeModLink' href='/index.php?_topRm=project&module=enggCrm_home'></a>
            <ul class='homeTop'>
                <li>
        ...
        <div class='floatbox'>
            <div class='col-md-12 noPadding'>
                <table class='table loginLeftPanelTableLogo'>
                    ...
                    <tr>
                        <td colspan='2' align='center'><img src='images/logo.jpg' width='170'/></td>
                    </tr>
                    <tr>
                        <td colspan='2'></td>
                    </tr>
            ...
            <div id='col3'>
                <div id='col3_content' class='clearfix'>
                    <div class='loginPanelLogin col-md-12 card-header card-header-tabs card-header-default '>
                        <div class='col-md-7 noPadding bgloginLoginPanelLeft'>
                            {$loginTitle}
                        </div>
                        <div class='col-md-5'>
                            {$login->getLoginForm()}
