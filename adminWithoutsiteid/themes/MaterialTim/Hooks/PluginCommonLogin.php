<?
class CPL_Admin_Themes_MaterialTim_Hooks_PluginCommonLogin
{
    /**
     *
     */
    function getLoginForm(){
        ...
        <div id='loginOuter'>
            <h2 class='h2 ml10'>Login</h2>
            <form name='loginForm' id='loginForm' class='yform mt30 columnar login cpJqForm' method='post' action='{$formAction}'>
                <fieldset>
                    <div id='errorDisplayBox'></div>
                    {$formObj->getTextBoxRow('Email', 'email', '', $expEmail)}
                    {$formObj->getTextBoxRow('Password', 'pass_word', '', $expPass)}
                    <input type='submit' name='submit' class='btn btn-primary col-md-12' value='Login' />
                    <div class='flaotbox'>
                        <div class='float_left'>
                            <div class='type-check mt10'>
                                <input type='checkbox' id='fld_save_login' class='checkBox float_left mr5' name='saveLogin' value='1' />
