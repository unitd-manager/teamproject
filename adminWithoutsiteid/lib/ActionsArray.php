<?
class CPL_Admin_Lib_ActionsArray extends CP_Common_Lib_ActionsArray
{
    ...
    function setActionsArray(){
        ...
        //====================== Print List to PDF Used in NahviBiz ================================//
        $actObj = $this->getActionObj('printListPDFInvoice');
        $this->registerAction($actObj, array(
            'title' => 'Print Invoice'
           ,'url' => "javascript:Actions.printListPDFInvoice('{$queryStringNoRoomInfo}')"
        ));
    }
