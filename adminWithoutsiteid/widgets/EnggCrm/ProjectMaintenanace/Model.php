<?
class CPL_Admin_Widgets_EnggCrm_ProjectMaintenanace_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'enggCrm_projectMaintenanace');
    ...
    function getAddMultipleMaterialsSubmit() {
        ...
        $service_type = $fn->getReqParam('service_type');
                $ahu_fcu_no = $fn->getReqParam('ahu_fcu_no');
