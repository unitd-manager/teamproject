$(function(){
    ...
    /* MATERIAL USED EDIT */
    $("a.addMultipleWarrantyRenewal").livequery('click', function (e){
        var title = "Add Warranty";
        ...
        var expObj = {
            ...
            callbackOnSuccess: function(){
                ...
                projectWarrantyRenewal.reloadMaterialUsedPortal(renewal_id);
            }
        }

        Util.openFormInDialog.call(this, 'addMultipleWarrantyForm', title, 1200, 500, expObj);
    });

    /* Adding row in new material */
    $("a.addMaterialRow").livequery('click', function (e){
        var url = 'index.php?widget=enggCrm_projectWarrantyRenewal&_spAction=addMaterialRecord'
                + '&showHTML=0';

        $.get(url, '' ,function(html){
            $('#addMultipleWarrantyForm tr:last').after(html);
        });
    });
    ...
    $('.cancelMaterial').livequery('click', function (e){
        ...
        if (!confirm(msg)){
            ...
            var url = 'index.php?widget=enggCrm_projectWarrantyRenewal&_spAction=cancelMaterial&showHTML=0';
    ...
    $('.virescoFactory').livequery('click', function (e){
        Util.showProgressInd();
        var url = 'index.php?widget=enggCrm_projectWarrantyRenewal&_spAction=updateVirescoFactory&showHTML=0';
        var project_materials_id = $(this).attr('project_materials_id');
    ...
    $(".addMultipleMaterialsForm input.materialTitleFull").livequery(projectWarrantyRenewal.poProductTitle);
    $("#editForMaterialUsed input[name=title]").livequery(projectWarrantyRenewal.poProductTitleEdit);
    ...
    /* MATERIAL USED EDIT */
    $("a.editForWarrantyRenewal").livequery('click', function (e){
        var title = "Edit Warranty";
        var renewal_id = $("#record_id").val();
        ...
        Util.openFormInDialog.call(this, 'editForWarrantyRenewal', title, 1200, 600, expObj);
    });
    ...
    $('.viewAllReturnedMaterialHistory').livequery('click', function (){
        ...
        if(project_materials_id != "") {
            var url = "index.php?widget=enggCrm_projectWarrantyRenewal&_spAction=returnedMaterialHistory&project_materials_id="+project_materials_id+"&showHTML=0";
            var exp = {
                url: url
            };
    ...
    $(".creationModificationMU").livequery('click', function (e){
        ...
        var url = "index.php?widget=enggCrm_projectWarrantyRenewal&_spAction=creationModificationMU&project_materials_id="+project_materials_id+"&showHTML=0";
        var exp = {
            url: url
        };
...
var projectWarrantyRenewal = {
    poProductTitle: function() {
        var titleObj = this;
        $(titleObj).autocomplete({
            source: function(request, response) {
                $.ajax({
                  url: 'index.php?widget=enggCrm_projectWarrantyRenewal&_spAction=searchProductTitle&showHTML=0',
                  dataType: "json",
                  data: request,                    
    ...
    reloadMaterialUsedPortal: function(renewal_id){
        var url = 'index.php?widget=enggCrm_projectWarrantyRenewal&_spAction=ProjectWarrantyPortal&showHTML=0';
        Util.showProgressInd();
        $.get(url, {renewal_id: renewal_id}, function(html){
            Util.hideProgressInd();
            $('#warraLinkPortal').html(html);
        });
    },
}