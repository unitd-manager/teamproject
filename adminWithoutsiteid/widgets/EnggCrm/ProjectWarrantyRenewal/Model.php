<?
class CPL_Admin_Widgets_EnggCrm_ProjectWarrantyRenewal_Model extends CP_Common_Lib_WidgetModelAbstract
{
    /**
     *
     */
    ...
    function getDataArray() {
        ...
        $dataArray = $modelHelper->getWidgetDataArray($this->controller, 'enggCrm_projectWarrantyRenewal');
    ...
    function getEditForMaterialUsedSubmit() {
        ...
        $project_warranty_id = $fn->getPostParam('project_warranty_id');
    
        $detail_of_work      = $fn->getPostParam('detail_of_work');
        $renewal_id = $fn->getPostParam('renewal_id');
        $ref_no = $fn->getPostParam('ref_no');
        $warranty_start_date = $fn->getPostParam('warranty_start_date');
        $end_date = $fn->getPostParam('warranty_end_date');
        $special_terms = $fn->getPostParam('special_terms');
        $warranty_duration = $fn->getPostParam('warranty_duration');
        $work_completed_date = $fn->getPostParam('work_completed_date');
        $warranty_details = $fn->getPostParam('warranty_details');
        $location_of_work = $fn->getPostParam('location_of_work');
        $po_issue_date = $fn->getPostParam('po_issue_date');
        $issued_for = $fn->getPostParam('issued_for');
        $warranty_date = $fn->getPostParam('warranty_date');

        $fa = array();
        $fa['detail_of_work']         = $detail_of_work;
        $fa['renewal_id']    = $renewal_id;
         $fa['ref_no']    = $ref_no;
        $fa['warranty_start_date']    = $warranty_start_date;
        $fa['end_date']    = $end_date;
        $fa['special_terms']    = $special_terms;
        $fa['warranty_duration']    = $warranty_duration;
        $fa['work_completed_date']    = $work_completed_date;
        $fa['warranty_details']    = $warranty_details;
        $fa['location_of_work']    = $location_of_work;
        $fa['po_issue_date']    = $po_issue_date;
        $fa['issued_for']    = $issued_for;
        $fa['warranty_date']    = $warranty_date;


        $whereCondition      = "WHERE project_warranty_id = {$project_warranty_id}" ;
        $sqlUpdateExpense    = $dbUtil->getUpdateSQLStringFromArray($fa, "project_warranty", $whereCondition);
    ...
    function getAddMultipleMaterialsSubmit() {
        ...
        $detail_of_work      = $fn->getReqParam('detail_of_work');
        $renewal_id = $fn->getReqParam('renewal_id');
        $ref_no = $fn->getReqParam('ref_no');
        $warranty_start_date = $fn->getReqParam('warranty_start_date');
        $end_date = $fn->getReqParam('end_date');
        $special_terms = $fn->getReqParam('special_terms');
        $warranty_duration = $fn->getReqParam('warranty_duration');
        $work_completed_date = $fn->getReqParam('work_completed_date');
        $warranty_details = $fn->getReqParam('warranty_details');
        $location_of_work = $fn->getReqParam('location_of_work');
        $po_issue_date = $fn->getReqParam('po_issue_date');
        $issued_for = $fn->getReqParam('issued_for');
        $warranty_date = $fn->getReqParam('warranty_date');
        ...
        $insert = $dbUtil->getInsertSQLStringFromArray($fa, 'project_warranty');
     ...
     */
    function getAddMultipleMaterialsSubmitold() {
        $fn       = Zend_Registry::get('fn');
        $db       = Zend_Registry::get('db');
        $dbUtil   = Zend_Registry::get('dbUtil');
        $validate = Zend_Registry::get('validate');
