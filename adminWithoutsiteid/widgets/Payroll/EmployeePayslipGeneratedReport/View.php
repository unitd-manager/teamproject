<?
class CPL_Admin_Widgets_Payroll_EmployeePayslipGeneratedReport_View extends CP_Admin_Widgets_Payroll_EmployeePayslipGeneratedReport_View
{
    /**
     *
     */
    function getWidget() {
        ...
        $month_val = $dateUtil->getLongMonthName($month);
        ...
        if ($rowsHTML != ""){
            ...
            <table class='thinlist summaryTable'>
                <thead>
                    <th colspan='11' class='txtCenter'>Employee Payslip Generated Report</th>
                </thead>
                <tr>
                    <td colspan='6'><b>Month :</b> {$month_val}</td>
                    <td colspan='5'><b>Year :</b> {$year}</td>
                </tr>
            </table>
