<?
class CPL_Admin_Widgets_Payroll_EmployeeSalaryReport_View extends CP_Admin_Widgets_Payroll_EmployeeSalaryReport_View
{
    /**
     *
     */
    function getWidget() {
        ...
        if ($rowsHTML != ""){
            ...
            <table class='thinlist summaryTable'>
                <thead>
                    <th colspan='11' class='txtCenter'>Employee Salary Report</th>
                </thead>
                <tr>
                    <td><b>Employee Status :</b> {$employee_status}</td>
                </tr>
            </table>
