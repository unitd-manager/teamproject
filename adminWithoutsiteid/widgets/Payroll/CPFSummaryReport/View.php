<?
class CPL_Admin_Widgets_Payroll_CPFSummaryReport_View extends CP_Admin_Widgets_Payroll_CPFSummaryReport_View
{
    /**
     *
     */
    function getWidget() {
        ...
        if ($rowsHTML != ""){
            ...
            <table class='thinlist summaryTable'>
                <thead>
                    <th colspan='6' class='txtCenter'>CPF Summary Report</th>
                </thead>
                <tr>
                    <td colspan='3'><b>Month :</b> {$month_val}</td>
                    <td colspan='3'><b>Year :</b> {$year}</td>
                </tr>
            </table>
