<?
class CPL_Admin_Modules_EnggCrm_Order_Controller extends CP_Common_Lib_ModuleControllerAbstract
{
    /**
     *
     */
    ...
    function getEditInvoiceForm1() {
        $modObj = getCPModuleObj('enggCrm_invoice');
        return $modObj->view->getEditInvoiceForm1();
    }
    ...
    function getInvoicePortalDisplay() {
     ...
     function getInvoicePortalDisplay1() {
        return $this->view->getInvoicePortalDisplay1();
    }
