...
cpm.payroll.jobInformation = {
    init: function(){
        ...
        $('.m-payroll_jobInformation input[name=overtime]').livequery('click', function(e) {
            var overtime = $(this).val();
            
            if(overtime == 1) {
                $('.m-payroll_jobInformation .overTimeRate').removeClass('displayNone');
                $('.m-payroll_jobInformation .sunPhRate').removeClass('displayNone');
            } else {
                $('.m-payroll_jobInformation .overTimeRate').addClass('displayNone');
                $('.m-payroll_jobInformation .sunPhRate').addClass('displayNone');
            }
        });
